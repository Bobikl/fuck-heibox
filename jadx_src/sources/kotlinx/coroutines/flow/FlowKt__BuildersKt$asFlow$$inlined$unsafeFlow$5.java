...
public final class FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$5<T> implements e<T> {
    ...
    final /* synthetic */ kotlin.sequences.m f129238b;
    ...
    public static final class AnonymousClass1 extends ContinuationImpl {
        ...
        public final Object invokeSuspend(@dl.d Object obj) {
            this.f129239b = obj;
            this.f129240c |= Integer.MIN_VALUE;
    ...
    public Object a(@dl.d f<? super T> fVar, @dl.d kotlin.coroutines.c<? super b2> cVar) throws Throwable {
        ...
        if (cVar instanceof AnonymousClass1) {
            ...
            int i10 = anonymousClass1.f129240c;
            if ((i10 & Integer.MIN_VALUE) != 0) {
                anonymousClass1.f129240c = i10 - Integer.MIN_VALUE;
            } else {
        ...
        Object obj = anonymousClass1.f129239b;
        Object objH = kotlin.coroutines.intrinsics.b.h();
        int i11 = anonymousClass1.f129240c;
        if (i11 == 0) {
            t0.n(obj);
            fVar2 = fVar;
            it = this.f129238b.iterator();
        } else {
            if (i11 != 1) {
                throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
            }
            it = (Iterator) anonymousClass1.f129243f;
            f fVar3 = (f) anonymousClass1.f129242e;
            t0.n(obj);
            fVar2 = fVar3;
        }
        while (it.hasNext()) {
            T next = it.next();
            anonymousClass1.f129242e = fVar2;
            anonymousClass1.f129243f = it;
            anonymousClass1.f129240c = 1;
