...
public final class FlowKt__ZipKt$combineTransform$6<R> extends SuspendLambda implements yh.p<f<? super R>, kotlin.coroutines.c<? super b2>, Object> {

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    int f129836b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private /* synthetic */ Object f129837c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    final /* synthetic */ e<T>[] f129838d;

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    final /* synthetic */ yh.q<f<? super R>, T[], kotlin.coroutines.c<? super b2>, Object> f129839e;
    ...
    public static final class AnonymousClass1<T> extends Lambda implements yh.a<T[]> {
        ...
        public final T[] invoke() {
            int length = this.f129840b.length;
            f0.y(0, "T?");
    ...
    public static final class AnonymousClass2<T> extends SuspendLambda implements yh.q<f<? super R>, T[], kotlin.coroutines.c<? super b2>, Object> {
        ...
        /* JADX INFO: renamed from: c, reason: collision with root package name */
        private /* synthetic */ Object f129842c;

        /* JADX INFO: renamed from: d, reason: collision with root package name */
        /* synthetic */ Object f129843d;

        /* JADX INFO: renamed from: e, reason: collision with root package name */
        final /* synthetic */ yh.q<f<? super R>, T[], kotlin.coroutines.c<? super b2>, Object> f129844e;
        ...
        public final Object invoke(@dl.d f<? super R> fVar, @dl.d T[] tArr, @dl.e kotlin.coroutines.c<? super b2> cVar) {
            AnonymousClass2 anonymousClass2 = new AnonymousClass2(this.f129844e, cVar);
            anonymousClass2.f129842c = fVar;
            anonymousClass2.f129843d = tArr;
        ...
        public final Object f(@dl.d Object obj) {
            this.f129844e.invoke((f) this.f129842c, (Object[]) this.f129843d, this);
            return b2.f124493a;
        }
        ...
        public final Object invokeSuspend(@dl.d Object obj) throws Throwable {
            ...
            int i10 = this.f129841b;
            if (i10 == 0) {
                t0.n(obj);
                f<? super R> fVar = (f) this.f129842c;
                Object[] objArr = (Object[]) this.f129843d;
                yh.q<f<? super R>, T[], kotlin.coroutines.c<? super b2>, Object> qVar = this.f129844e;
                this.f129842c = null;
                this.f129841b = 1;
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public FlowKt__ZipKt$combineTransform$6(e<? extends T>[] eVarArr, yh.q<? super f<? super R>, ? super T[], ? super kotlin.coroutines.c<? super b2>, ? extends Object> qVar, kotlin.coroutines.c<? super FlowKt__ZipKt$combineTransform$6> cVar) {
        super(2, cVar);
        this.f129838d = eVarArr;
        this.f129839e = qVar;
    }

    @dl.e
    public final Object a(@dl.d Object obj) {
        f fVar = (f) this.f129837c;
        e<T>[] eVarArr = this.f129838d;
        f0.w();
        AnonymousClass1 anonymousClass1 = new AnonymousClass1(this.f129838d);
        f0.w();
        AnonymousClass2 anonymousClass2 = new AnonymousClass2(this.f129839e, null);
        c0.e(0);
    ...
    public final kotlin.coroutines.c<b2> create(@dl.e Object obj, @dl.d kotlin.coroutines.c<?> cVar) {
        FlowKt__ZipKt$combineTransform$6 flowKt__ZipKt$combineTransform$6 = new FlowKt__ZipKt$combineTransform$6(this.f129838d, this.f129839e, cVar);
        flowKt__ZipKt$combineTransform$6.f129837c = obj;
    ...
    public final Object invoke(@dl.d f<? super R> fVar, @dl.e kotlin.coroutines.c<? super b2> cVar) {
        return ((FlowKt__ZipKt$combineTransform$6) create(fVar, cVar)).invokeSuspend(b2.f124493a);
    }
