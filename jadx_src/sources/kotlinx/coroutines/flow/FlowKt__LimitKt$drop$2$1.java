...
public final class FlowKt__LimitKt$drop$2$1<T> implements f {
    ...
    final /* synthetic */ Ref.IntRef f129464b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    final /* synthetic */ int f129465c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    final /* synthetic */ f<T> f129466d;

    /* JADX WARN: Multi-variable type inference failed */
    FlowKt__LimitKt$drop$2$1(Ref.IntRef intRef, int i10, f<? super T> fVar) {
        this.f129464b = intRef;
        this.f129465c = i10;
        this.f129466d = fVar;
    }
    ...
    public final Object emit(T t10, @dl.d kotlin.coroutines.c<? super b2> cVar) throws Throwable {
        ...
        if (cVar instanceof FlowKt__LimitKt$drop$2$1$emit$1) {
            ...
            int i10 = flowKt__LimitKt$drop$2$1$emit$1.f129469d;
            if ((i10 & Integer.MIN_VALUE) != 0) {
                flowKt__LimitKt$drop$2$1$emit$1.f129469d = i10 - Integer.MIN_VALUE;
            } else {
        ...
        Object obj = flowKt__LimitKt$drop$2$1$emit$1.f129467b;
        Object objH = kotlin.coroutines.intrinsics.b.h();
        int i11 = flowKt__LimitKt$drop$2$1$emit$1.f129469d;
        if (i11 == 0) {
            t0.n(obj);
            Ref.IntRef intRef = this.f129464b;
            int i12 = intRef.f124889b;
            if (i12 < this.f129465c) {
                intRef.f124889b = i12 + 1;
                return b2.f124493a;
            }
            f<T> fVar = this.f129466d;
            flowKt__LimitKt$drop$2$1$emit$1.f129469d = 1;
            if (fVar.emit(t10, flowKt__LimitKt$drop$2$1$emit$1) == objH) {
                return objH;
            }
        } else {
            if (i11 != 1) {
