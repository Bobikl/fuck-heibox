...
public final class FlowKt__ZipKt$combine$$inlined$unsafeFlow$2<R> implements e<R> {
    ...
    final /* synthetic */ e[] f129772b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    final /* synthetic */ yh.p f129773c;

    public FlowKt__ZipKt$combine$$inlined$unsafeFlow$2(e[] eVarArr, yh.p pVar) {
        this.f129772b = eVarArr;
        this.f129773c = pVar;
    }
    ...
    public Object a(@dl.d f<? super R> fVar, @dl.d kotlin.coroutines.c<? super b2> cVar) {
        e[] eVarArr = this.f129772b;
        f0.w();
        FlowKt__ZipKt$combine$5$1 flowKt__ZipKt$combine$5$1 = new FlowKt__ZipKt$combine$5$1(this.f129772b);
        f0.w();
        Object objA = CombineKt.a(fVar, eVarArr, flowKt__ZipKt$combine$5$1, new FlowKt__ZipKt$combine$5$2(this.f129773c, null), cVar);
    ...
    public Object g(@dl.d f fVar, @dl.d kotlin.coroutines.c cVar) {
        ...
        FlowKt__ZipKt$combine$5$1 flowKt__ZipKt$combine$5$1 = new FlowKt__ZipKt$combine$5$1(this.f129772b);
        f0.w();
        FlowKt__ZipKt$combine$5$2 flowKt__ZipKt$combine$5$2 = new FlowKt__ZipKt$combine$5$2(this.f129773c, null);
        c0.e(0);
