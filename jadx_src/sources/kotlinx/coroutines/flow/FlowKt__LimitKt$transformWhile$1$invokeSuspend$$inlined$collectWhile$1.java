...
public final class FlowKt__LimitKt$transformWhile$1$invokeSuspend$$inlined$collectWhile$1<T> implements f<T> {
    ...
    final /* synthetic */ yh.q f129510b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    final /* synthetic */ f f129511c;
    ...
    @kotlin.coroutines.jvm.internal.d(c = "kotlinx.coroutines.flow.FlowKt__LimitKt$transformWhile$1$invokeSuspend$$inlined$collectWhile$1", f = "Limit.kt", i = {0}, l = {142}, m = "emit", n = {"this"}, s = {"L$0"})
    public static final class AnonymousClass1 extends ContinuationImpl {
        ...
        public final Object invokeSuspend(@dl.d Object obj) {
            this.f129513c = obj;
            this.f129514d |= Integer.MIN_VALUE;
            return FlowKt__LimitKt$transformWhile$1$invokeSuspend$$inlined$collectWhile$1.this.emit(null, this);
        }
    }

    public FlowKt__LimitKt$transformWhile$1$invokeSuspend$$inlined$collectWhile$1(yh.q qVar, f fVar) {
        this.f129510b = qVar;
        this.f129511c = fVar;
    }
    ...
    public Object emit(T t10, @dl.d kotlin.coroutines.c<? super b2> cVar) throws Throwable {
        ...
        if (cVar instanceof AnonymousClass1) {
            ...
            int i10 = anonymousClass1.f129514d;
            if ((i10 & Integer.MIN_VALUE) != 0) {
                anonymousClass1.f129514d = i10 - Integer.MIN_VALUE;
            } else {
        ...
        Object objInvoke = anonymousClass1.f129513c;
        Object objH = kotlin.coroutines.intrinsics.b.h();
        int i11 = anonymousClass1.f129514d;
        if (i11 == 0) {
            t0.n(objInvoke);
            yh.q qVar = this.f129510b;
            f fVar = this.f129511c;
            anonymousClass1.f129512b = this;
            anonymousClass1.f129514d = 1;
            c0.e(6);
            objInvoke = qVar.invoke(fVar, t10, anonymousClass1);
            c0.e(7);
            if (objInvoke == objH) {
                return objH;
            }
            ...
            flowKt__LimitKt$transformWhile$1$invokeSuspend$$inlined$collectWhile$1 = (FlowKt__LimitKt$transformWhile$1$invokeSuspend$$inlined$collectWhile$1) anonymousClass1.f129512b;
            t0.n(objInvoke);
        }
