...
public final class FlowKt__ErrorsKt$catch$$inlined$unsafeFlow$1<T> implements e<T> {
    ...
    final /* synthetic */ e f129420b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    final /* synthetic */ yh.q f129421c;
    ...
    public static final class AnonymousClass1 extends ContinuationImpl {
        ...
        public final Object invokeSuspend(@dl.d Object obj) {
            this.f129422b = obj;
            this.f129423c |= Integer.MIN_VALUE;
            return FlowKt__ErrorsKt$catch$$inlined$unsafeFlow$1.this.a(null, this);
        }
    }

    public FlowKt__ErrorsKt$catch$$inlined$unsafeFlow$1(e eVar, yh.q qVar) {
        this.f129420b = eVar;
        this.f129421c = qVar;
    }
    ...
    public Object a(@dl.d f<? super T> fVar, @dl.d kotlin.coroutines.c<? super b2> cVar) throws Throwable {
        ...
        if (cVar instanceof AnonymousClass1) {
            ...
            int i10 = anonymousClass1.f129423c;
            if ((i10 & Integer.MIN_VALUE) != 0) {
                anonymousClass1.f129423c = i10 - Integer.MIN_VALUE;
            } else {
        ...
        Object objV = anonymousClass1.f129422b;
        Object objH = kotlin.coroutines.intrinsics.b.h();
        int i11 = anonymousClass1.f129423c;
        if (i11 != 0) {
            if (i11 == 1) {
                fVar = (f) anonymousClass1.f129426f;
                flowKt__ErrorsKt$catch$$inlined$unsafeFlow$1 = (FlowKt__ErrorsKt$catch$$inlined$unsafeFlow$1) anonymousClass1.f129425e;
                t0.n(objV);
            } else {
                if (i11 != 2) {
        ...
        t0.n(objV);
        e eVar = this.f129420b;
        anonymousClass1.f129425e = this;
        anonymousClass1.f129426f = fVar;
        anonymousClass1.f129423c = 1;
        objV = g.v(eVar, fVar, anonymousClass1);
        if (objV == objH) {
            return objH;
        }
        flowKt__ErrorsKt$catch$$inlined$unsafeFlow$1 = this;
        Throwable th2 = (Throwable) objV;
        if (th2 != null) {
            yh.q qVar = flowKt__ErrorsKt$catch$$inlined$unsafeFlow$1.f129421c;
            anonymousClass1.f129425e = null;
            anonymousClass1.f129426f = null;
            anonymousClass1.f129423c = 2;
            c0.e(6);
            Object objInvoke = qVar.invoke(fVar, th2, anonymousClass1);
            c0.e(7);
            if (objInvoke == objH) {
                return objH;
            }
