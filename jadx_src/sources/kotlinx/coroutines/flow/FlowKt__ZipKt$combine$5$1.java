...
public final class FlowKt__ZipKt$combine$5$1<T> extends Lambda implements yh.a<T[]> {

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    final /* synthetic */ e<T>[] f129786b;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public FlowKt__ZipKt$combine$5$1(e<? extends T>[] eVarArr) {
        super(0);
        this.f129786b = eVarArr;
    }
    ...
    public final T[] invoke() {
        int length = this.f129786b.length;
        f0.y(0, "T?");
