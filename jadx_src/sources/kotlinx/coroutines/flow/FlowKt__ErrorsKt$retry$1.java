...
public final class FlowKt__ErrorsKt$retry$1 extends SuspendLambda implements yh.p<Throwable, kotlin.coroutines.c<? super Boolean>, Object> {
    ...
    public final Object invoke(@dl.d Throwable th2, @dl.e kotlin.coroutines.c<? super Boolean> cVar) {
        return ((FlowKt__ErrorsKt$retry$1) create(th2, cVar)).invokeSuspend(b2.f124493a);
    }
