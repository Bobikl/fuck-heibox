...
@Metadata(bv = {}, d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0004\u001a\u00020\u0001*\u00020\u00008F¢\u0006\u0006\u001a\u0004\b\u0002\u0010\u0003¨\u0006\u0005"}, d2 = {"Ln0/a$c;", "Landroidx/compose/ui/graphics/vector/c;", ak.av, "(Ln0/a$c;)Landroidx/compose/ui/graphics/vector/c;", "ArrowForward", "material-icons-core_release"}, k = 2, mv = {1, 7, 1})
public final class g {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    @dl.e
    private static androidx.compose.ui.graphics.vector.c f138539a;

    @dl.d
    public static final androidx.compose.ui.graphics.vector.c a(@dl.d n0.a.c cVar) {
        kotlin.jvm.internal.f0.p(cVar, "<this>");
        androidx.compose.ui.graphics.vector.c cVar2 = f138539a;
        if (cVar2 != null) {
            kotlin.jvm.internal.f0.m(cVar2);
            return cVar2;
        }
        androidx.compose.ui.graphics.vector.c.a aVar = new androidx.compose.ui.graphics.vector.c.a("Rounded.ArrowForward", s1.h.g(24.0f), s1.h.g(24.0f), 24.0f, 24.0f, 0L, 0, 96, (kotlin.jvm.internal.u) null);
        ...
        eVar.i(11.17f);
        eVar.k(-4.88f, 4.88f);
        eVar.f(-0.39f, 0.39f, -0.39f, 1.03f, 0.0f, 1.42f);
