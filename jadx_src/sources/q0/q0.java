...
@Metadata(bv = {}, d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0004\u001a\u00020\u0001*\u00020\u00008F¢\u0006\u0006\u001a\u0004\b\u0002\u0010\u0003¨\u0006\u0005"}, d2 = {"Ln0/a$c;", "Landroidx/compose/ui/graphics/vector/c;", ak.av, "(Ln0/a$c;)Landroidx/compose/ui/graphics/vector/c;", "Send", "material-icons-core_release"}, k = 2, mv = {1, 7, 1})
public final class q0 {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    @dl.e
    private static androidx.compose.ui.graphics.vector.c f138560a;

    @dl.d
    public static final androidx.compose.ui.graphics.vector.c a(@dl.d n0.a.c cVar) {
        kotlin.jvm.internal.f0.p(cVar, "<this>");
        androidx.compose.ui.graphics.vector.c cVar2 = f138560a;
        if (cVar2 != null) {
            kotlin.jvm.internal.f0.m(cVar2);
            return cVar2;
        }
        androidx.compose.ui.graphics.vector.c.a aVar = new androidx.compose.ui.graphics.vector.c.a("Rounded.Send", s1.h.g(24.0f), s1.h.g(24.0f), 24.0f, 24.0f, 0L, 0, 96, (kotlin.jvm.internal.u) null);
        ...
        eVar.l(3.4f, 20.4f);
        eVar.k(17.45f, -7.48f);
        eVar.f(0.81f, -0.35f, 0.81f, -1.49f, 0.0f, -1.84f);
        eVar.j(3.4f, 3.6f);
        eVar.f(-0.66f, -0.29f, -1.39f, 0.2f, -1.39f, 0.91f);
        eVar.j(2.0f, 9.12f);
        eVar.f(0.0f, 0.5f, 0.37f, 0.93f, 0.87f, 0.99f);
        eVar.j(17.0f, 12.0f);
        eVar.j(2.87f, 13.88f);
        eVar.f(-0.5f, 0.07f, -0.87f, 0.5f, -0.87f, 1.0f);
        eVar.k(0.01f, 4.61f);
        eVar.f(0.0f, 0.71f, 0.73f, 1.2f, 1.39f, 0.91f);
        eVar.d();
