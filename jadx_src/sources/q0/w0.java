...
@Metadata(bv = {}, d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0004\u001a\u00020\u0001*\u00020\u00008F¢\u0006\u0006\u001a\u0004\b\u0002\u0010\u0003¨\u0006\u0005"}, d2 = {"Ln0/a$c;", "Landroidx/compose/ui/graphics/vector/c;", ak.av, "(Ln0/a$c;)Landroidx/compose/ui/graphics/vector/c;", com.google.common.net.c.f58823g, "material-icons-core_release"}, k = 2, mv = {1, 7, 1})
public final class w0 {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    @dl.e
    private static androidx.compose.ui.graphics.vector.c f138572a;

    @dl.d
    public static final androidx.compose.ui.graphics.vector.c a(@dl.d n0.a.c cVar) {
        kotlin.jvm.internal.f0.p(cVar, "<this>");
        androidx.compose.ui.graphics.vector.c cVar2 = f138572a;
        if (cVar2 != null) {
            kotlin.jvm.internal.f0.m(cVar2);
            return cVar2;
        }
        androidx.compose.ui.graphics.vector.c.a aVar = new androidx.compose.ui.graphics.vector.c.a("Rounded.Warning", s1.h.g(24.0f), s1.h.g(24.0f), 24.0f, 24.0f, 0L, 0, 96, (kotlin.jvm.internal.u) null);
        ...
        eVar.l(4.47f, 21.0f);
        eVar.i(15.06f);
        eVar.f(1.54f, 0.0f, 2.5f, -1.67f, 1.73f, -3.0f);
        eVar.j(13.73f, 4.99f);
        eVar.f(-0.77f, -1.33f, -2.69f, -1.33f, -3.46f, 0.0f);
        eVar.j(2.74f, 18.0f);
        eVar.f(-0.77f, 1.33f, 0.19f, 3.0f, 1.73f, 3.0f);
        eVar.d();
        eVar.l(12.0f, 14.0f);
