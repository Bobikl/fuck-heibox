...
public final class BasicTrustRootIndex implements TrustRootIndex {
    ...
    public BasicTrustRootIndex(@d X509Certificate... caCerts) {
    ...
    public boolean equals(@e Object other) {
        return other == this || ((other instanceof BasicTrustRootIndex) && f0.g(((BasicTrustRootIndex) other).subjectToCaCerts, this.subjectToCaCerts));
    }
