...
public abstract class CertificateChainCleaner {
    ...
    public static final class Companion {
        ...
        @d
        public final CertificateChainCleaner get(@d X509TrustManager trustManager) {
            f0.p(trustManager, "trustManager");
            return Platform.INSTANCE.get().buildCertificateChainCleaner(trustManager);
        }

        @d
        public final CertificateChainCleaner get(@d X509Certificate... caCerts) {
    ...
    @d
    public abstract List<Certificate> clean(@d List<? extends Certificate> chain, @d String hostname) throws SSLPeerUnverifiedException;
}
