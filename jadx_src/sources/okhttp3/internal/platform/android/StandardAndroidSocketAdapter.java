...
public final class StandardAndroidSocketAdapter extends AndroidSocketAdapter {
    ...
    public static final class Companion {
        ...
        @e
        public final SocketAdapter buildIfSupported(@d String packageName) {
    ...
    public StandardAndroidSocketAdapter(@d Class<? super SSLSocket> sslSocketClass, @d Class<? super SSLSocketFactory> sslSocketFactoryClass, @d Class<?> paramClass) {
    ...
    @Override // okhttp3.internal.platform.android.AndroidSocketAdapter, okhttp3.internal.platform.android.SocketAdapter
    @e
    public X509TrustManager trustManager(@d SSLSocketFactory sslSocketFactory) throws IllegalAccessException {
        f0.p(sslSocketFactory, "sslSocketFactory");
