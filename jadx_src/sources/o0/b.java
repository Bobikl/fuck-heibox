...
@Metadata(bv = {}, d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0004\u001a\u00020\u0001*\u00020\u00008F¢\u0006\u0006\u001a\u0004\b\u0002\u0010\u0003¨\u0006\u0005"}, d2 = {"Ln0/a$a;", "Landroidx/compose/ui/graphics/vector/c;", ak.av, "(Ln0/a$a;)Landroidx/compose/ui/graphics/vector/c;", "AccountCircle", "material-icons-core_release"}, k = 2, mv = {1, 7, 1})
public final class b {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    @dl.e
    private static androidx.compose.ui.graphics.vector.c f132124a;

    @dl.d
    public static final androidx.compose.ui.graphics.vector.c a(@dl.d n0.a.C1205a c1205a) {
        kotlin.jvm.internal.f0.p(c1205a, "<this>");
        androidx.compose.ui.graphics.vector.c cVar = f132124a;
        if (cVar != null) {
            kotlin.jvm.internal.f0.m(cVar);
            return cVar;
        }
        androidx.compose.ui.graphics.vector.c.a aVar = new androidx.compose.ui.graphics.vector.c.a("Filled.AccountCircle", s1.h.g(24.0f), s1.h.g(24.0f), 24.0f, 24.0f, 0L, 0, 96, (kotlin.jvm.internal.u) null);
        ...
        eVar.p(13.93f, 13.0f, 12.0f, 13.0f);
        eVar.q(-3.5f, -1.57f, -3.5f, -3.5f);
        eVar.p(10.07f, 6.0f, 12.0f, 6.0f);
        eVar.d();
        eVar.l(12.0f, 20.0f);
        eVar.f(-2.03f, 0.0f, -4.43f, -0.82f, -6.14f, -2.88f);
        eVar.e(7.55f, 15.8f, 9.68f, 15.0f, 12.0f, 15.0f);
        eVar.q(4.45f, 0.8f, 6.14f, 2.12f);
        eVar.e(16.43f, 19.18f, 14.03f, 20.0f, 12.0f, 20.0f);
        eVar.d();
