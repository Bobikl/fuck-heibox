...
@Metadata(bv = {}, d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0004\u001a\u00020\u0001*\u00020\u00008F¢\u0006\u0006\u001a\u0004\b\u0002\u0010\u0003¨\u0006\u0005"}, d2 = {"Ln0/a$a;", "Landroidx/compose/ui/graphics/vector/c;", ak.av, "(Ln0/a$a;)Landroidx/compose/ui/graphics/vector/c;", "Face", "material-icons-core_release"}, k = 2, mv = {1, 7, 1})
public final class u {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    @dl.e
    private static androidx.compose.ui.graphics.vector.c f132162a;

    @dl.d
    public static final androidx.compose.ui.graphics.vector.c a(@dl.d n0.a.C1205a c1205a) {
        kotlin.jvm.internal.f0.p(c1205a, "<this>");
        androidx.compose.ui.graphics.vector.c cVar = f132162a;
        if (cVar != null) {
            kotlin.jvm.internal.f0.m(cVar);
            return cVar;
        }
        androidx.compose.ui.graphics.vector.c.a aVar = new androidx.compose.ui.graphics.vector.c.a("Filled.Face", s1.h.g(24.0f), s1.h.g(24.0f), 24.0f, 24.0f, 0L, 0, 96, (kotlin.jvm.internal.u) null);
        ...
        eVar.f(0.0f, -0.29f, 0.02f, -0.58f, 0.05f, -0.86f);
        eVar.f(2.36f, -1.05f, 4.23f, -2.98f, 5.21f, -5.37f);
        eVar.e(11.07f, 8.33f, 14.05f, 10.0f, 17.42f, 10.0f);
        eVar.f(0.78f, 0.0f, 1.53f, -0.09f, 2.25f, -0.26f);
        eVar.f(0.21f, 0.71f, 0.33f, 1.47f, 0.33f, 2.26f);
