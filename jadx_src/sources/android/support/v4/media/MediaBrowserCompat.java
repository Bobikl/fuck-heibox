...
public final class MediaBrowserCompat {
    ...
    public static class CallbackHandler extends Handler {
        ...
        public void handleMessage(@n0 Message message) {
            ...
            try {
                ...
                if (i10 == 1) {
                    Bundle bundle = data.getBundle(h.f24602k);
                    MediaSessionCompat.ensureClassLoader(bundle);
                    mediaBrowserServiceCallbackImpl.onServiceConnected(messenger, data.getString(h.f24595d), (MediaSessionCompat.Token) data.getParcelable(h.f24597f), bundle);
                } else if (i10 == 2) {
                    mediaBrowserServiceCallbackImpl.onConnectionFailed(messenger);
                } else if (i10 != 3) {
                    Log.w(MediaBrowserCompat.TAG, "Unhandled message: " + message + "\n  Client version: 1\n  Service version: " + message.arg1);
                } else {
                    Bundle bundle2 = data.getBundle(h.f24598g);
                    MediaSessionCompat.ensureClassLoader(bundle2);
                    Bundle bundle3 = data.getBundle(h.f24599h);
                    MediaSessionCompat.ensureClassLoader(bundle3);
                    mediaBrowserServiceCallbackImpl.onLoadChildren(messenger, data.getString(h.f24595d), data.getParcelableArrayList(h.f24596e), bundle2, bundle3);
                }
    ...
    public static class ItemReceiver extends ResultReceiver {
        ...
        protected void onReceiveResult(int i10, Bundle bundle) {
            ...
            if (i10 != 0 || bundle == null || !bundle.containsKey(MediaBrowserServiceCompat.f24438m)) {
                this.mCallback.onError(this.mMediaId);
                return;
            }
            Parcelable parcelable = bundle.getParcelable(MediaBrowserServiceCompat.f24438m);
    ...
    public interface MediaBrowserImpl {
        ...
        void getItem(@n0 String str, @n0 ItemCallback itemCallback);
        ...
        void search(@n0 String str, Bundle bundle, @n0 SearchCallback searchCallback);

        void sendCustomAction(@n0 String str, Bundle bundle, @p0 CustomActionCallback customActionCallback);

        void subscribe(@n0 String str, @p0 Bundle bundle, @n0 SubscriptionCallback subscriptionCallback);

        void unsubscribe(@n0 String str, SubscriptionCallback subscriptionCallback);
    }
    ...
    public static class MediaBrowserImplApi21 implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl, ConnectionCallback.ConnectionCallbackInternal {
        ...
        private final androidx.collection.a<String, Subscription> mSubscriptions = new androidx.collection.a<>();

        MediaBrowserImplApi21(Context context, ComponentName componentName, ConnectionCallback connectionCallback, Bundle bundle) {
            this.mContext = context;
            Bundle bundle2 = bundle != null ? new Bundle(bundle) : new Bundle();
            this.mRootHints = bundle2;
            bundle2.putInt(h.f24607p, 1);
            bundle2.putInt(h.f24608q, Process.myPid());
        ...
        @Override // android.support.v4.media.MediaBrowserCompat.MediaBrowserImpl
        public void getItem(@n0 final String str, @n0 final ItemCallback itemCallback) {
        ...
        public void onConnected() {
            try {
                ...
                this.mServiceVersion = extras.getInt(h.f24609r, 0);
                IBinder iBinderA = r.a(extras, h.f24610s);
                if (iBinderA != null) {
                ...
                IMediaSession iMediaSessionAsInterface = IMediaSession.Stub.asInterface(r.a(extras, h.f24611t));
        ...
        @Override // android.support.v4.media.MediaBrowserCompat.MediaBrowserImpl
        public void search(@n0 final String str, final Bundle bundle, @n0 final SearchCallback searchCallback) {
            if (!isConnected()) {
        ...
        @Override // android.support.v4.media.MediaBrowserCompat.MediaBrowserImpl
        public void sendCustomAction(@n0 final String str, final Bundle bundle, @p0 final CustomActionCallback customActionCallback) {
            if (!isConnected()) {
        ...
        @Override // android.support.v4.media.MediaBrowserCompat.MediaBrowserImpl
        public void subscribe(@n0 String str, Bundle bundle, @n0 SubscriptionCallback subscriptionCallback) {
            Subscription subscription = this.mSubscriptions.get(str);
            if (subscription == null) {
        ...
        @Override // android.support.v4.media.MediaBrowserCompat.MediaBrowserImpl
        public void unsubscribe(@n0 String str, SubscriptionCallback subscriptionCallback) {
            Subscription subscription = this.mSubscriptions.get(str);
            if (subscription == null) {
                return;
            }
    ...
    public static class MediaBrowserImplApi23 extends MediaBrowserImplApi21 {
        ...
        public void getItem(@n0 String str, @n0 ItemCallback itemCallback) {
            if (this.mServiceBinderWrapper == null) {
    ...
    public static class MediaBrowserImplApi26 extends MediaBrowserImplApi23 {
        ...
        @Override // android.support.v4.media.MediaBrowserCompat.MediaBrowserImplApi21, android.support.v4.media.MediaBrowserCompat.MediaBrowserImpl
        public void subscribe(@n0 String str, @p0 Bundle bundle, @n0 SubscriptionCallback subscriptionCallback) {
            ...
            if (i10 == 0 || i10 == 1) {
                ...
                this.mHandler.post(new Runnable() { // from class: android.support.v4.media.MediaBrowserCompat.MediaBrowserImplBase.1
                    ...
                    public void run() {
                        ...
                        Intent intent = new Intent(MediaBrowserServiceCompat.f24437l);
    ...
    public static abstract class SearchCallback {
        ...
        public void onSearchResult(@n0 String str, Bundle bundle, @n0 List<MediaItem> list) {
        }
    }
    ...
    public static class SearchResultReceiver extends ResultReceiver {
        ...
        protected void onReceiveResult(int i10, Bundle bundle) {
            ...
            if (i10 != 0 || bundle == null || !bundle.containsKey(MediaBrowserServiceCompat.f24439n)) {
                this.mCallback.onError(this.mQuery, this.mExtras);
                return;
            }
            Parcelable[] parcelableArray = bundle.getParcelableArray(MediaBrowserServiceCompat.f24439n);
    ...
    public static class ServiceBinderWrapper {
        ...
        void addSubscription(String str, IBinder iBinder, Bundle bundle, Messenger messenger) throws RemoteException {
            ...
            bundle2.putString(h.f24595d, str);
            r.b(bundle2, h.f24592a, iBinder);
            bundle2.putBundle(h.f24598g, bundle);
            sendRequest(3, bundle2, messenger);
        }

        void connect(Context context, Messenger messenger) throws RemoteException {
            Bundle bundle = new Bundle();
            bundle.putString(h.f24600i, context.getPackageName());
            bundle.putInt(h.f24594c, Process.myPid());
            bundle.putBundle(h.f24602k, this.mRootHints);
        ...
        void getMediaItem(String str, ResultReceiver resultReceiver, Messenger messenger) throws RemoteException {
            Bundle bundle = new Bundle();
            bundle.putString(h.f24595d, str);
            bundle.putParcelable(h.f24601j, resultReceiver);
        ...
        void removeSubscription(String str, IBinder iBinder, Messenger messenger) throws RemoteException {
            Bundle bundle = new Bundle();
            bundle.putString(h.f24595d, str);
            r.b(bundle, h.f24592a, iBinder);
            sendRequest(4, bundle, messenger);
        }

        void search(String str, Bundle bundle, ResultReceiver resultReceiver, Messenger messenger) throws RemoteException {
            Bundle bundle2 = new Bundle();
            bundle2.putString(h.f24604m, str);
            bundle2.putBundle(h.f24603l, bundle);
            bundle2.putParcelable(h.f24601j, resultReceiver);
        ...
        void sendCustomAction(String str, Bundle bundle, ResultReceiver resultReceiver, Messenger messenger) throws RemoteException {
            Bundle bundle2 = new Bundle();
            bundle2.putString(h.f24605n, str);
            bundle2.putBundle(h.f24606o, bundle);
            bundle2.putParcelable(h.f24601j, resultReceiver);
    ...
    public static class Subscription {
        ...
        public SubscriptionCallback getCallback(Bundle bundle) {
            for (int i10 = 0; i10 < this.mOptionsList.size(); i10++) {
                if (g.a(this.mOptionsList.get(i10), bundle)) {
    ...
    public static abstract class SubscriptionCallback {
        ...
        public void onChildrenLoaded(@n0 String str, @n0 List<MediaItem> list) {
        }

        public void onChildrenLoaded(@n0 String str, @n0 List<MediaItem> list, @n0 Bundle bundle) {
        }
    ...
    public void search(@n0 String str, Bundle bundle, @n0 SearchCallback searchCallback) {
        if (TextUtils.isEmpty(str)) {
    ...
    public void sendCustomAction(@n0 String str, Bundle bundle, @p0 CustomActionCallback customActionCallback) {
        if (TextUtils.isEmpty(str)) {
    ...
    public void subscribe(@n0 String str, @n0 Bundle bundle, @n0 SubscriptionCallback subscriptionCallback) {
        if (TextUtils.isEmpty(str)) {
    ...
    public void subscribe(@n0 String str, @n0 SubscriptionCallback subscriptionCallback) {
        if (TextUtils.isEmpty(str)) {
            throw new IllegalArgumentException("parentId is empty");
        }
        if (subscriptionCallback == null) {
    ...
    public void unsubscribe(@n0 String str) {
        if (TextUtils.isEmpty(str)) {
            throw new IllegalArgumentException("parentId is empty");
        }
    ...
    public void unsubscribe(@n0 String str, @n0 SubscriptionCallback subscriptionCallback) {
        if (TextUtils.isEmpty(str)) {
            throw new IllegalArgumentException("parentId is empty");
        }
        if (subscriptionCallback == null) {
