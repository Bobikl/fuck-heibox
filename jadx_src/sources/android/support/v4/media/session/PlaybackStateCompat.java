...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public static class Api21Impl {
        ...
        @u
        static PlaybackState.CustomAction.Builder createCustomActionBuilder(String str, CharSequence charSequence, int i10) {
        ...
        @u
        static void setState(PlaybackState.Builder builder, int i10, long j10, float f10, long j11) {
    ...
    public String toString() {
        return "PlaybackState {state=" + this.mState + ", position=" + this.mPosition + ", buffered position=" + this.mBufferedPosition + ", speed=" + this.mSpeed + ", updated=" + this.mUpdateTime + ", actions=" + this.mActions + ", error code=" + this.mErrorCode + ", error message=" + this.mErrorMessage + ", custom actions=" + this.mCustomActions + ", active item id=" + this.mActiveItemId + z5.g.f141884d;
    }
