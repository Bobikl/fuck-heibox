...
public class MediaSessionCompat {
    ...
    public static abstract class Callback {
        ...
        public class CallbackHandler extends Handler {
            ...
            public void handleMessage(Message message) {
                ...
                if (message.what == 1) {
                    ...
                    mediaSessionImpl.setCurrentControllerInfo((l.b) message.obj);
        ...
        public class MediaSessionCallbackApi21 extends MediaSession.Callback {
            ...
            private void setCurrentControllerInfo(MediaSessionImpl mediaSessionImpl) {
                ...
                if (TextUtils.isEmpty(callingPackage)) {
                    callingPackage = l.b.f24623b;
                }
                mediaSessionImpl.setCurrentControllerInfo(new l.b(callingPackage, -1, -1));
            }
            ...
            public void onCommand(String str, Bundle bundle, ResultReceiver resultReceiver) {
                ...
                try {
                    ...
                    if (str.equals(MediaControllerCompat.COMMAND_GET_EXTRA_BINDER)) {
                        ...
                        r.b(bundle2, MediaSessionCompat.KEY_EXTRA_BINDER, iBinderAsBinder);
                        androidx.versionedparcelable.c.e(bundle2, MediaSessionCompat.KEY_SESSION2_TOKEN, sessionToken.getSession2Token());
        ...
        public boolean onMediaButtonEvent(Intent intent) {
            ...
            l.b currentControllerInfo = mediaSessionImpl.getCurrentControllerInfo();
    ...
    public interface MediaSessionImpl {
        ...
        void setCurrentControllerInfo(l.b bVar);
    ...
    public static class MediaSessionImplApi18 extends MediaSessionImplBase {
        ...
        MediaSessionImplApi18(Context context, String str, ComponentName componentName, PendingIntent pendingIntent, androidx.versionedparcelable.g gVar, Bundle bundle) {
    ...
    public static class MediaSessionImplApi19 extends MediaSessionImplApi18 {
        MediaSessionImplApi19(Context context, String str, ComponentName componentName, PendingIntent pendingIntent, androidx.versionedparcelable.g gVar, Bundle bundle) {
            super(context, str, componentName, pendingIntent, gVar, bundle);
        }
    ...
    public static class MediaSessionImplApi21 implements MediaSessionImpl {
        ...
        public class ExtraSession extends IMediaSession.Stub {
            ...
            public void registerCallbackListener(IMediaControllerCallback iMediaControllerCallback) {
                ...
                MediaSessionImplApi21.this.mExtraControllerCallbacks.register(iMediaControllerCallback, new l.b(l.b.f24623b, Binder.getCallingPid(), Binder.getCallingUid()));
            }
        ...
        MediaSessionImplApi21(Context context, String str, androidx.versionedparcelable.g gVar, Bundle bundle) {
            ...
            this.mToken = new Token(mediaSessionCreateFwkMediaSession.getSessionToken(), new ExtraSession(), gVar);
        ...
        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public l.b getCurrentControllerInfo() {
            l.b bVar;
            synchronized (this.mLock) {
        ...
        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public void setCurrentControllerInfo(l.b bVar) {
            synchronized (this.mLock) {
        ...
        public void setPlaybackToRemote(p pVar) {
            this.mSessionFwk.setPlaybackToRemote((VolumeProvider) pVar.e());
        }
    ...
    public static class MediaSessionImplApi22 extends MediaSessionImplApi21 {
        MediaSessionImplApi22(Context context, String str, androidx.versionedparcelable.g gVar, Bundle bundle) {
    ...
    public static class MediaSessionImplApi28 extends MediaSessionImplApi22 {
        MediaSessionImplApi28(Context context, String str, androidx.versionedparcelable.g gVar, Bundle bundle) {
            super(context, str, gVar, bundle);
        }
        ...
        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImplApi21, android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        @n0
        public final l.b getCurrentControllerInfo() {
            return new l.b(this.mSessionFwk.getCurrentControllerInfo());
        }
    ...
    public static class MediaSessionImplApi29 extends MediaSessionImplApi28 {
        MediaSessionImplApi29(Context context, String str, androidx.versionedparcelable.g gVar, Bundle bundle) {
            super(context, str, gVar, bundle);
        }
    ...
    public static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        int mFlags = 3;
        private p.d mVolumeCallback = new p.d() { // from class: android.support.v4.media.session.MediaSessionCompat.MediaSessionImplBase.1
            @Override // androidx.media.p.d
            public void onVolumeChanged(p pVar) {
                if (MediaSessionImplBase.this.mVolumeProvider != pVar) {
                    return;
                }
                MediaSessionImplBase mediaSessionImplBase = MediaSessionImplBase.this;
                MediaSessionImplBase.this.sendVolumeInfoChanged(new ParcelableVolumeInfo(mediaSessionImplBase.mVolumeType, mediaSessionImplBase.mLocalStream, pVar.c(), pVar.b(), pVar.a()));
            }
        };
        ...
        public class MediaSessionStub extends IMediaSession.Stub {
            ...
            public ParcelableVolumeInfo getVolumeAttributes() {
                ...
                synchronized (MediaSessionImplBase.this.mLock) {
                    ...
                    p pVar = mediaSessionImplBase.mVolumeProvider;
                    i12 = 2;
                    if (i10 == 2) {
                        int iC = pVar.c();
                        int iB = pVar.b();
            ...
            public void registerCallbackListener(IMediaControllerCallback iMediaControllerCallback) {
                if (MediaSessionImplBase.this.mDestroyed) {
                    ...
                    MediaSessionImplBase.this.mControllerCallbacks.register(iMediaControllerCallback, new l.b(MediaSessionImplBase.this.getPackageNameForUid(Binder.getCallingUid()), Binder.getCallingPid(), Binder.getCallingUid()));
                }
            }
        ...
        public class MessageHandler extends Handler {
            ...
            public void handleMessage(Message message) {
                ...
                MediaSessionImplBase.this.setCurrentControllerInfo(new l.b(data.getString(MediaSessionCompat.DATA_CALLING_PACKAGE), data.getInt("data_calling_pid"), data.getInt("data_calling_uid")));
        ...
        public MediaSessionImplBase(Context context, String str, ComponentName componentName, PendingIntent pendingIntent, androidx.versionedparcelable.g gVar, Bundle bundle) {
            ...
            this.mToken = new Token(mediaSessionStub, null, gVar);
            this.mRatingType = 0;
            this.mVolumeType = 1;
            this.mLocalStream = 3;
        ...
        String getPackageNameForUid(int i10) {
            ...
            return TextUtils.isEmpty(nameForUid) ? l.b.f24623b : nameForUid;
        }
        ...
        public void setPlaybackToRemote(p pVar) {
            ...
            p pVar2 = this.mVolumeProvider;
            if (pVar2 != null) {
                pVar2.h(null);
            }
            this.mVolumeType = 2;
            this.mVolumeProvider = pVar;
    ...
    public static final class QueueItem implements Parcelable {
        ...
        public static class Api21Impl {
            ...
            @u
            static MediaSession.QueueItem createQueueItem(MediaDescription mediaDescription, long j10) {
    ...
    public static final class Token implements Parcelable {
        ...
        @b0("mLock")
        private androidx.versionedparcelable.g mSession2Token;
        ...
        Token(Object obj, IMediaSession iMediaSession, androidx.versionedparcelable.g gVar) {
        ...
        public static Token fromBundle(Bundle bundle) {
            ...
            IMediaSession iMediaSessionAsInterface = IMediaSession.Stub.asInterface(r.a(bundle, MediaSessionCompat.KEY_EXTRA_BINDER));
            androidx.versionedparcelable.g gVarC = androidx.versionedparcelable.c.c(bundle, MediaSessionCompat.KEY_SESSION2_TOKEN);
            Token token = (Token) bundle.getParcelable(MediaSessionCompat.KEY_TOKEN);
            if (token == null) {
                return null;
            }
            return new Token(token.mInner, iMediaSessionAsInterface, gVarC);
        }
        ...
        @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
        public androidx.versionedparcelable.g getSession2Token() {
        ...
        @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
        public void setSession2Token(androidx.versionedparcelable.g gVar) {
            synchronized (this.mLock) {
                this.mSession2Token = gVar;
            }
        }
        ...
        public Bundle toBundle() {
            ...
            synchronized (this.mLock) {
                ...
                if (iMediaSession != null) {
                    r.b(bundle, MediaSessionCompat.KEY_EXTRA_BINDER, iMediaSession.asBinder());
                }
                androidx.versionedparcelable.g gVar = this.mSession2Token;
                if (gVar != null) {
                    androidx.versionedparcelable.c.e(bundle, MediaSessionCompat.KEY_SESSION2_TOKEN, gVar);
                }
            }
            return bundle;
        }
    ...
    static {
        PENDING_INTENT_FLAG_MUTABLE = androidx.core.os.a.i() ? 33554432 : 0;
    }
    ...
    @SuppressLint({"WrongConstant"})
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
    public MediaSessionCompat(@n0 Context context, @n0 String str, @p0 ComponentName componentName, @p0 PendingIntent pendingIntent, @p0 Bundle bundle, @p0 androidx.versionedparcelable.g gVar) {
        this.mActiveListeners = new ArrayList<>();
        if (context == null) {
        ...
        if (i10 >= 29) {
            this.mImpl = new MediaSessionImplApi29(context, str, gVar, bundle);
        } else if (i10 >= 28) {
            this.mImpl = new MediaSessionImplApi28(context, str, gVar, bundle);
        } else {
            this.mImpl = new MediaSessionImplApi22(context, str, gVar, bundle);
        }
    ...
    @RestrictTo({RestrictTo.Scope.LIBRARY})
    public static void ensureClassLoader(@p0 Bundle bundle) {
        if (bundle != null) {
    ...
    public static MediaSessionCompat fromMediaSession(Context context, Object obj) {
        ...
        if (i10 >= 29) {
            ...
            mediaSessionImplApi28 = i10 >= 28 ? new MediaSessionImplApi28(obj) : new MediaSessionImplApi21(obj);
        }
    ...
    static PlaybackStateCompat getStateWithUpdatedPosition(PlaybackStateCompat playbackStateCompat, MediaMetadataCompat mediaMetadataCompat) {
        ...
        if (j11 < 0 || playbackSpeed <= j11) {
            j10 = playbackSpeed < 0 ? 0L : playbackSpeed;
        } else {
            j10 = j11;
        }
    ...
    @RestrictTo({RestrictTo.Scope.LIBRARY})
    @p0
    public static Bundle unparcelWithClassLoader(@p0 Bundle bundle) {
        if (bundle == null) {
            return null;
        }
    ...
    public void setPlaybackToRemote(p pVar) {
        ...
        this.mImpl.setPlaybackToRemote(pVar);
    }
