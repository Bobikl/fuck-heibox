...
public class c {
    ...
    static volatile String f30003b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    static f f30004c;

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    static final byte[][] f30002a = {new byte[]{-64, 0, 0, -86}, new byte[]{-64, 0, 0, -85}};

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    static ConcurrentHashMap<String, f> f30005d = new ConcurrentHashMap<>();

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    static ConcurrentHashMap<String, Integer> f30006e = new ConcurrentHashMap<>();

    static {
        f30003b = null;
        f30004c = null;
        try {
            f30004c = new f((Inet6Address) InetAddress.getAllByName("64:ff9b::")[0], 96);
            f30003b = b(NetworkStatusHelper.getStatus());
    ...
    public static String a(Inet4Address inet4Address) throws Exception {
        ...
        byte[] address2 = fVarD.f30011b.getAddress();
        int i10 = fVarD.f30010a / 8;
        int i11 = 0;
        int i12 = 0;
        while (true) {
            int i13 = i11 + i10;
    ...
    public static boolean b() {
        Integer num = f30006e.get(f30003b);
    ...
    public static f d() {
        f fVar = f30005d.get(f30003b);
        return fVar == null ? f30004c : fVar;
    }
    ...
    public static void e() {
        ...
        f30003b = b(NetworkStatusHelper.getStatus());
        if (f30006e.putIfAbsent(f30003b, 0) != null) {
            return;
        }
        int iJ = j();
        f30006e.put(f30003b, Integer.valueOf(iJ));
