...
public class GifImageButton extends ImageButton {
    ...
    public Parcelable onSaveInstanceState() {
        return new GifViewSavedState(super.onSaveInstanceState(), this.f138315b ? getDrawable() : null, this.f138315b ? getBackground() : null);
    }
