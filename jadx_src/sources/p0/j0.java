...
@Metadata(bv = {}, d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0004\u001a\u00020\u0001*\u00020\u00008F¢\u0006\u0006\u001a\u0004\b\u0002\u0010\u0003¨\u0006\u0005"}, d2 = {"Ln0/a$b;", "Landroidx/compose/ui/graphics/vector/c;", ak.av, "(Ln0/a$b;)Landroidx/compose/ui/graphics/vector/c;", "Notifications", "material-icons-core_release"}, k = 2, mv = {1, 7, 1})
public final class j0 {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    @dl.e
    private static androidx.compose.ui.graphics.vector.c f138104a;

    @dl.d
    public static final androidx.compose.ui.graphics.vector.c a(@dl.d n0.a.b bVar) {
        kotlin.jvm.internal.f0.p(bVar, "<this>");
        androidx.compose.ui.graphics.vector.c cVar = f138104a;
        if (cVar != null) {
            kotlin.jvm.internal.f0.m(cVar);
            return cVar;
        }
        androidx.compose.ui.graphics.vector.c.a aVar = new androidx.compose.ui.graphics.vector.c.a("Outlined.Notifications", s1.h.g(24.0f), s1.h.g(24.0f), 24.0f, 24.0f, 0L, 0, 96, (kotlin.jvm.internal.u) null);
        ...
        eVar.l(18.0f, 16.0f);
        eVar.u(-5.0f);
        eVar.f(0.0f, -3.07f, -1.63f, -5.64f, -4.5f, -6.32f);
        eVar.j(13.5f, 4.0f);
        eVar.f(0.0f, -0.83f, -0.67f, -1.5f, -1.5f, -1.5f);
        eVar.q(-1.5f, 0.67f, -1.5f, 1.5f);
        eVar.u(0.68f);
        eVar.e(7.64f, 5.36f, 6.0f, 7.92f, 6.0f, 11.0f);
        eVar.u(5.0f);
        eVar.k(-2.0f, 2.0f);
        eVar.u(1.0f);
        eVar.i(16.0f);
        ...
        eVar.j(8.0f, 17.0f);
        eVar.u(-6.0f);
        eVar.f(0.0f, -2.48f, 1.51f, -4.5f, 4.0f, -4.5f);
        eVar.q(4.0f, 2.02f, 4.0f, 4.5f);
        eVar.u(6.0f);
        eVar.d();
