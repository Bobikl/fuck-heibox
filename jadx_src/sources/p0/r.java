...
@Metadata(bv = {}, d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0004\u001a\u00020\u0001*\u00020\u00008F¢\u0006\u0006\u001a\u0004\b\u0002\u0010\u0003¨\u0006\u0005"}, d2 = {"Ln0/a$b;", "Landroidx/compose/ui/graphics/vector/c;", ak.av, "(Ln0/a$b;)Landroidx/compose/ui/graphics/vector/c;", "Edit", "material-icons-core_release"}, k = 2, mv = {1, 7, 1})
public final class r {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    @dl.e
    private static androidx.compose.ui.graphics.vector.c f138119a;

    @dl.d
    public static final androidx.compose.ui.graphics.vector.c a(@dl.d n0.a.b bVar) {
        kotlin.jvm.internal.f0.p(bVar, "<this>");
        androidx.compose.ui.graphics.vector.c cVar = f138119a;
        if (cVar != null) {
            kotlin.jvm.internal.f0.m(cVar);
            return cVar;
        }
        androidx.compose.ui.graphics.vector.c.a aVar = new androidx.compose.ui.graphics.vector.c.a("Outlined.Edit", s1.h.g(24.0f), s1.h.g(24.0f), 24.0f, 24.0f, 0L, 0, 96, (kotlin.jvm.internal.u) null);
        ...
        eVar.k(9.06f, -9.06f);
        eVar.l(17.66f, 3.0f);
        eVar.f(-0.25f, 0.0f, -0.51f, 0.1f, -0.7f, 0.29f);
        eVar.k(-1.83f, 1.83f);
        eVar.k(3.75f, 3.75f);
        eVar.k(1.83f, -1.83f);
