...
@Metadata(bv = {}, d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0004\u001a\u00020\u0001*\u00020\u00008F¢\u0006\u0006\u001a\u0004\b\u0002\u0010\u0003¨\u0006\u0005"}, d2 = {"Ln0/a$b;", "Landroidx/compose/ui/graphics/vector/c;", ak.av, "(Ln0/a$b;)Landroidx/compose/ui/graphics/vector/c;", "Place", "material-icons-core_release"}, k = 2, mv = {1, 7, 1})
public final class m0 {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    @dl.e
    private static androidx.compose.ui.graphics.vector.c f138110a;

    @dl.d
    public static final androidx.compose.ui.graphics.vector.c a(@dl.d n0.a.b bVar) {
        kotlin.jvm.internal.f0.p(bVar, "<this>");
        androidx.compose.ui.graphics.vector.c cVar = f138110a;
        if (cVar != null) {
            kotlin.jvm.internal.f0.m(cVar);
            return cVar;
        }
        androidx.compose.ui.graphics.vector.c.a aVar = new androidx.compose.ui.graphics.vector.c.a("Outlined.Place", s1.h.g(24.0f), s1.h.g(24.0f), 24.0f, 24.0f, 0L, 0, 96, (kotlin.jvm.internal.u) null);
        ...
        eVar.q(0.9f, -2.0f, 2.0f, -2.0f);
        eVar.q(2.0f, 0.9f, 2.0f, 2.0f);
        eVar.q(-0.9f, 2.0f, -2.0f, 2.0f);
        eVar.d();
        eVar.l(18.0f, 10.2f);
        eVar.e(18.0f, 6.57f, 15.35f, 4.0f, 12.0f, 4.0f);
        eVar.q(-6.0f, 2.57f, -6.0f, 6.2f);
        eVar.f(0.0f, 2.34f, 1.95f, 5.44f, 6.0f, 9.14f);
        eVar.f(4.05f, -3.7f, 6.0f, -6.8f, 6.0f, -9.14f);
        eVar.d();
        eVar.l(12.0f, 2.0f);
        eVar.f(4.2f, 0.0f, 8.0f, 3.22f, 8.0f, 8.2f);
        eVar.f(0.0f, 3.32f, -2.67f, 7.25f, -8.0f, 11.8f);
        eVar.f(-5.33f, -4.55f, -8.0f, -8.48f, -8.0f, -11.8f);
        eVar.e(4.0f, 5.22f, 7.8f, 2.0f, 12.0f, 2.0f);
        eVar.d();
