...
@Metadata(bv = {}, d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0004\u001a\u00020\u0001*\u00020\u00008F¢\u0006\u0006\u001a\u0004\b\u0002\u0010\u0003¨\u0006\u0005"}, d2 = {"Ln0/a$b;", "Landroidx/compose/ui/graphics/vector/c;", ak.av, "(Ln0/a$b;)Landroidx/compose/ui/graphics/vector/c;", "Person", "material-icons-core_release"}, k = 2, mv = {1, 7, 1})
public final class k0 {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    @dl.e
    private static androidx.compose.ui.graphics.vector.c f138106a;

    @dl.d
    public static final androidx.compose.ui.graphics.vector.c a(@dl.d n0.a.b bVar) {
        kotlin.jvm.internal.f0.p(bVar, "<this>");
        androidx.compose.ui.graphics.vector.c cVar = f138106a;
        if (cVar != null) {
            kotlin.jvm.internal.f0.m(cVar);
            return cVar;
        }
        androidx.compose.ui.graphics.vector.c.a aVar = new androidx.compose.ui.graphics.vector.c.a("Outlined.Person", s1.h.g(24.0f), s1.h.g(24.0f), 24.0f, 24.0f, 0L, 0, 96, (kotlin.jvm.internal.u) null);
        ...
        eVar.q(0.9f, -2.0f, 2.0f, -2.0f);
        eVar.m(0.0f, 10.0f);
        eVar.f(2.7f, 0.0f, 5.8f, 1.29f, 6.0f, 2.0f);
        eVar.j(6.0f, 18.0f);
        eVar.f(0.23f, -0.72f, 3.31f, -2.0f, 6.0f, -2.0f);
        eVar.m(0.0f, -12.0f);
        eVar.e(9.79f, 4.0f, 8.0f, 5.79f, 8.0f, 8.0f);
        eVar.q(1.79f, 4.0f, 4.0f, 4.0f);
        eVar.q(4.0f, -1.79f, 4.0f, -4.0f);
        eVar.q(-1.79f, -4.0f, -4.0f, -4.0f);
        eVar.d();
        eVar.l(12.0f, 14.0f);
        eVar.f(-2.67f, 0.0f, -8.0f, 1.34f, -8.0f, 4.0f);
        eVar.u(2.0f);
        eVar.i(16.0f);
        eVar.u(-2.0f);
        eVar.f(0.0f, -2.66f, -5.33f, -4.0f, -8.0f, -4.0f);
        eVar.d();
