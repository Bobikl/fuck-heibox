...
public final class c {
    ...
    private static final Map f130924a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static final Map f130925b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private static final Map f130926c;
    ...
    static {
        ...
        f130926c = new HashMap();
        for (Map.Entry entry : map2.entrySet()) {
            f130926c.put((String) entry.getValue(), (Integer) entry.getKey());
        }
    }

    @a
    public static int a(String str) {
        Integer num = (Integer) f130926c.get(str);
        if (num != null) {
            return num.intValue();
        }
