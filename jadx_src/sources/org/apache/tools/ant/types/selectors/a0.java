...
/* JADX INFO: compiled from: NoneSelector.java */
...
public class a0 extends j {
    ...
    public boolean P0(final File file, final String str, final File file2) {
        i2();
        return Stream.of((Object[]) N0(b())).noneMatch(new Predicate() { // from class: org.apache.tools.ant.types.selectors.z
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                return a0.t2(file, str, file2, (v) obj);
            }
        });
    }
