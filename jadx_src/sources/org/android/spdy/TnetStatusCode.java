...
public final class TnetStatusCode {
    ...
    public static final int getErrno(int i10) {
        if (i10 <= -3800) {
            return 0;
        }
        if (i10 <= -3500) {
            return EASY_REASON_SLIGHTSSL_ERROR - i10;
        }
        if (i10 <= -3000) {
            return EASY_REASON_HANDSHAKE_ERROR - i10;
        }
        if (i10 <= -2500) {
            return EASY_REASON_CONN_ERROR - i10;
        }
        if (i10 <= -2300) {
            return EASY_REASON_WRITE_ERROR - i10;
        }
        if (i10 <= -2100) {
            return EASY_REASON_READ_ERROR - i10;
        }
        return 0;
    }

    public static final int getReqStage(int i10) {
        int statusCode = getStatusCode(i10);
    ...
    public static final int getStatusCode(int i10) {
        if (i10 <= -3800) {
            return i10;
        }
        if (i10 <= -3500) {
        ...
        if (i10 <= -2500) {
            return EASY_REASON_CONN_ERROR;
        }
        if (i10 <= -2300) {
            return EASY_REASON_WRITE_ERROR;
        }
        return i10 <= -2100 ? EASY_REASON_READ_ERROR : i10;
    }
}
