...
public class KeyDescObj implements Serializable {
    ...
    @JSONField(alternateNames = {"description"}, name = SocialConstants.PARAM_APP_DESC)
    private String desc;
    ...
    private String f66939id;

    @SerializedName(alternate = {"img_url", "right_img"}, value = SocialConstants.PARAM_IMG_URL)
    @JSONField(alternateNames = {"img_url", "right_img"}, name = SocialConstants.PARAM_IMG_URL)
    private String img;
    private int index;
    ...
    @SerializedName(alternate = {"selectable"}, value = "canClick")
    @JSONField(alternateNames = {"selectable"}, name = "canClick")
    ...
    public KeyDescObj(String str) {
        this.name = str;
    }

    public KeyDescObj(String str, String str2, String str3) {
        this.name = str;
        this.protocol = str2;
        this.icon = str3;
    }
    ...
    public boolean equals(Object obj) {
        PatchProxyResult patchProxyResultProxy = PatchProxy.proxy(new Object[]{obj}, this, changeQuickRedirect, false, c.d.O3, new Class[]{Object.class}, Boolean.TYPE);
    ...
    public int hashCode() {
        PatchProxyResult patchProxyResultProxy = PatchProxy.proxy(new Object[0], this, changeQuickRedirect, false, c.d.P3, new Class[0], Integer.TYPE);
