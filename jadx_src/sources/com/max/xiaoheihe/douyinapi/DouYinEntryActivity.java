...
public class DouYinEntryActivity extends Activity implements a {
    ...
    public void c(b bVar) {
        if (PatchProxy.proxy(new Object[]{bVar}, this, changeQuickRedirect, false, 21957, new Class[]{b.class}, Void.TYPE).isSupported) {
            return;
        }
    ...
    public void onCreate(@p0 Bundle bundle) {
        if (PatchProxy.proxy(new Object[]{bundle}, this, changeQuickRedirect, false, 21956, new Class[]{Bundle.class}, Void.TYPE).isSupported) {
            return;
        }
    ...
    public void onPointerCaptureChanged(boolean z10) {
        if (PatchProxy.proxy(new Object[]{new Byte(z10 ? (byte) 1 : (byte) 0)}, this, changeQuickRedirect, false, 21959, new Class[]{Boolean.TYPE}, Void.TYPE).isSupported) {
            return;
        }
