...
/* JADX INFO: compiled from: FollowListItemView.kt */
...
public final class FollowListItemView extends RelativeLayout {
    ...
    public static final int f78840h = 8;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public HeyBoxAvatarView f78841b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public FollowButton f78842c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    public View f78843d;

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    public TextView f78844e;

    /* JADX INFO: renamed from: f, reason: collision with root package name */
    public RelativeLayout f78845f;

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    public TextView f78846g;

    public FollowListItemView(@dl.e Context context) {
        this(context, null);
    }

    public FollowListItemView(@dl.e Context context, @dl.e AttributeSet attributeSet) {
        this(context, attributeSet, 0);
    }

    public FollowListItemView(@dl.e Context context, @dl.e AttributeSet attributeSet, int i10) {
        this(context, attributeSet, i10, 0);
    }

    public FollowListItemView(@dl.e Context context, @dl.e AttributeSet attributeSet, int i10, int i11) {
    ...
    public final HeyBoxAvatarView getAvatar() {
        PatchProxyResult patchProxyResultProxy = PatchProxy.proxy(new Object[0], this, changeQuickRedirect, false, 24853, new Class[0], HeyBoxAvatarView.class);
        if (patchProxyResultProxy.isSupported) {
            return (HeyBoxAvatarView) patchProxyResultProxy.result;
        }
        HeyBoxAvatarView heyBoxAvatarView = this.f78841b;
    ...
    public final View getDivider() {
        PatchProxyResult patchProxyResultProxy = PatchProxy.proxy(new Object[0], this, changeQuickRedirect, false, 24857, new Class[0], View.class);
        if (patchProxyResultProxy.isSupported) {
            return (View) patchProxyResultProxy.result;
        }
        View view = this.f78843d;
        if (view != null) {
            return view;
        }
        f0.S(SearchHelper.E);
    ...
    public final FollowButton getFb() {
        PatchProxyResult patchProxyResultProxy = PatchProxy.proxy(new Object[0], this, changeQuickRedirect, false, 24855, new Class[0], FollowButton.class);
        if (patchProxyResultProxy.isSupported) {
            return (FollowButton) patchProxyResultProxy.result;
        }
        FollowButton followButton = this.f78842c;
    ...
    public final RelativeLayout getRl_medal_level() {
        PatchProxyResult patchProxyResultProxy = PatchProxy.proxy(new Object[0], this, changeQuickRedirect, false, 24861, new Class[0], RelativeLayout.class);
        if (patchProxyResultProxy.isSupported) {
            return (RelativeLayout) patchProxyResultProxy.result;
        }
        RelativeLayout relativeLayout = this.f78845f;
    ...
    public final TextView getTv_desc() {
        PatchProxyResult patchProxyResultProxy = PatchProxy.proxy(new Object[0], this, changeQuickRedirect, false, 24863, new Class[0], TextView.class);
        if (patchProxyResultProxy.isSupported) {
            return (TextView) patchProxyResultProxy.result;
        }
        TextView textView = this.f78846g;
        if (textView != null) {
            return textView;
        }
        f0.S("tv_desc");
    ...
    public final TextView getTv_name() {
        PatchProxyResult patchProxyResultProxy = PatchProxy.proxy(new Object[0], this, changeQuickRedirect, false, 24859, new Class[0], TextView.class);
        if (patchProxyResultProxy.isSupported) {
            return (TextView) patchProxyResultProxy.result;
        }
        TextView textView = this.f78844e;
        if (textView != null) {
            return textView;
        }
        f0.S("tv_name");
    ...
    public final void setAvatar(@dl.d HeyBoxAvatarView heyBoxAvatarView) {
        if (PatchProxy.proxy(new Object[]{heyBoxAvatarView}, this, changeQuickRedirect, false, 24854, new Class[]{HeyBoxAvatarView.class}, Void.TYPE).isSupported) {
            return;
        }
        f0.p(heyBoxAvatarView, "<set-?>");
        this.f78841b = heyBoxAvatarView;
    }
    ...
    public final void setFb(@dl.d FollowButton followButton) {
        if (PatchProxy.proxy(new Object[]{followButton}, this, changeQuickRedirect, false, 24856, new Class[]{FollowButton.class}, Void.TYPE).isSupported) {
            return;
        }
        f0.p(followButton, "<set-?>");
        this.f78842c = followButton;
    }
    ...
    public final void setRl_medal_level(@dl.d RelativeLayout relativeLayout) {
        if (PatchProxy.proxy(new Object[]{relativeLayout}, this, changeQuickRedirect, false, 24862, new Class[]{RelativeLayout.class}, Void.TYPE).isSupported) {
            return;
        }
        f0.p(relativeLayout, "<set-?>");
        this.f78845f = relativeLayout;
    }

    public final void setTv_desc(@dl.d TextView textView) {
        if (PatchProxy.proxy(new Object[]{textView}, this, changeQuickRedirect, false, 24864, new Class[]{TextView.class}, Void.TYPE).isSupported) {
            return;
        }
        f0.p(textView, "<set-?>");
        this.f78846g = textView;
    }

    public final void setTv_name(@dl.d TextView textView) {
        if (PatchProxy.proxy(new Object[]{textView}, this, changeQuickRedirect, false, 24860, new Class[]{TextView.class}, Void.TYPE).isSupported) {
            return;
        }
        f0.p(textView, "<set-?>");
        this.f78844e = textView;
    }
}
