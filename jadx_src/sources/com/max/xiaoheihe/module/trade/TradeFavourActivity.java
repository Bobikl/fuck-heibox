...
/* JADX INFO: compiled from: TradeFavourActivity.kt */
...
public final class TradeFavourActivity extends BaseActivity {
    ...
    public static final class a {
        ...
        public static /* synthetic */ Intent b(a aVar, Context context, Integer num, int i10, Object obj) {
            PatchProxyResult patchProxyResultProxy = PatchProxy.proxy(new Object[]{aVar, context, num, new Integer(i10), obj}, null, changeQuickRedirect, true, 45152, new Class[]{a.class, Context.class, Integer.class, Integer.TYPE, Object.class}, Intent.class);
        ...
        public final Intent a(@dl.d Context context, @dl.e Integer num) {
            PatchProxyResult patchProxyResultProxy = PatchProxy.proxy(new Object[]{context, num}, this, changeQuickRedirect, false, 45151, new Class[]{Context.class, Integer.class}, Intent.class);
            if (patchProxyResultProxy.isSupported) {
                return (Intent) patchProxyResultProxy.result;
            }
    ...
    public static final class b extends n0 {
        ...
        public Fragment getItem(int i10) {
            PatchProxyResult patchProxyResultProxy = PatchProxy.proxy(new Object[]{new Integer(i10)}, this, changeQuickRedirect, false, 45153, new Class[]{Integer.TYPE}, Fragment.class);
            if (patchProxyResultProxy.isSupported) {
                return (Fragment) patchProxyResultProxy.result;
            }
            return i10 == 0 ? TradeItemFavourListFragment.f92931i.a() : TradeTypeFavourListFragment.f93254j.a();
        }

        @Override // androidx.viewpager.widget.a
        @dl.e
        public CharSequence getPageTitle(int i10) {
            return i10 == 0 ? "关注单品" : "关注品类";
        }
    }

    @dl.d
    public final SlidingTabLayout M1() {
        PatchProxyResult patchProxyResultProxy = PatchProxy.proxy(new Object[0], this, changeQuickRedirect, false, 45147, new Class[0], SlidingTabLayout.class);
        if (patchProxyResultProxy.isSupported) {
    ...
    public final void O1(@dl.d SlidingTabLayout slidingTabLayout) {
        if (PatchProxy.proxy(new Object[]{slidingTabLayout}, this, changeQuickRedirect, false, 45148, new Class[]{SlidingTabLayout.class}, Void.TYPE).isSupported) {
            return;
        }
