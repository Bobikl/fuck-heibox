...
/* JADX INFO: compiled from: SearchMallListV2VHB.kt */
...
public final class n extends a0 {
    ...
    public static final int f91814m = 8;

    /* JADX INFO: renamed from: l, reason: collision with root package name */
    @dl.e
    private RecyclerView.OnScrollListener f91815l;
    ...
    public static final class a extends RecyclerView.OnScrollListener {
        ...
        public void onScrolled(@dl.d RecyclerView recyclerView, int i10, int i11) {
            ...
            if (PatchProxy.proxy(objArr, this, changeQuickRedirect2, false, 43353, new Class[]{RecyclerView.class, cls, cls}, Void.TYPE).isSupported) {
                return;
            }
            f0.p(recyclerView, "recyclerView");
            super.onScrolled(recyclerView, i10, i11);
            if (n.this.o().n() instanceof com.max.xiaoheihe.module.search.a) {
                com.max.hbcommon.base.adapter.u<?> uVarN = n.this.o().n();
    ...
    public static final class b implements View.OnClickListener {
        ...
        final /* synthetic */ SearchMallListObj f91818c;

        b(SearchMallListObj searchMallListObj) {
            this.f91818c = searchMallListObj;
        }
        ...
        public final void onClick(View view) {
            ...
            com.max.xiaoheihe.base.router.b.k0(n.this.o().q(), this.f91818c.getMore_prot());
        }
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public n(@dl.d z param) {
        super(param);
        f0.p(param, "param");
    }
    ...
    public /* bridge */ /* synthetic */ void b(com.max.hbcommon.base.adapter.s.e eVar, GeneralSearchInfo generalSearchInfo) {
        if (PatchProxy.proxy(new Object[]{eVar, generalSearchInfo}, this, changeQuickRedirect, false, 43352, new Class[]{com.max.hbcommon.base.adapter.s.e.class, Object.class}, Void.TYPE).isSupported) {
            return;
        }
    ...
    public void f(@dl.d com.max.hbcommon.base.adapter.s.e viewHolder, @dl.d GeneralSearchInfo data) {
        if (PatchProxy.proxy(new Object[]{viewHolder, data}, this, changeQuickRedirect, false, 43351, new Class[]{com.max.hbcommon.base.adapter.s.e.class, GeneralSearchInfo.class}, Void.TYPE).isSupported) {
            return;
        }
        ...
        com.max.hbcommon.base.adapter.w wVar = new com.max.hbcommon.base.adapter.w(o().q(), new com.max.xiaoheihe.module.mall.l(o().q(), searchMallListObj.getMall_list()), new b(searchMallListObj));
        wVar.G(!com.max.hbcommon.utils.c.u(searchMallListObj.getMore_prot()));
        wVar.J(-1);
        wVar.H(R.color.transparent);
        recyclerView.setAdapter(wVar);
        RecyclerView.OnScrollListener onScrollListener = this.f91815l;
        if (onScrollListener == null) {
            this.f91815l = new a();
        } else if (onScrollListener != null) {
            recyclerView.removeOnScrollListener(onScrollListener);
        }
        RecyclerView.OnScrollListener onScrollListener2 = this.f91815l;
