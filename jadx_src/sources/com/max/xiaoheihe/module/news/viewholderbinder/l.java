...
/* JADX INFO: compiled from: NewsFeedsLinkV3VHB.kt */
...
public class l extends k {
    ...
    public static final int f91473n = 0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public l(@dl.d g0 param) {
        super(param);
    ...
    public void O(@dl.d BBSLinkObj linkData, @dl.d BBSLinkListBottomBar vg_bottom_bar) {
        if (PatchProxy.proxy(new Object[]{linkData, vg_bottom_bar}, this, changeQuickRedirect, false, 42695, new Class[]{BBSLinkObj.class, BBSLinkListBottomBar.class}, Void.TYPE).isSupported) {
            return;
        }
    ...
    public void Q(@dl.d com.max.xiaoheihe.module.bbs.component.a vgUser, @dl.d BBSLinkObj data) {
        if (PatchProxy.proxy(new Object[]{vgUser, data}, this, changeQuickRedirect, false, 42694, new Class[]{com.max.xiaoheihe.module.bbs.component.a.class, BBSLinkObj.class}, Void.TYPE).isSupported) {
            return;
        }
    ...
    public void i(@dl.d com.max.hbcommon.base.adapter.s.e viewHolder, @dl.d FeedsContentBaseObj data) {
        if (PatchProxy.proxy(new Object[]{viewHolder, data}, this, changeQuickRedirect, false, 42693, new Class[]{com.max.hbcommon.base.adapter.s.e.class, FeedsContentBaseObj.class}, Void.TYPE).isSupported) {
            return;
        }
