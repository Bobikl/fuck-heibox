...
/* JADX INFO: compiled from: NormalCookieJarImpl.java */
/* JADX INFO: loaded from: classes11.dex */
public class z1 implements okhttp3.l {
    public static ChangeQuickRedirect changeQuickRedirect;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private ka.d f88586c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private boolean f88587d = true;
    ...
    public synchronized List<Cookie> a(okhttp3.t tVar) {
        ka.d dVar;
        PatchProxyResult patchProxyResultProxy = PatchProxy.proxy(new Object[]{tVar}, this, changeQuickRedirect, false, 35048, new Class[]{okhttp3.t.class}, List.class);
        ...
        if (this.f88587d) {
            ...
            if (ad.a.a(ad.a.f1217x, false) && (dVar = this.f88586c) != null) {
                List<Cookie> listA = dVar.a(tVar);
    ...
    public synchronized void b(okhttp3.t tVar, List<Cookie> list) {
        if (PatchProxy.proxy(new Object[]{tVar, list}, this, changeQuickRedirect, false, 35047, new Class[]{okhttp3.t.class, List.class}, Void.TYPE).isSupported) {
            return;
        }
        this.f88586c.f(tVar, list);
