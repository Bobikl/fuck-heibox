...
public class AvatarDecorationObj implements Serializable {
    ...
    public boolean equals(Object obj) {
        PatchProxyResult patchProxyResultProxy = PatchProxy.proxy(new Object[]{obj}, this, changeQuickRedirect, false, c.k.Cd, new Class[]{Object.class}, Boolean.TYPE);
        ...
        String str = this.f72834id;
        String str2 = ((AvatarDecorationObj) obj).f72834id;
        if (str != null) {
    ...
    public int hashCode() {
        PatchProxyResult patchProxyResultProxy = PatchProxy.proxy(new Object[0], this, changeQuickRedirect, false, c.k.Dd, new Class[0], Integer.TYPE);
        if (patchProxyResultProxy.isSupported) {
