...
public final /* synthetic */ class ExpressionPackGridFragmentV2$initSmallExpression$1$2 extends FunctionReferenceImpl implements yh.p<ExpressionObj, View, Boolean> {
    public static ChangeQuickRedirect changeQuickRedirect;

    ExpressionPackGridFragmentV2$initSmallExpression$1$2(Object obj) {
    ...
    public final Boolean i(@dl.d ExpressionObj p10, @dl.d View p11) {
        PatchProxyResult patchProxyResultProxy = PatchProxy.proxy(new Object[]{p10, p11}, this, changeQuickRedirect, false, bb.c.g.f32763c0, new Class[]{ExpressionObj.class, View.class}, Boolean.class);
    ...
    public /* bridge */ /* synthetic */ Boolean invoke(ExpressionObj expressionObj, View view) {
        PatchProxyResult patchProxyResultProxy = PatchProxy.proxy(new Object[]{expressionObj, view}, this, changeQuickRedirect, false, bb.c.g.f32783d0, new Class[]{Object.class, Object.class}, Object.class);
