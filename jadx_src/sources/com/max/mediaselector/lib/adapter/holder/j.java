...
public class j extends c {
    ...
    public j(@n0 View view, PictureSelectionConfig pictureSelectionConfig) {
        ...
        if (s.a(iArrK) && (textView.getLayoutParams() instanceof RelativeLayout.LayoutParams)) {
            ...
            for (int i10 : iArrK) {
                ((RelativeLayout.LayoutParams) this.f74919m.getLayoutParams()).addRule(i10);
            }
        }
    }
    ...
    public void g(LocalMedia localMedia, int i10) {
        if (PatchProxy.proxy(new Object[]{localMedia, new Integer(i10)}, this, changeQuickRedirect, false, bb.c.l.Hh, new Class[]{LocalMedia.class, Integer.TYPE}, Void.TYPE).isSupported) {
            return;
        }
        super.g(localMedia, i10);
        this.f74919m.setText(com.max.mediaselector.lib.utils.g.c(localMedia.w()));
    }
}
