...
/* JADX INFO: compiled from: BlurUtils.java */
/* JADX INFO: loaded from: classes10.dex */
public class c {
    public static ChangeQuickRedirect changeQuickRedirect;

    public static Bitmap a(Bitmap bitmap, int i10) {
        PatchProxyResult patchProxyResultProxy = PatchProxy.proxy(new Object[]{bitmap, new Integer(i10)}, null, changeQuickRedirect, true, bb.c.g.R6, new Class[]{Bitmap.class, Integer.TYPE}, Bitmap.class);
    ...
    public static Bitmap b(Activity activity, Bitmap bitmap) {
        PatchProxyResult patchProxyResultProxy = PatchProxy.proxy(new Object[]{activity, bitmap}, null, changeQuickRedirect, true, bb.c.g.N6, new Class[]{Activity.class, Bitmap.class}, Bitmap.class);
        if (patchProxyResultProxy.isSupported) {
            return (Bitmap) patchProxyResultProxy.result;
        }
        return Bitmap.createBitmap(bitmap, 0, 0, bitmap.getWidth(), bitmap.getHeight() - (u.a(activity) ? u.d(activity) : 0), (Matrix) null, false);
    }

    public static Bitmap c(Bitmap bitmap, int i10, boolean z10) {
        Bitmap bitmapCopy = bitmap;
        int i11 = i10;
        PatchProxyResult patchProxyResultProxy = PatchProxy.proxy(new Object[]{bitmapCopy, new Integer(i11), new Byte(z10 ? (byte) 1 : (byte) 0)}, null, changeQuickRedirect, true, bb.c.g.T6, new Class[]{Bitmap.class, Integer.TYPE, Boolean.TYPE}, Bitmap.class);
        if (patchProxyResultProxy.isSupported) {
            return (Bitmap) patchProxyResultProxy.result;
        }
        if (!z10) {
    ...
    public static Bitmap d(Activity activity) {
        PatchProxyResult patchProxyResultProxy = PatchProxy.proxy(new Object[]{activity}, null, changeQuickRedirect, true, bb.c.g.O6, new Class[]{Activity.class}, Bitmap.class);
        return patchProxyResultProxy.isSupported ? (Bitmap) patchProxyResultProxy.result : f(activity, 4, 4);
    }

    public static Bitmap e(Activity activity, int i10) {
        PatchProxyResult patchProxyResultProxy = PatchProxy.proxy(new Object[]{activity, new Integer(i10)}, null, changeQuickRedirect, true, bb.c.g.P6, new Class[]{Activity.class, Integer.TYPE}, Bitmap.class);
        return patchProxyResultProxy.isSupported ? (Bitmap) patchProxyResultProxy.result : f(activity, i10, 4);
    }

    public static Bitmap f(Activity activity, int i10, int i11) {
        Object[] objArr = {activity, new Integer(i10), new Integer(i11)};
        ChangeQuickRedirect changeQuickRedirect2 = changeQuickRedirect;
        Class cls = Integer.TYPE;
        PatchProxyResult patchProxyResultProxy = PatchProxy.proxy(objArr, null, changeQuickRedirect2, true, bb.c.g.Q6, new Class[]{Activity.class, cls, cls}, Bitmap.class);
        return patchProxyResultProxy.isSupported ? (Bitmap) patchProxyResultProxy.result : a(com.max.hbimage.b.o(activity, com.max.hbimage.b.A(activity), 12, i11), Color.argb(i10 * 25, 0, 0, 0));
    }
    ...
    @TargetApi(18)
    public static Bitmap g(Context context, Bitmap bitmap, int i10) throws Throwable {
        BaseObj baseObj;
        Allocation allocationCreateFromBitmap;
        Allocation allocationCreateTyped;
        PatchProxyResult patchProxyResultProxy = PatchProxy.proxy(new Object[]{context, bitmap, new Integer(i10)}, null, changeQuickRedirect, true, bb.c.g.S6, new Class[]{Context.class, Bitmap.class, Integer.TYPE}, Bitmap.class);
        if (patchProxyResultProxy.isSupported) {
            return (Bitmap) patchProxyResultProxy.result;
        }
