...
public class ThreadUtils {
    ...
    public static <V> V invokeAtFrontUninterruptibly(Handler handler, final Callable<V> callable) {
        ...
        if (c1CaughtException.f42175e == null) {
            return c1Result.value;
        }
        RuntimeException runtimeException = new RuntimeException(c1CaughtException.f42175e);
        runtimeException.setStackTrace(concatStackTraces(c1CaughtException.f42175e.getStackTrace(), runtimeException.getStackTrace()));
