...
public enum RXPixelFormat {
    ...
    /* JADX INFO: renamed from: com.bytedance.realx.video.RXPixelFormat$1, reason: invalid class name */
    ...
    RXPixelFormat(int i10) {
        this.value = i10;
    }

    @CalledByNative
    public static RXPixelFormat fromId(int i10) {
        if (i10 == 3553) {
            return kTexture2D;
        }
        if (i10 == 36197) {
