...
public class RendererCommon {
    ...
    /* JADX INFO: renamed from: com.bytedance.realx.video.RendererCommon$1, reason: invalid class name */
    ...
    public interface GlDrawer {
        ...
        void drawOes(int i10, float[] fArr, int i11, int i12, int i13, int i14, int i15, int i16, FilterType filterType, int i17, int i18);

        void drawRgb(int i10, float[] fArr, int i11, int i12, int i13, int i14, int i15, int i16);

        void drawRgb(int i10, float[] fArr, int i11, int i12, int i13, int i14, int i15, int i16, FilterType filterType, int i17, int i18);

        void drawYuv(int[] iArr, float[] fArr, int i10, int i11, int i12, int i13, int i14, int i15);

        void drawYuv(int[] iArr, float[] fArr, int i10, int i11, int i12, int i13, int i14, int i15, FilterType filterType, int i16, int i17);
    ...
    private static float convertScalingTypeToVisibleFraction(ScalingType scalingType) {
        int i10 = AnonymousClass1.$SwitchMap$com$bytedance$realx$video$RendererCommon$ScalingType[scalingType.ordinal()];
        if (i10 == 1) {
            return 1.0f;
        }
        if (i10 == 2) {
