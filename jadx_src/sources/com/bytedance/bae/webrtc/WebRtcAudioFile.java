...
public class WebRtcAudioFile {
    ...
    private HttpURLConnection f42168oc;
    ...
    private boolean isAvailableOnlineURL(String str) {
        ...
        try {
            ...
            this.f42168oc = httpURLConnection;
            httpURLConnection.setUseCaches(false);
            this.f42168oc.setConnectTimeout(4000);
            RXLogging.e(TAG, "connect done....");
            int responseCode = this.f42168oc.getResponseCode();
            if (200 == responseCode) {
                z10 = true;
            } else {
            ...
            InputStream inputStream = this.f42168oc.getInputStream();
            if (inputStream != null) {
                inputStream.close();
            }
            return z10;
            ...
            HttpURLConnection httpURLConnection2 = this.f42168oc;
    ...
    public void disConnectURL() {
        ...
        HttpURLConnection httpURLConnection = this.f42168oc;
    ...
    /* JADX WARN: Code duplicated, block: B:55:0x0111 A[Catch: Exception -> 0x0158, TryCatch #0 {Exception -> 0x0158, blocks: (B:3:0x0004, B:5:0x0008, B:8:0x000e, B:10:0x0016, B:12:0x001c, B:14:0x002a, B:16:0x002f, B:18:0x003f, B:19:0x0041, B:20:0x004d, B:22:0x0051, B:28:0x0068, B:30:0x006c, B:32:0x0072, B:33:0x0074, B:37:0x0089, B:38:0x0093, B:40:0x0098, B:41:0x00bd, B:44:0x00d5, B:43:0x00c3, B:45:0x00dc, B:47:0x00e5, B:49:0x00f1, B:51:0x00fd, B:53:0x0107, B:55:0x0111, B:56:0x0146, B:57:0x0150, B:58:0x0155), top: B:64:0x0004 }] */
    /* JADX WARN: Instruction removed from duplicated block: B:55:0x0111, please report this as an issue */
    @CalledByNative
