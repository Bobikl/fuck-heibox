...
public class Response implements at<Response, e>, Serializable, Cloneable {
    ...
    public enum e implements ba {
        ...
        private static final Map<String, e> f105393d = new HashMap();

        /* JADX INFO: renamed from: e, reason: collision with root package name */
        private final short f105395e;

        /* JADX INFO: renamed from: f, reason: collision with root package name */
        private final String f105396f;

        static {
            for (e eVar : EnumSet.allOf(e.class)) {
                f105393d.put(eVar.b(), eVar);
            }
        }
    ...
    static {
        ...
        enumMap.put(e.RESP_CODE, new bf("resp_code", (byte) 1, new bg((byte) 8)));
        enumMap.put(e.MSG, new bf("msg", (byte) 2, new bg((byte) 11)));
        enumMap.put(e.IMPRINT, new bf(ak.X, (byte) 2, new bk((byte) 12, com.umeng.commonsdk.statistics.proto.d.class)));
        Map<e, bf> mapUnmodifiableMap = Collections.unmodifiableMap(enumMap);
        metaDataMap = mapUnmodifiableMap;
        bf.a(Response.class, mapUnmodifiableMap);
    }
    ...
    public void setResp_codeIsSet(boolean z10) {
        this.__isset_bitfield = aq.a(this.__isset_bitfield, 0, z10);
    }
