...
public class UMProcessDBDatasSender implements UMLogDataProtocol {
    ...
    public class ReplaceCallback implements FileLockCallback {
        ...
        public boolean onFileLock(String str) throws Throwable {
            ...
            if (str.startsWith(a.f105008c)) {
                str = str.replaceFirst(a.f105008c, "");
            }
            UMProcessDBHelper.getInstance(UMProcessDBDatasSender.this.mContext).deleteEventDatas(str.replace(a.f105009d, ""), null, null);
            return true;
        }
    ...
    private int defconProcesserHandler() throws Throwable {
        ...
        if (iA != 0) {
            ...
            UMProcessDBHelper.getInstance(this.mContext).deleteEventDatas(a.f105013h, null, null);
        }
        return iA;
    }
    ...
    private JSONObject generalHeader() {
        ...
        try {
            ...
            jSONObject.put(d.f104702i, AnalyticsConfig.getVerticalType(this.mContext));
            ...
            SharedPreferences sharedPreferences = PreferenceWrapper.getDefault(this.mContext);
            jSONObject.put(d.f104705l, UMEnvelopeBuild.imprintProperty(this.mContext, "pr_ve", null));
            jSONObject.put(d.f104706m, UMEnvelopeBuild.imprintProperty(this.mContext, "ud_da", null));
            jSONObject.put(d.f104690ah, "1.0.0");
            if (TextUtils.isEmpty(strImprintProperty)) {
                jSONObject.put(d.f104705l, sharedPreferences.getString("vers_pre_version", "0"));
                jSONObject.put(d.f104706m, sharedPreferences.getString("vers_date", new SimpleDateFormat("yyyy-MM-dd", Locale.getDefault()).format(new Date(System.currentTimeMillis()))));
            }
        } catch (Throwable th2) {
            th2.printStackTrace();
        }
