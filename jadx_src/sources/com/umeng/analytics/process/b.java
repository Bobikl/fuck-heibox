...
public class b extends SQLiteOpenHelper {
    b(Context context, String str, SQLiteDatabase.CursorFactory cursorFactory, int i10) {
        super(context, str, cursorFactory, i10);
    }

    static b a(Context context, String str) {
        String strB = b(context, str);
        a.f105013h.equals(str);
    ...
    public static String b(Context context, String str) {
        ...
        return String.format(strB + a.f105010e, str);
    }
