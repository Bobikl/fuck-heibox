...
public class UmengTool {
    ...
    public static String checkFBByself(Context context) {
        ...
        if (UMUtils.checkMetaData(context, "com.facebook.sdk.ApplicationId")) {
            return !UMUtils.checkResource(context, "facebook_app_id", w.b.f17895e) ? UmengText.FACEBOOK.ERRORMETA : UmengText.CHECK.checkSuccess(UMUtils.getAppHashKey(context), ContextUtil.getPackageName());
        }
