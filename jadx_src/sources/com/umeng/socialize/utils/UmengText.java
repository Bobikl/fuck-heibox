...
public class UmengText {
    ...
    public static class CACHE {
        ...
        private static String f106396id = "[SCC10000]";
        public static String CACHEFILE = f106396id + "缓存文件错误，请勿担心，不影响正常使用";
        public static String CLOSE = f106396id + "关闭流异常";
    ...
    public static class IMAGE {
        ...
        /* JADX INFO: renamed from: id, reason: collision with root package name */
        private static String f106397id = "[SI10000]";
        public static String BINARYTOFILE = f106397id + "字节流转文件错误";
        public static String BITMAOTOBINARY = f106397id + "bitmap转字节流错误";
        public static String CLOSE = f106397id + "流关闭错误";
        public static String GET_FILE_FROM_BINARY = f106397id + "字节流输出文件出错";
        public static String TOOBIG = f106397id + "加载文件过大";
        public static String FILE_TO_BINARY_ERROR = f106397id + "文件转入字节流，先要进行压缩出错";
        public static String GET_IMAGE_SCALE_ERROR = f106397id + "获取文件大小出错";
        public static String READ_IMAGE_ERROR = f106397id + "读取图片文件出错";
        public static String CHECK_FORMAT_ERROR = f106397id + "checkFormat出错";
    ...
    public static class NET {
        ...
        /* JADX INFO: renamed from: id, reason: collision with root package name */
        private static String f106398id = "[SN10000]";
        public static String PARSEERROR = f106398id + "返回字符串不是json，可能是由于服务器不通造成";
        public static String TOOL = f106398id + "工具类内的错误，不影响用户使用";
        public static String IMAGEDOWN = "[SN10004]图片下载错误,请检查网址";
        public static String CLOSE = f106398id + "关闭流异常";
        public static String CREATE = f106398id + "构建response出错,不影响用户使用，但需要查明原因";
        ...
        public static String getURLERROR(String str) {
            return f106398id + "baseurl=" + str + " 该url不正确";
        }
    }
