...
public enum SHARE_MEDIA {
    ...
    public String getName() {
        ...
        return toString().equals("WEIXIN_FAVORITE") ? "wxfavorite" : toString().toLowerCase();
    }
    ...
    public String getsharestyle(boolean z10) {
        ...
        return (toString().equals("RENREN") || toString().equals("DOUBAN") || toString().equals("TENCENT") || toString().equals("TWITTER") || toString().equals("LINKEDIN")) ? "cloudy self" : "sso";
    }
    ...
    public SnsPlatform toSnsPlatform() {
        ...
        if (toString().equals(Constants.SOURCE_QQ)) {
            ...
            if (toString().equals("EMAIL")) {
                ...
                snsPlatform.mIndex = 0;
                snsPlatform.mKeyword = PaymentManager.f71422u;
                ...
                snsPlatform.mIndex = 0;
                snsPlatform.mKeyword = BBSTopicObj.VIRTUAL_TAG_MORE;
