...
public class AccsClientConfig implements Serializable {
    ...
    public static class Builder {
        ...
        public AccsClientConfig build() throws AccsException {
            ...
            if (i10 != 1) {
                map = i10 != 2 ? AccsClientConfig.mReleaseConfigs : AccsClientConfig.mDebugConfigs;
            } else {
    ...
    public static AccsClientConfig getConfigByTag(String str) {
        ...
        if (i10 == 0) {
            ...
            accsClientConfig = i10 != 2 ? mReleaseConfigs.get(str) : mDebugConfigs.get(str);
        } else {
    ...
    public static void setAccsConfig(int i10, AccsClientConfig accsClientConfig) {
        Map<String, AccsClientConfig> map;
        if (i10 != 1) {
            map = i10 != 2 ? mReleaseConfigs : mDebugConfigs;
        } else {
            map = mPreviewConfigs;
        }
        AccsClientConfig accsClientConfig2 = map.get(accsClientConfig.getTag());
