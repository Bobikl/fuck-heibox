...
public abstract class TaoBaseService extends Service implements AccsDataListener {
    ...
    public static class ConnectInfo implements Serializable {
        ...
        public ConnectInfo(String str, boolean z10, boolean z11) {
            this.host = str;
            this.isInapp = z10;
            this.isCenterHost = z11;
        }

        public ConnectInfo(String str, boolean z10, boolean z11, int i10, String str2) {
            this.host = str;
            this.isInapp = z10;
            this.isCenterHost = z11;
            this.errorCode = i10;
    ...
    public enum ExtHeaderType {
        ...
        public static ExtHeaderType valueOf(int i10) {
            switch (i10) {
                case 0:
    ...
    public void onAntiBrush(boolean z10, ExtraInfo extraInfo) {
    }
