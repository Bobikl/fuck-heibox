...
public class Constants {
    ...
    public static final String SP_KEY_CONNECT_STATE_LISTENER_ENABLE = "connect_state_listener_enable";
    ...
    public static final String SP_KEY_IMPAAS_MODIFY = "impass_modify";
    ...
    public static final boolean UT_OFF = true;
}
