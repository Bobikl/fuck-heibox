...
public class ThreadPoolExecutorFactory {
    ...
    public static class a implements ThreadFactory {
        ...
        public Thread newThread(Runnable runnable) {
            Thread thread = new Thread(runnable, this.f98201a + ThreadPoolExecutorFactory.integer.getAndIncrement());
    ...
    public static void execute(Runnable runnable) {
        try {
            ...
            ALog.e(TAG, "ThreadPoolExecutorFactory execute", th2, new Object[0]);
        }
    }
    ...
    public static ScheduledFuture<?> schedule(Runnable runnable, long j10, TimeUnit timeUnit) {
        try {
            ...
            ALog.e(TAG, "ThreadPoolExecutorFactory schedule", th2, new Object[0]);
            return null;
        }
    }
}
