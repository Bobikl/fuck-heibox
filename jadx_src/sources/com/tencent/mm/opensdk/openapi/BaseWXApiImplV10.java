...
public class BaseWXApiImplV10 implements IWXAPI {
    ...
    BaseWXApiImplV10(Context context, String str, boolean z10, int i10) {
        ...
        this.launchMode = i10;
        b.f100926a = context.getApplicationContext();
    }
        ...
        try {
            ...
            if (iWXChannelJumpInfo instanceof WXChannelBaseJumpInfo) {
                ...
                if (iWXChannelJumpInfo instanceof WXChannelJumpMiniProgramInfo) {
                    jSONObject.put(a.f118919c, ((WXChannelJumpMiniProgramInfo) iWXChannelJumpInfo).username);
                    str = ((WXChannelJumpMiniProgramInfo) iWXChannelJumpInfo).path;
                    str2 = FlutterActivityLaunchConfigs.EXTRA_PATH;
    ...
    public int getWXAppSupportAPI() {
        ...
        b.f100930e.submit(new Runnable() { // from class: com.tencent.mm.opensdk.openapi.BaseWXApiImplV10.1
    ...
    public boolean registerApp(String str, long j10) {
        ...
        com.tencent.mm.opensdk.channel.a.a.C0970a c0970a = new com.tencent.mm.opensdk.channel.a.a.C0970a();
        c0970a.f100887a = "com.tencent.mm";
        c0970a.f100888b = ConstantsAPI.ACTION_HANDLE_APP_REGISTER;
        c0970a.f100889c = "weixin://registerapp?appid=" + this.appId;
        c0970a.f100890d = j10;
        return com.tencent.mm.opensdk.channel.a.a.a(this.context, c0970a);
    }
    ...
    public void unregisterApp() {
        ...
        com.tencent.mm.opensdk.channel.a.a.C0970a c0970a = new com.tencent.mm.opensdk.channel.a.a.C0970a();
        c0970a.f100887a = "com.tencent.mm";
        c0970a.f100888b = ConstantsAPI.ACTION_HANDLE_APP_UNREGISTER;
        c0970a.f100889c = "weixin://unregisterapp?appid=" + this.appId;
        com.tencent.mm.opensdk.channel.a.a.a(this.context, c0970a);
    }
}
