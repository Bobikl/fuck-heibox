...
public class TRTCCloudDef {
    ...
    public static final String TRTC_SDK_VERSION = "12.2.0.15065";
    ...
    public static class TRTCAudioEffectParam {
        ...
        public TRTCAudioEffectParam(int i10, String str) {
            this.path = str;
            this.effectId = i10;
        }
    }
    ...
    public static class TRTCMixUser {
        ...
        public TRTCMixUser(TRTCMixUser tRTCMixUser) {
            ...
            this.f103189x = tRTCMixUser.f103189x;
            this.f103190y = tRTCMixUser.f103190y;
        ...
        public TRTCMixUser(String str, int i10, int i11, int i12, int i13, int i14) {
            this.userId = str;
            this.f103189x = i10;
            this.f103190y = i11;
            this.width = i12;
        ...
        public String toString() {
            return "userId=" + this.userId + ", roomId=" + this.roomId + ", x=" + this.f103189x + ", y=" + this.f103190y + ", width=" + this.width + ", height=" + this.height + ", zOrder=" + this.zOrder + ", streamType=" + this.streamType + ", pureAudio=" + this.pureAudio + ", inputType=" + this.inputType + ", renderMode=" + this.renderMode + ", soundLevel=" + this.soundLevel + ", image=" + this.image;
        }
    }
    ...
    public static class TRTCParams {
        ...
        public TRTCParams(int i10, String str, String str2, int i11, String str3, String str4) {
            this.role = 20;
            this.streamId = "";
            this.userDefineRecordId = "";
            this.sdkAppId = i10;
        ...
        public TRTCParams(int i10, String str, String str2, String str3, String str4, String str5) {
            this.roomId = 0;
            this.role = 20;
            this.streamId = "";
            this.userDefineRecordId = "";
    ...
    public static class TRTCVideoLayout {
        ...
        /* JADX INFO: renamed from: x, reason: collision with root package name */
        public int f103191x = 0;

        /* JADX INFO: renamed from: y, reason: collision with root package name */
        public int f103192y = 0;
        public int width = 0;
        public int height = 0;
        public int zOrder = 0;
    ...
    public static class TRTCWatermark {
        ...
        /* JADX INFO: renamed from: x, reason: collision with root package name */
        public int f103193x = 0;

        /* JADX INFO: renamed from: y, reason: collision with root package name */
        public int f103194y = 0;
        public int height = 0;
        public int width = 0;
        public int zOrder = 0;
    }
