...
public class UserInfo extends BaseApi {
    ...
    public void getOpenId(IUiListener iUiListener) {
        HttpUtils.requestAsync(this.f99424c, g.a(), GRAPH_OPEN_ID, a(), "GET", new BaseApi.TempRequestListener(iUiListener));
    }

    public void getUserInfo(IUiListener iUiListener) {
        HttpUtils.requestAsync(this.f99424c, g.a(), "user/get_simple_userinfo", a(), "GET", new BaseApi.TempRequestListener(iUiListener));
    }
}
