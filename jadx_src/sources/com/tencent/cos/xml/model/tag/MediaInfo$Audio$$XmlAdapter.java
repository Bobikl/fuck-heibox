...
public class MediaInfo$Audio$$XmlAdapter implements IXmlAdapter<MediaInfo.Audio> {
    ...
    public MediaInfo$Audio$$XmlAdapter() {
        ...
        map.put("Index", new ChildElementBinder<MediaInfo.Audio>() { // from class: com.tencent.cos.xml.model.tag.MediaInfo$Audio$$XmlAdapter.1
            ...
            public void fromXml(XmlPullParser xmlPullParser, MediaInfo.Audio audio) throws XmlPullParserException, IOException {
                xmlPullParser.next();
    ...
    public MediaInfo.Audio fromXml(XmlPullParser xmlPullParser) throws XmlPullParserException, IOException {
    ...
    @Override // com.tencent.qcloud.qcloudxml.core.IXmlAdapter
    public void toXml(XmlSerializer xmlSerializer, MediaInfo.Audio audio) throws XmlPullParserException, IOException {
        if (audio == null) {
            return;
        }
