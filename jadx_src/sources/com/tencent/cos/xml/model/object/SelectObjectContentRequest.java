...
public class SelectObjectContentRequest extends ObjectRequest {
    ...
    public SelectObjectContentRequest(String str, String str2, String str3, boolean z10, InputSerialization inputSerialization, OutputSerialization outputSerialization) {
        this(str, str2, EXPRESSION_TYPE_SQL, str3, new RequestProgress(Boolean.valueOf(z10)), inputSerialization, outputSerialization);
    }
    ...
    public Map<String, String> getQueryString() {
        this.queryParameters.put(AddressListActivity.N, null);
