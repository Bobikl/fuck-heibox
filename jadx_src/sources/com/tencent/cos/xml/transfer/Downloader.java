...
public class Downloader {
    ...
    public class ListenerHandler implements CosXmlProgressListener, CosXmlResultListener {
        ...
        public void onProgress(long j10, long j11) {
            ...
            if (cosXmlProgressListener != null) {
                cosXmlProgressListener.onProgress(Downloader.this.rangeStart + j10, Downloader.this.rangeStart + j11);
            }
        }
    ...
    public GetObjectResult download(String str, String str2, String str3, String str4) throws CosXmlServiceException, CosXmlClientException {
        this.bucket = str;
        this.cosPath = str2;
        this.localPath = str3;
    ...
    public void download(String str, String str2, String str3, String str4, CosXmlResultListener cosXmlResultListener) {
        ...
        try {
            ...
            this.listenerHandler.onFail(this.getObjectRequest, e10, null);
        }
    }
