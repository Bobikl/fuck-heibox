...
public class TransferService {
    ...
    public TransferService(CosXmlSimpleService cosXmlSimpleService, TransferConfig transferConfig, EncryptionMaterialsProvider encryptionMaterialsProvider) {
        ...
        TencentCloudKMSClient tencentCloudKMSClientNewTencentCloudKMSClient = newTencentCloudKMSClient(cosXmlSimpleService.getCredentialProvider());
        this.kms = tencentCloudKMSClientNewTencentCloudKMSClient;
        this.cryptoModule = new CryptoModuleAE(tencentCloudKMSClientNewTencentCloudKMSClient, cosXmlSimpleService, cosXmlSimpleService.getCredentialProvider(), encryptionMaterialsProvider);
    }
