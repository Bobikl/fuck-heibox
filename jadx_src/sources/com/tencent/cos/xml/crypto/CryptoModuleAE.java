...
public class CryptoModuleAE extends CryptoModuleBase {
    ...
    protected final long ciphertextLength(long j10) {
        return j10 + ((long) (this.contentCryptoScheme.getTagLengthInBits() / 8));
    }

    @Override // com.tencent.cos.xml.crypto.CryptoModuleBase
    final long computeLastPartSize(UploadPartRequest uploadPartRequest) {
        return uploadPartRequest.getFileLength() + ((long) (this.contentCryptoScheme.getTagLengthInBits() / 8));
    }

    @Override // com.tencent.cos.xml.crypto.CryptoModule
    public GetObjectResult getObjectSecurely(GetObjectRequest getObjectRequest) throws CosXmlServiceException, CosXmlClientException {
        GetObjectResult object = this.cos.getObject(getObjectRequest);
