...
public class CosXmlService extends CosXmlSimpleService implements CosXml {
    ...
    protected <T1 extends CosXmlRequest, T2 extends CosXmlResult> boolean buildHttpRequestBodyConverter(T1 t10, T2 t11, QCloudHttpRequest.Builder<T2> builder) {
        if (!(t10 instanceof SelectObjectContentRequest)) {
            return super.buildHttpRequestBodyConverter(t10, t11, builder);
        }
        SelectObjectContentRequest selectObjectContentRequest = (SelectObjectContentRequest) t10;
        SelectObjectContentConverter selectObjectContentConverter = new SelectObjectContentConverter((SelectObjectContentResult) t11, selectObjectContentRequest.getSelectResponseFilePath());
    ...
    public boolean doesBucketExist(String str) throws CosXmlServiceException, CosXmlClientException {
        try {
            ...
            if (e10.getStatusCode() == 301 || "AccessDenied".equals(e10.getErrorCode())) {
                return true;
            }
    ...
    @Override // com.tencent.cos.xml.CosXml
    public PostTextContentAuditResult postTextContentAudit(PostTextContentAuditRequest postTextContentAuditRequest) throws CosXmlServiceException, CosXmlClientException {
        return (PostTextContentAuditResult) execute(postTextContentAuditRequest, new PostTextContentAuditResult());
    }
    ...
    @Override // com.tencent.cos.xml.CosXml
    public PostAuditResult postTextObjectAudit(PostTextObjectAuditRequest postTextObjectAuditRequest) throws CosXmlServiceException, CosXmlClientException {
        return (PostAuditResult) execute(postTextObjectAuditRequest, new PostAuditResult());
    }
