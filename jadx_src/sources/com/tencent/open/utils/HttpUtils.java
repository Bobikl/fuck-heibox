...
public class HttpUtils {
    ...
    private static int a(Context context) {
        String property = System.getProperty(h1.f136787d);
    ...
    /* JADX WARN: Code duplicated, block: B:45:0x017a  */
    /* JADX WARN: Code duplicated, block: B:50:0x018b A[LOOP:0: B:12:0x00c0->B:50:0x018b, LOOP_END] */
    /* JADX WARN: Code duplicated, block: B:66:0x018f A[SYNTHETIC] */
    /* JADX WARN: Code duplicated, block: B:67:0x0180 A[SYNTHETIC] */
    public static JSONObject request(QQToken qQToken, Context context, String str, Bundle bundle, String str2) throws JSONException, IOException, HttpStatusException, NetworkUnavailableException {
        ...
        while (true) {
            ...
            try {
                    ...
                    try {
                        ...
                        if (iD == 200) {
                            ...
                            try {
                                ...
                                if (i14 >= i13) {
                                    jSONObjectD = jSONObject;
                                    com.tencent.open.b.h.a().a(str4, jElapsedRealtime2, j10, jB, i10);
                                    return jSONObjectD;
                                }
                                i12 = i14;
                                jSONObject = jSONObject;
                ...
                e15.printStackTrace();
                com.tencent.open.b.h.a().a(str4, jElapsedRealtime2, 0L, 0L, getErrorCodeFromException(e15));
                throw e15;
            }
            i12 = i14;
            jSONObject = jSONObject;
