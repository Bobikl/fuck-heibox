...
public class IM extends BaseApi {
    ...
    public int startIMConversation(Activity activity, String str, String str2, String str3) {
        ...
        intent.setData(Uri.parse(String.format("mqqapi://im/chat?chat_type=%1$s&uin=%2$s&version=1&src_type=app&open_id=%3$s&app_id=%4$s&app_pkg_name=%5$s", str, str2, m.k(this.f99424c.getOpenId()), m.k(this.f99424c.getAppId()), m.k(str3))));
