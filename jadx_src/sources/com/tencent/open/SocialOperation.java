...
public class SocialOperation extends BaseApi {
    ...
    private void a(Activity activity, String str) {
        new TDialog(activity, "", a(str), null, this.f99424c).show();
    }
    ...
    public void bindQQGroup(final Activity activity, String str, String str2, final IUiListener iUiListener) {
        ...
        stringBuffer.append("&app_name_url_encode=" + m.f(Base64.encodeToString(m.j(strA), 2)));
        ...
        HttpUtils.requestAsync(this.f99424c, activity, "https://openmobile.qq.com/cgi-bin/qunopensdk/check_group", bundleA, "GET", new BaseApi.TempRequestListener(defaultUiListener));
    ...
    public void makeFriend(Activity activity, Bundle bundle) {
        ...
        if (bundle == null) {
            ...
            e.a().a(this.f99424c.getOpenId(), this.f99424c.getAppId(), Constants.VIA_MAKE_FRIEND, "14", "18", "1");
            return;
        }
        ...
        if (m.f(activity, "5.1.0")) {
            ...
            try {
                ...
                e.a().a(this.f99424c.getOpenId(), this.f99424c.getAppId(), Constants.VIA_MAKE_FRIEND, "14", "18", "0");
            } catch (Exception e10) {
    ...
    public void unBindGroup(Context context, String str, final IUiListener iUiListener) {
        ...
        bundleA.putString("appid", appId);
        bundleA.putString("orgid", str);
        HttpUtils.requestAsync(this.f99424c, context, "https://openmobile.qq.com/cgi-bin/qunopensdk/unbind", bundleA, "GET", new BaseApi.TempRequestListener(defaultUiListener));
