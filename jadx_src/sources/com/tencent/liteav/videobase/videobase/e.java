...
public final class e {
    ...
    private static final Map<a, Integer> f100448a = new HashMap<a, Integer>() { // from class: com.tencent.liteav.videobase.videobase.e.1
        {
    ...
    private static final Map<c, Integer> f100449b = new HashMap<c, Integer>() { // from class: com.tencent.liteav.videobase.videobase.e.2
        {
    ...
    private static final Map<b, Integer> f100450c = new HashMap<b, Integer>() { // from class: com.tencent.liteav.videobase.videobase.e.3
        {
    ...
    private static final Map<b, Integer> f100451d = new HashMap<b, Integer>() { // from class: com.tencent.liteav.videobase.videobase.e.4
        {
            ...
            put(b.EVT_VIDEO_CAPTURE_CAMERA_START_SUCCESS, Integer.valueOf(PushConsts.ALIAS_ERROR_FREQUENCY));
            put(b.EVT_VIDEO_CAPTURE_SCREEN_CAPTURE_START_SUCCESS, Integer.valueOf(PushConsts.ALIAS_OPERATE_PARAM_ERROR));
            put(b.EVT_VIDEO_CAPTURE_SCREEN_CAPTURE_STOP_SUCCESS, Integer.valueOf(PushConsts.ALIAS_REQUEST_FILTER));
            put(b.EVT_VIDEO_CAPTURE_SCREEN_CAPTURE_INTERRUPTED, Integer.valueOf(PushConsts.ALIAS_OPERATE_ALIAS_FAILED));
            put(b.EVT_VIDEO_CAPTURE_SCREEN_CAPTURE_RESUME, Integer.valueOf(PushConsts.ALIAS_CID_LOST));
