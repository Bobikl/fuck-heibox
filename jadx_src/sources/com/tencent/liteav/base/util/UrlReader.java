...
public class UrlReader {
    ...
    private void open() {
        try {
            InputStream inputStreamOpenInputStream = ContextUtils.getApplicationContext().getContentResolver().openInputStream(this.mUri);
            this.mStream = inputStreamOpenInputStream;
            this.mFileSize = inputStreamOpenInputStream.available();
    ...
    private long seekFromCurrent(long j10) {
        ...
        try {
            long jSkip = this.mOffset + this.mStream.skip(j10);
            this.mOffset = jSkip;
            return jSkip;
        } catch (IOException e10) {
            Log.e(TAG, "Fail to seek " + j10 + " exception " + e10.getMessage(), new Object[0]);
    ...
    private long seekFromEnd(long j10) {
        ...
        long j11 = ((long) this.mFileSize) + j10;
        if (j11 < 0) {
            return -1L;
        }
        ...
        try {
            long jSkip = j12 + this.mStream.skip(j11 - j12);
            this.mOffset = jSkip;
            return jSkip;
        } catch (IOException e10) {
            Log.e(TAG, "Fail to seek " + j10 + " exception " + e10.getMessage(), new Object[0]);
