...
public interface TXAudioEffectManager {
    ...
    public static class AudioMusicParam {
        ...
        public String toString() {
            return "path=" + this.path + ", id=" + this.f99526id + ", loopCount=" + this.loopCount + ", publish=" + this.publish + ", isShortFile=" + this.isShortFile + ", startTimeMS=" + this.startTimeMS + ", endTimeMS=" + this.endTimeMS;
        }
    }
