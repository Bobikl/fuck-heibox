...
public class TXAudioEffectManagerImpl implements TXAudioEffectManager {
    ...
    public static TXAudioEffectManager.TXVoiceChangerType voiceChangerTypeFromInt(int i10) {
        ...
        return i10 == 11 ? TXAudioEffectManager.TXVoiceChangerType.TXLiveVoiceChangerType_11 : TXAudioEffectManager.TXVoiceChangerType.TXLiveVoiceChangerType_0;
    }
    ...
    public static TXAudioEffectManager.TXVoiceReverbType voiceReverbTypeFromInt(int i10) {
        ...
        return i10 == 10 ? TXAudioEffectManager.TXVoiceReverbType.TXLiveVoiceReverbType_10 : TXAudioEffectManager.TXVoiceReverbType.TXLiveVoiceReverbType_0;
    }
    ...
    public void playAudioEffect(TXAudioEffectManager.AudioMusicParam audioMusicParam) {
        ...
        long j10 = this.mNativeAudioEffectMgr;
        if (j10 != 0) {
            nativeStartPlayMusic(j10, convertToEffectId(audioMusicParam.f99526id), new AudioBgmParams(audioMusicParam));
            synchronized (this) {
                this.mEffectIdList.add(Integer.valueOf(audioMusicParam.f99526id));
            }
        }
    }
    ...
    public boolean preloadMusic(TXAudioEffectManager.AudioMusicParam audioMusicParam) {
        ...
        nativePreloadMusic(j10, audioMusicParam.f99526id, new AudioBgmParams(audioMusicParam));
        return true;
    }
    ...
    public boolean startPlayMusic(TXAudioEffectManager.AudioMusicParam audioMusicParam) {
        ...
        nativeStartPlayMusic(j10, audioMusicParam.f99526id, new AudioBgmParams(audioMusicParam));
        return true;
    }
    ...
    public void stopAudioEffect(int i10) {
        if (this.mNativeAudioEffectMgr != 0) {
            ...
            synchronized (this) {
                int iIndexOf = this.mEffectIdList.indexOf(Integer.valueOf(i10));
                if (iIndexOf >= 0) {
                    this.mEffectIdList.remove(iIndexOf);
                }
            }
        }
    }
