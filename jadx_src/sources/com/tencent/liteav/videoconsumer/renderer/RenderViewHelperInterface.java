...
public abstract class RenderViewHelperInterface {
    ...
    /* JADX INFO: renamed from: com.tencent.liteav.videoconsumer.renderer.RenderViewHelperInterface$1, reason: invalid class name */
    public static final /* synthetic */ class AnonymousClass1 {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        static final /* synthetic */ int[] f100549a;
        ...
        static {
            ...
            try {
                f100549a[DisplayTarget.a.TEXTUREVIEW.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f100549a[DisplayTarget.a.SURFACE.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f100549a[DisplayTarget.a.TXCLOUDVIEW.ordinal()] = 4;
    ...
    public static RenderViewHelperInterface create(DisplayTarget displayTarget, RenderViewListener renderViewListener) {
        ...
        int i10 = AnonymousClass1.f100549a[displayTarget.getType().ordinal()];
        if (i10 == 1) {
            surface = null;
            textureView = 0;
        ...
        if (textureView != 0) {
            return new k((TextureView) textureView, renderViewListener);
        }
        if (surface != null) {
    ...
    public static void setBackgroundColor(DisplayTarget displayTarget, int i10) {
        ...
        if (displayTarget == null || displayTarget.getType() == null) {
            LiteavLog.w(TAG, "displayTarget or type is null. displayTarget=".concat(String.valueOf(displayTarget)));
        } else if (AnonymousClass1.f100549a[displayTarget.getType().ordinal()] == 4 && (tXCloudVideoView = displayTarget.getTXCloudVideoView()) != null) {
