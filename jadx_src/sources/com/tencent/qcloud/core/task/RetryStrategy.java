...
public class RetryStrategy {
    ...
    public static class WeightAndReliableAddition {
        ...
        private int regular(int i10, int i11, int i12) {
            if (i10 > i11) {
                return i11;
            }
        ...
        public int getRetryAddition(int i10, int i11) {
            int iRegular = regular(i10, 2, 0);
            return this.addTable[iRegular][regular(i11, 4, 0)] + 1;
        }
    }

    public RetryStrategy(int i10, int i11, int i12) {
        this.initBackoff = i10;
        this.maxBackoff = i11;
        this.baseAttempts = i12;
    }
    ...
    public long getNextDelay(int i10) {
        ...
        return Math.min(this.maxBackoff, this.initBackoff * ((int) Math.pow(2.0d, i10 - 1)));
    }
    ...
    public boolean shouldRetry(int i10, long j10, int i11) {
        return i10 < this.baseAttempts + i11;
    }
}
