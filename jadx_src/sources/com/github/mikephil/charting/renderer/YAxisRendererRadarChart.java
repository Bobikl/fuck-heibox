    ...
    protected void computeAxisValues(float f10, float f11) {
        ...
        if (this.mAxis.isForceLabelsEnabled()) {
            ...
            for (int i12 = 0; i12 < i11; i12++) {
                ...
                this.mAxis.mEntries[i12] = (float) dCeil;
                dCeil += dRoundToNextSignificant;
            }
            labelCount = i11;
        }
        ...
        if (zIsCenterAxisLabelsEnabled) {
            ...
            for (int i13 = 0; i13 < labelCount; i13++) {
                ...
                axisBase5.mCenteredEntries[i13] = axisBase5.mEntries[i13] + f14;
            }
        }
    ...
    public void renderAxisLabels(Canvas canvas) {
        if (this.mYAxis.isEnabled() && this.mYAxis.isDrawLabelsEnabled()) {
            ...
            for (int i11 = !this.mYAxis.isDrawBottomYLabelEntryEnabled() ? 1 : 0; i11 < i10; i11++) {
                ...
                Utils.getPosition(centerOffsets, (yAxis.mEntries[i11] - yAxis.mAxisMinimum) * factor, this.mChart.getRotationAngle(), mPPointF);
        ...
        for (int i10 = 0; i10 < limitLines.size(); i10++) {
            ...
            if (limitLine.isEnabled()) {
                ...
                for (int i11 = 0; i11 < ((RadarData) this.mChart.getData()).getMaxEntryCountSet().getEntryCount(); i11++) {
                    Utils.getPosition(centerOffsets, limit, (i11 * sliceAngle) + this.mChart.getRotationAngle(), mPPointF);
                    if (i11 == 0) {
