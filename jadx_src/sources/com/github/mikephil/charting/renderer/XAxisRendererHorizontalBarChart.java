...
public class XAxisRendererHorizontalBarChart extends XAxisRenderer {
    ...
    protected void computeSize() {
        ...
        float f10 = fSizeCalcTextSize.height;
        FSize sizeOfRotatedRectangleByDegrees = Utils.getSizeOfRotatedRectangleByDegrees(fSizeCalcTextSize.width, f10, this.mXAxis.getLabelRotationAngle());
    ...
    protected void drawLabels(Canvas canvas, float f10, MPPointF mPPointF) {
        ...
        for (int i12 = 0; i12 < i10; i12 += 2) {
            ...
            if (this.mViewPortHandler.isInBoundsY(f11)) {
                ...
                XAxis xAxis = this.mXAxis;
                drawLabel(canvas, valueFormatter.getFormattedValue(xAxis.mEntries[i12 / 2], xAxis), f10, f11, mPPointF, labelRotationAngle);
            }
        }
    }
