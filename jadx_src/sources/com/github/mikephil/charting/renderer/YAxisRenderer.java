...
public class YAxisRenderer extends AxisRenderer {
    ...
    protected void drawYLabels(Canvas canvas, float f10, float[] fArr, float f11) {
        ...
        for (int i11 = !this.mYAxis.isDrawBottomYLabelEntryEnabled() ? 1 : 0; i11 < i10; i11++) {
            canvas.drawText(this.mYAxis.getFormattedLabel(i11), f10, fArr[(i11 * 2) + 1] + f11, this.mAxisLabelPaint);
        }
    }
    ...
    public void renderAxisLabels(Canvas canvas) {
        ...
        if (this.mYAxis.isEnabled() && this.mYAxis.isDrawLabelsEnabled()) {
            ...
            float fCalcTextHeight = (Utils.calcTextHeight(this.mAxisLabelPaint, a.W4) / 2.5f) + this.mYAxis.getYOffset();
