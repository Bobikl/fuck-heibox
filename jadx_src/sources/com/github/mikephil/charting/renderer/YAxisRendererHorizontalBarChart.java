...
public class YAxisRendererHorizontalBarChart extends YAxisRenderer {
    ...
    protected void drawYLabels(Canvas canvas, float f10, float[] fArr, float f11) {
        ...
        for (int i11 = !this.mYAxis.isDrawBottomYLabelEntryEnabled() ? 1 : 0; i11 < i10; i11++) {
            canvas.drawText(this.mYAxis.getFormattedLabel(i11), fArr[i11 * 2], f10 - f11, this.mAxisLabelPaint);
        }
    }
    ...
    protected void drawZeroLine(Canvas canvas) {
        ...
        path.reset();
        path.moveTo(((float) pixelForValues.f43141x) - 1.0f, this.mViewPortHandler.contentTop());
        path.lineTo(((float) pixelForValues.f43141x) - 1.0f, this.mViewPortHandler.contentBottom());
    ...
    protected Path linePath(Path path, int i10, float[] fArr) {
        path.moveTo(fArr[i10], this.mViewPortHandler.contentTop());
        path.lineTo(fArr[i10], this.mViewPortHandler.contentBottom());
        return path;
    }
    ...
    public void renderLimitLines(Canvas canvas) {
        ...
        while (i10 < limitLines.size()) {
            ...
            if (limitLine.isEnabled()) {
                ...
                this.mTrans.pointValuesToPixel(fArr);
                fArr[c10] = this.mViewPortHandler.contentTop();
