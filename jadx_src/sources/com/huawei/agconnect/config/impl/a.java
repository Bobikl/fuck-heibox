...
public class a extends AGConnectApp {
    ...
    private static final Map<String, AGConnectApp> f60120a = new HashMap();

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static final Object f60121b = new Object();

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private static String f60122c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private AGConnectServicesConfig f60123d;

    private a(Context context, String str) {
        this.f60123d = AGConnectServicesConfig.fromContext(context, str);
    }
    ...
    public static AGConnectApp a(Context context, String str) {
        ...
        synchronized (f60121b) {
            Map<String, AGConnectApp> map = f60120a;
    ...
    public void setApiKey(String str) {
        this.f60123d.setParam("/client/api_key", str);
    }

    @Override // com.huawei.agconnect.AGConnectApp
    public void setAppId(String str) {
        this.f60123d.setParam("/client/app_id", str);
    }

    @Override // com.huawei.agconnect.AGConnectApp
    public void setClientId(String str) {
        this.f60123d.setParam("/client/client_id", str);
    }

    @Override // com.huawei.agconnect.AGConnectApp
    public void setClientSecret(String str) {
        this.f60123d.setParam("/client/client_secret", str);
    }

    @Override // com.huawei.agconnect.AGConnectApp
    public void setCpId(String str) {
        this.f60123d.setParam("/client/cp_id", str);
    }
    ...
    public void setParam(String str, String str2) {
        ...
        this.f60123d.setParam(str, str2);
    }

    @Override // com.huawei.agconnect.AGConnectApp
    public void setProductId(String str) {
        this.f60123d.setParam("/client/product_id", str);
    }
}
