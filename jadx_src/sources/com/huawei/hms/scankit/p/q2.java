...
public final class q2 extends q7 {
    ...
    private final int[] f62249h = new int[4];
    ...
    protected int a(r rVar, int[] iArr, StringBuilder sb2) throws a {
        ...
        int iE = rVar.e();
        int i10 = iArr[1];
        for (int i11 = 0; i11 < 4 && i10 < iE; i11++) {
            sb2.append((char) (b(rVar, iArr2, i10, q7.f62265f) + 48));
            for (int i12 : iArr2) {
                i10 += i12;
            }
        }
        int i13 = q7.a(rVar, i10, true, q7.f62263d)[1];
        for (int i14 = 0; i14 < 4 && i13 < iE; i14++) {
            sb2.append((char) (b(rVar, iArr2, i13, q7.f62265f) + 48));
            for (int i15 : iArr2) {
                i13 += i15;
            }
        }
    ...
    public boolean a(int i10, int i11, r rVar) {
        return rVar.a(i11, ((int) (((double) (i11 - i10)) * 1.5d)) + i11, false, true);
    }
