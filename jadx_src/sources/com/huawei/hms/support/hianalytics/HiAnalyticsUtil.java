...
public class HiAnalyticsUtil {
    ...
    private static final Object f62677a = new Object();

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static HiAnalyticsUtil f62678b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private static HiAnalyticsUtils f62679c;
    ...
    public static HiAnalyticsUtil getInstance() {
        ...
        synchronized (f62677a) {
            if (f62678b == null) {
                f62678b = new HiAnalyticsUtil();
                f62679c = HiAnalyticsUtils.getInstance();
            }
            hiAnalyticsUtil = f62678b;
        }
    ...
    public boolean hasError(Context context) {
        return f62679c.hasError(context);
    }

    public void onBuoyEvent(Context context, String str, String str2) {
        f62679c.onBuoyEvent(context, str, str2);
    }
    ...
    public void onEvent(Context context, String str, Map<String, String> map) {
        f62679c.onEvent(context, str, map);
    }

    public void onEvent2(Context context, String str, String str2) {
        f62679c.onEvent2(context, str, str2);
    }

    public void onNewEvent(Context context, String str, Map map) {
        f62679c.onNewEvent(context, str, map);
    }
}
