...
public class x {
    ...
    private String f61061a = q0.i().getFilesDir().getPath();

    x() {
    }

    private String a(String str) {
        return this.f61061a + "/hms/component/".replace("component", str);
    }
    ...
    private char[] a(String str, String str2, String str3, String str4) {
        ...
        for (int i10 = 0; i10 < length; i10++) {
            cArr[i10] = (char) (((bArrHexStr2ByteArray[i10] ^ bArrHexStr2ByteArray2[i10]) ^ bArrHexStr2ByteArray3[i10]) ^ bArrHexStr2ByteArray4[i10]);
        }
        return cArr;
    }
