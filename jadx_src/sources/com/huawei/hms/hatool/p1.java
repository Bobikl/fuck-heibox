...
public class p1 {
    ...
    public static String a(String str) {
        ...
        try {
            ...
            v.b("hmsSdk", "getHostByURI error : " + e10.getMessage());
            return null;
        }
    }
    ...
    public static boolean b(String str) {
        if (p.f61009a.booleanValue()) {
            return true;
        }
        for (String str2 : f61017a) {
            if (a(str, str2, 2)) {
                return true;
            }
        }
