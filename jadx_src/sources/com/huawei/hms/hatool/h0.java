...
public class h0 {
    ...
    private static PublicKey a(byte[] bArr) {
        return KeyFactory.getInstance(n5.d.f132016a).generatePublic(new X509EncodedKeySpec(bArr));
    }
    ...
    private static byte[] a(byte[] bArr, PublicKey publicKey) {
        ...
        try {
            ...
            Cipher cipher = Cipher.getInstance(COSKeyWrapScheme.RSA_ECB_OAEPWithSHA256AndMGF1Padding);
