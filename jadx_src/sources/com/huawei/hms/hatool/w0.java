...
public class w0 {
    ...
    public static boolean a() {
        ...
        if (!TextUtils.isEmpty(strA) && !TextUtils.isEmpty(strM)) {
            try {
                ...
                v.e("GetPublicKey", "checkCachePubKey NumberFormatException :" + e10.getMessage());
            }
        }
        return true;
    }
    ...
    public static void b(String str, String str2) {
        ...
        try {
            ...
            v.e("GetPublicKey", "get pubKey response Exception :" + e10.getMessage());
            n0VarA = null;
        }
        if (n0VarA == null) {
    ...
    public static String c(String str, String str2) {
        ...
        if (!org.apache.tools.ant.taskdefs.optional.ejb.g.a.f134950d.equals(strC)) {
            a(str, str2);
            return null;
        }
    ...
    private static void d(String str, String str2) {
        try {
            ...
            v.e("GetPublicKey", "get pubKey parse json JSONException :" + e10.getMessage());
        }
    }
}
