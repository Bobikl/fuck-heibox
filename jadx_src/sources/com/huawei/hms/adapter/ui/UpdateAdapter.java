...
public class UpdateAdapter implements IBridgeActivityDelegate {
    ...
    private WeakReference<Activity> f60337a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private Context f60338b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private int f60339c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private UpdateBean f60340d;

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    private boolean f60341e = false;
    ...
    private Activity b() {
        WeakReference<Activity> weakReference = this.f60337a;
    ...
    public static Object invokeMethod(String str, String str2, Object[] objArr) {
        ...
        try {
            ...
            HMSLog.e("UpdateAdapter", "invoke " + str + "." + str2 + " fail. " + e10.getMessage());
            return null;
        }
    }
    ...
    public void onBridgeActivityCreate(Activity activity) {
        ...
        this.f60338b = activity.getApplicationContext();
        this.f60337a = new WeakReference<>(activity);
        if (c.f60431b.a(b())) {
            ...
            try {
                this.f60339c = intent.getIntExtra(CommonCode.MapKey.UPDATE_VERSION, 0);
            } catch (Exception e10) {
                HMSLog.e("UpdateAdapter", "get update_version:" + e10.getMessage());
            }
            if (this.f60339c == 0) {
                c();
                return;
            ...
            if (!a(intent, activity) && AvailableUtil.isInstallerLibExist(this.f60338b)) {
                UpdateBean updateBean = (UpdateBean) invokeMethod("com.huawei.hms.adapter.ui.InstallerAdapter", "setUpdateBean", new Object[]{activity, Integer.valueOf(this.f60339c), Boolean.valueOf(this.f60341e)});
                this.f60340d = updateBean;
    ...
    public boolean onBridgeActivityResult(int i10, int i11, Intent intent) {
        ...
        if (AvailableUtil.isInstallerLibExist(this.f60338b) && i11 == 1214) {
            ...
            invokeMethod("com.huawei.hms.update.manager.UpdateManager", "startUpdate", new Object[]{activityB, 1001, this.f60340d});
            this.f60340d = null;
        }
        if (i11 == -1) {
            if (intent != null) {
            ...
            if (this.f60341e || a(activityB2, hMSPackageName, this.f60339c)) {
