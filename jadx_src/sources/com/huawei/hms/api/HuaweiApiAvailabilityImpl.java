...
public final class HuaweiApiAvailabilityImpl extends HuaweiApiAvailability {
    ...
    private static final HuaweiApiAvailabilityImpl f60376a = new HuaweiApiAvailabilityImpl();

    public class a implements BusResponseCallback {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        final /* synthetic */ TaskCompletionSource[] f60377a;

        a(TaskCompletionSource[] taskCompletionSourceArr) {
            this.f60377a = taskCompletionSourceArr;
        }
        ...
        public BusResponseResult innerError(Activity activity, int i10, String str) {
            ...
            this.f60377a[0].setException(new AvailabilityException());
            return null;
        }
