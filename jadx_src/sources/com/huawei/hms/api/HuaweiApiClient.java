...
public abstract class HuaweiApiClient implements AidlApiClient {
    ...
    public static final class Builder {
        ...
        private final List<Scope> f60380b = new ArrayList();

        /* JADX INFO: renamed from: c, reason: collision with root package name */
        private final List<PermissionInfo> f60381c = new ArrayList();

        /* JADX INFO: renamed from: d, reason: collision with root package name */
        private final Map<Api<?>, Api.ApiOptions> f60382d = new HashMap();

        /* JADX INFO: renamed from: e, reason: collision with root package name */
        private OnConnectionFailedListener f60383e;

        /* JADX INFO: renamed from: f, reason: collision with root package name */
        private ConnectionCallbacks f60384f;

        /* JADX INFO: renamed from: g, reason: collision with root package name */
        private int f60385g;

        /* JADX INFO: renamed from: h, reason: collision with root package name */
        private Activity f60386h;

        public Builder(Context context) throws NullPointerException {
            Checker.checkNonNull(context, "context must not be null.");
            Context applicationContext = context.getApplicationContext();
            this.f60379a = applicationContext;
            this.f60385g = -1;
        ...
        private void a(HuaweiApiClient huaweiApiClient) {
            AutoLifecycleFragment.getInstance(this.f60386h).startAutoMange(this.f60385g, huaweiApiClient);
        }

        public Builder addApi(Api<? extends Api.ApiOptions.NotRequiredOptions> api) {
            this.f60382d.put(api, null);
            if (HuaweiApiAvailability.HMS_API_NAME_GAME.equals(api.getApiName())) {
                HiAnalyticsUtil.getInstance().onEvent(this.f60379a.getApplicationContext(), HiAnalyticsConstant.KeyAndValue.GAME_INIT_KEY, "|" + System.currentTimeMillis());
            }
            return this;
        }
        ...
        public <O extends Api.ApiOptions.HasOptions> Builder addApi(Api<O> api, O o10) {
            ...
            this.f60382d.put(api, o10);
            if (api.getOptions() != null) {
                this.f60380b.addAll(api.getOptions().getScopeList(o10));
                this.f60381c.addAll(api.getOptions().getPermissionInfoList(o10));
            }
            return this;
        }
        ...
        public <O extends Api.ApiOptions.HasOptions> Builder addApiWithScope(Api<O> api, O o10, Scope... scopeArr) {
            ...
            this.f60380b.addAll(new ArrayList(Arrays.asList(scopeArr)));
            return this;
        }
        ...
        public Builder allowLifeCycleManagement(Activity activity, int i10, OnConnectionFailedListener onConnectionFailedListener) {
            ...
            this.f60385g = i10;
            this.f60386h = (Activity) Preconditions.checkNotNull(activity, "activity must not be Null.");
            return this;
        }
        ...
        public HuaweiApiClient build() {
            ...
            HuaweiApiClientImpl huaweiApiClientImpl = new HuaweiApiClientImpl(this.f60379a);
            huaweiApiClientImpl.setScopes(this.f60380b);
            huaweiApiClientImpl.setPermissionInfos(this.f60381c);
            huaweiApiClientImpl.setApiMap(this.f60382d);
            huaweiApiClientImpl.setConnectionCallbacks(this.f60384f);
            huaweiApiClientImpl.setConnectionFailedListener(this.f60383e);
            huaweiApiClientImpl.setAutoLifecycleClientId(this.f60385g);
            if (this.f60385g >= 0) {
