...
public abstract class HmsClient extends BaseHmsClient implements AnyClient {
    ...
    public static class a implements BaseAdapter.BaseCallBack {
        ...
        private final AnyClient.CallBack f60537a;

        /* JADX INFO: renamed from: b, reason: collision with root package name */
        private final WeakReference<HmsClient> f60538b;

        a(HmsClient hmsClient, AnyClient.CallBack callBack) {
            this.f60537a = callBack;
            this.f60538b = new WeakReference<>(hmsClient);
        }

        private void a(String str) {
            HmsClient hmsClient = this.f60538b.get();
            if (hmsClient != null) {
        ...
        private void a(String str, String str2) {
            ...
            if (!responseHeader.fromJson(str)) {
                this.f60537a.onCallback(new ResponseHeader(1, CommonCode.ErrorCode.ARGUMENTS_INVALID, "response header json error"), new JSONObject().toString());
                return;
            }
            HMSLog.i("HmsClient", "receive msg " + responseHeader);
            a(responseHeader.getSessionId());
            this.f60537a.onCallback(responseHeader, str2);
        }
        ...
        public void onError(String str) {
            ...
            a(responseHeader.getSessionId());
            this.f60537a.onCallback(responseHeader, responseWrap.getBody());
        }
    }
