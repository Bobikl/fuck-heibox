...
public class UIUtil {
    ...
    public static String getProcessName(Context context, int i10) {
        ...
        if (context != null && (activityManager = (ActivityManager) context.getSystemService(RXScreenCaptureService.KEY_LAUNCH_ACTIVITY)) != null && (runningAppProcesses = activityManager.getRunningAppProcesses()) != null) {
    ...
    public static boolean isBackground(Context context) {
        ...
        for (ActivityManager.RunningAppProcessInfo runningAppProcessInfo : runningAppProcesses) {
            if (TextUtils.equals(runningAppProcessInfo.processName, processName)) {
                ...
                HMSLog.i("UIUtil", "isForground is " + z10 + "***  isLockedState is " + zIsKeyguardLocked);
