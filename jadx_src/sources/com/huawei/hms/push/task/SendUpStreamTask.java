...
public class SendUpStreamTask extends TaskApiCall<PushClient, BaseVoidTask> {
    ...
    private String f61295a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private String f61296b;
    ...
    private void a(PushClient pushClient, ResponseErrorCode responseErrorCode) {
        HMSLog.i("SendUpStreamTask", "receive upstream, msgId :" + this.f61296b + " , packageName = " + this.f61295a + " , errorCode = " + responseErrorCode.getErrorCode());
        Intent intent = new Intent("com.huawei.push.action.MESSAGING_EVENT");
        intent.setPackage(this.f61295a);
        Bundle bundle = new Bundle();
        bundle.putString("message_id", this.f61296b);
