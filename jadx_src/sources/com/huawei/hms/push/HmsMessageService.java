...
public class HmsMessageService extends Service {
    ...
    private final Messenger f61196a = new Messenger(new e(new b()));
    ...
    private void b(Intent intent) {
        ...
        try {
            ...
            for (int i10 = 0; i10 < jSONArray.length(); i10++) {
                ...
                String strOptString = jSONObject.optString(com.tekartik.sqflite.b.f98598q);
    ...
    public void handleIntentMessage(Intent intent) {
        ...
        try {
            ...
            HMSLog.e("HmsMessageService", "handle intent exception: " + e11.getMessage());
        }
    }
