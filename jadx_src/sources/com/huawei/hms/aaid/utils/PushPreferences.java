...
public class PushPreferences {
    ...
    protected SharedPreferences f60253a;
    ...
    public boolean clear() {
        SharedPreferences sharedPreferences = this.f60253a;
    ...
    public boolean removeKey(String str) {
        ...
        SharedPreferences sharedPreferences = this.f60253a;
        if (sharedPreferences == null || !sharedPreferences.contains(str) || (editorEdit = this.f60253a.edit()) == null) {
            return false;
        }
    ...
    public boolean removeKey(String[] strArr) {
        ...
        for (String str : strArr) {
            if (this.f60253a.contains(str)) {
                this.f60253a.edit().remove(str);
            }
        }
        this.f60253a.edit().commit();
        return true;
    }
    ...
    public boolean write(ContentValues contentValues) {
        if (this.f60253a == null || contentValues == null) {
            return false;
        }
        boolean z10 = true;
