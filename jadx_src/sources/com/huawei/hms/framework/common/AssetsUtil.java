...
public class AssetsUtil {
    ...
    public static String[] list(final Context context, final String str) {
        ...
        try {
            ...
            Logger.w(TAG, "get local config files from sp task interrupted", e10);
            return new String[0];
        } catch (ExecutionException e11) {
            Logger.w(TAG, "get local config files from sp task failed", e11);
            return new String[0];
        } finally {
    ...
    public static InputStream open(Context context, String str) throws IOException {
        ...
        try {
            ...
            Logger.e(TAG, "AssetManager has been destroyed", e10);
            return null;
        }
    }
}
