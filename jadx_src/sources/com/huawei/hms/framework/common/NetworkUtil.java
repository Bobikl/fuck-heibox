...
public class NetworkUtil {
    ...
    public static String getMNC(Context context) {
        ...
        Object systemService = ContextCompat.getSystemService(context, g0.a.f118921e);
    ...
    public static int getWifiRssi(Context context) {
        ...
        if (context != null && Build.VERSION.SDK_INT >= 31) {
            try {
                ...
                Logger.i(TAG, "getWifiRssiLevel did not has permission!" + e10.getClass().getSimpleName() + e10.getMessage());
            }
        }
        return rssi;
    }
