...
public class IOUtil {
    ...
    private static final String f63073a = "IOUtil";

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static final int f63074b = 4096;
    ...
    public static void closeSecure(Closeable closeable) {
        if (closeable != null) {
            try {
                ...
                Log.e(f63073a, "closeSecure IOException");
            }
        }
    }
    ...
    public static void deleteSecure(File file) {
        ...
        Log.e(f63073a, "deleteSecure exception");
    }
