...
public class l11l1111Il {
    ...
    private static final String l111l11111I1l = "com.ishumei.smantifraud.l111l1111l1Il.l1111l111111Il.l11l1111Il";
    private static String l111l11111lIl = "Volley";
    ...
    public static final class l1111l111111Il {
        ...
        private final List<C0516l1111l111111Il> l111l11111I1l = new ArrayList();
        private boolean l111l11111Il = false;

        /* JADX INFO: renamed from: com.ishumei.smantifraud.l111l1111l1Il.l1111l111111Il.l11l1111Il$l1111l111111Il$l1111l111111Il, reason: collision with other inner class name */
        public static final class C0516l1111l111111Il {
            public final String l1111l111111Il;
            public final long l111l11111I1l;
            public final long l111l11111lIl;

            public C0516l1111l111111Il(String str, long j10, long j11) {
        ...
        private long l1111l111111Il() {
            ...
            long j10 = this.l111l11111I1l.get(0).l111l11111I1l;
            List<C0516l1111l111111Il> list = this.l111l11111I1l;
            return list.get(list.size() - 1).l111l11111I1l - j10;
        }
        ...
        public final synchronized void l1111l111111Il(String str) {
            ...
            for (C0516l1111l111111Il c0516l1111l111111Il : this.l111l11111I1l) {
                long j13 = c0516l1111l111111Il.l111l11111I1l;
                l11l1111Il.l111l11111lIl("(+%-4d) [%2d] %s", Long.valueOf(j13 - j12), Long.valueOf(c0516l1111l111111Il.l111l11111lIl), c0516l1111l111111Il.l1111l111111Il);
                j12 = j13;
            }
        }
        ...
        public final synchronized void l1111l111111Il(String str, long j10) {
            ...
            this.l111l11111I1l.add(new C0516l1111l111111Il(str, j10, SystemClock.elapsedRealtime()));
        }
    }
    ...
    public static void l1111l111111Il(String str, Object... objArr) {
        if (l1111l111111Il) {
            Log.v(l111l11111lIl, l111l1111l1Il(str, objArr));
        }
    }

    public static void l1111l111111Il(Throwable th2, String str, Object... objArr) {
        Log.e(l111l11111lIl, l111l1111l1Il(str, objArr), th2);
    }

    public static void l111l11111I1l(String str, Object... objArr) {
        Log.e(l111l11111lIl, l111l1111l1Il(str, objArr));
    }

    public static void l111l11111Il(String str, Object... objArr) {
        Log.wtf(l111l11111lIl, l111l1111l1Il(str, objArr));
    }

    public static void l111l11111lIl(String str, Object... objArr) {
        Log.d(l111l11111lIl, l111l1111l1Il(str, objArr));
    }

    private static void l111l11111lIl(Throwable th2, String str, Object... objArr) {
        Log.wtf(l111l11111lIl, l111l1111l1Il(str, objArr), th2);
    }
    ...
    private static String l111l1111l1Il(String str, Object... objArr) {
        ...
        for (int i10 = 2; i10 < stackTrace.length; i10++) {
            if (!stackTrace[i10].getClassName().equals(l111l11111I1l)) {
