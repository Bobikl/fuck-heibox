...
public abstract class l111l1111lI1l<T> implements Comparable<l111l1111lI1l<T>> {
    ...
    private final int l111l1111lI1l;
    private final Object l111l1111lIl;
    ...
    final void l1111l111111Il(int i10) {
    ...
    final void l1111l111111Il(l11l1111lIIl<?> l11l1111liil) {
        synchronized (this.l111l1111lIl) {
        }
    }

    protected abstract void l1111l111111Il(T t10);
    ...
    final void l111l11111lIl(final String str) {
        l111l1111lIl l111l1111lil = this.l11l1111I1l;
        if (l111l1111lil != null) {
    ...
    public String toString() {
        String str = "0x" + Integer.toHexString(this.l111l1111lI1l);
        StringBuilder sb2 = new StringBuilder();
        ...
        sb2.append(str);
        sb2.append(" ");
        sb2.append(l111l11111I1l.NORMAL);
        sb2.append(" ");
        sb2.append(this.l11l1111I11l);
        return sb2.toString();
    }
}
