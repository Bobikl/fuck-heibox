...
public class l11l111l11Il {
    ...
    static String l1111l111111Il(Set<JSONObject> set, JSONObject jSONObject, boolean z10) {
        String str;
        try {
            ...
            String strL111l11111lIl = com.ishumei.smantifraud.l111l11111lIl.l1111l111111Il.l111l11111Il.l111l11111lIl();
            if (TextUtils.isEmpty(strL111l11111lIl)) {
                strL111l11111lIl = "";
                str = strL111l11111lIl;
            } else if (strL111l11111lIl.startsWith("B")) {
                str = "";
            } else {
                str = strL111l11111lIl;
                strL111l11111lIl = "";
            ...
            if (TextUtils.isEmpty(strL111l11111lIl)) {
                strL111l11111lIl = com.ishumei.smantifraud.l111l11111lIl.l1111l111111Il.l111l11111Il.l1111l111111Il().l111l1111llIl();
                if (TextUtils.isEmpty(strL111l11111lIl)) {
                    strL111l11111lIl = com.ishumei.smantifraud.l111l11111lIl.l1111l111111Il.l111l11111Il.l1111l111111Il().l111l1111l1Il();
                }
            }
            if (!TextUtils.isEmpty(strL111l11111lIl)) {
                jSONObject2.put("smid", strL111l11111lIl);
            } else if (z10) {
            ...
            return l11l1111Il.l1111l111111Il.l1111l111111Il.l1111l111111Il(th2);
        }
    }
