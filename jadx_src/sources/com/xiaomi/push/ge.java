...
public enum ge {
    ...
    GSLB_TCP_ERR_OTHER(bb.c.l.N4),
    GSLB_ERR(bb.c.l.f34191hk),
    CONN_SUCCESS(20000),
        ...
        switch (i10) {
            ...
            default:
                switch (i10) {
                    ...
                    case bb.c.l.N4 /* 10199 */:
                        return GSLB_TCP_ERR_OTHER;
                    case bb.c.l.f34191hk /* 10999 */:
                        return GSLB_ERR;
                    case 20000:
                        return CONN_SUCCESS;
                    case 20199:
