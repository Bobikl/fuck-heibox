...
public class JsonReader implements Closeable {
    ...
    private int peekNumber() throws IOException {
        ...
        if (c12 == 2 && z10 && ((j10 != Long.MIN_VALUE || z11) && (j10 != 0 || !z11))) {
            if (!z11) {
                j10 = -j10;
            }
            this.peekedLong = j10;
    ...
    public double nextDouble() throws IOException {
        ...
        if (iDoPeek == 16) {
            ...
            this.peekedString = nextQuotedValue(iDoPeek == 8 ? '\'' : y.f128593b);
        } else if (iDoPeek == 10) {
    ...
    public String nextName() throws IOException {
        ...
        if (iDoPeek == 14) {
            ...
            strNextQuotedValue = nextQuotedValue(y.f128593b);
        }
        this.peeked = 0;
    ...
    public String nextString() throws IOException {
        ...
        if (iDoPeek == 10) {
            ...
            str = nextQuotedValue(y.f128593b);
        } else if (iDoPeek == 11) {
