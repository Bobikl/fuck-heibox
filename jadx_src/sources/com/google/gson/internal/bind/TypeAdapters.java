                ...
                for (Field field : (Field[]) AccessController.doPrivileged(new PrivilegedAction<Field[]>() { // from class: com.google.gson.internal.bind.TypeAdapters.EnumTypeAdapter.1
                    ...
                    if (serializedName != null) {
                        ...
                        for (String str : serializedName.alternate()) {
                            this.nameToConstant.put(str, (T) r10);
                        }
                    }
                    this.nameToConstant.put(strName, (T) r10);
                    this.constantToName.put((T) r10, strName);
                }
    ...
    static {
        ...
        TypeAdapter<Locale> typeAdapter14 = new TypeAdapter<Locale>() { // from class: com.google.gson.internal.bind.TypeAdapters.27
            ...
            public Locale read2(JsonReader jsonReader) throws IOException {
                ...
                StringTokenizer stringTokenizer = new StringTokenizer(jsonReader.nextString(), a.f131412e);
                ...
                if (cls.isAssignableFrom(rawType)) {
                    return (TypeAdapter<T2>) new TypeAdapter<T1>() { // from class: com.google.gson.internal.bind.TypeAdapters.34.1
                        ...
                        public T1 read2(JsonReader jsonReader) throws IOException {
                            T1 t10 = (T1) typeAdapter.read2(jsonReader);
                            if (t10 == null || rawType.isInstance(t10)) {
                                return t10;
                            }
                            throw new JsonSyntaxException("Expected a " + rawType.getName() + " but was " + t10.getClass().getName() + "; at path " + jsonReader.getPreviousPath());
                        }

                        @Override // com.google.gson.TypeAdapter
                        public void write(JsonWriter jsonWriter, T1 t10) throws IOException {
