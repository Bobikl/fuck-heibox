...
public class ThreadLocalCache {
    ...
    public static byte[] getBytes(int i10) {
        ...
        return (softReference == null || (bArr = softReference.get()) == null || bArr.length < i10) ? allocateBytes(i10) : bArr;
    }

    public static char[] getChars(int i10) {
        char[] cArr;
        SoftReference<char[]> softReference = charsBufLocal.get();
        return (softReference == null || (cArr = softReference.get()) == null || cArr.length < i10) ? allocate(i10) : cArr;
    }
