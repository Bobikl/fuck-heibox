...
public enum HonorPushErrorEnum {
    ...
    ERROR_HTTP_OPERATION_FREQUENTLY(c.l.f34061c5, "http operation too frequently.");
    ...
    static {
        ...
        for (int i10 = 0; i10 < 24; i10++) {
            HonorPushErrorEnum honorPushErrorEnum = honorPushErrorEnumArrValues[i10];
            ENUM_MAPPER.put(honorPushErrorEnum.statusCode, honorPushErrorEnum);
        }
    }

    HonorPushErrorEnum(int i10, String str) {
        this.statusCode = i10;
        this.message = str;
    }

    public static HonorPushErrorEnum fromCode(int i10) {
        return ENUM_MAPPER.get(i10, ERROR_UNKNOWN);
    }
