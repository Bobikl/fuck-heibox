...
public class EglRenderer implements VideoSink {
        ...
        synchronized (this.frameLock) {
            ...
            if (i12 != 1) {
                ...
                if (z10) {
                    ...
                    z11 = true;
                    this.frameDrawer.drawFrame(videoFrame, this.drawer, this.drawMatrix, iSurfaceWidth, iSurfaceHeight, i10, i11);
    ...
    public void addFrameListener(final FrameListener frameListener, final float f10, @p0 final RendererCommon.GlDrawer glDrawer, final boolean z10) {
        postToRenderThread(new Runnable() { // from class: com.ss.bytertc.base.media.e
            @Override // java.lang.Runnable
            public final void run() {
                this.f97878b.lambda$addFrameListener$3(glDrawer, frameListener, f10, z10);
            }
        });
    }
    ...
    public void clearImage(final float f10, final float f11, final float f12, final float f13) {
        synchronized (this.handlerLock) {
            ...
            handler.postAtFrontOfQueue(new Runnable() { // from class: com.ss.bytertc.base.media.g
                @Override // java.lang.Runnable
                public final void run() {
                    this.f97886b.lambda$clearImage$6(f10, f11, f12, f13);
                }
            });
        }
    }
    ...
    public void init(@p0 final EglBase.Context context, final int[] iArr, RendererCommon.GlDrawer glDrawer, boolean z10) {
        synchronized (this.handlerLock) {
            ...
            ThreadUtils.invokeAtFrontUninterruptibly(handlerWithExceptionCallback, new Runnable() { // from class: com.ss.bytertc.base.media.h
                @Override // java.lang.Runnable
                public final void run() {
                    this.f97891b.lambda$init$0(context, iArr);
                }
            });
    ...
    public void onFrame(VideoFrame videoFrame) {
        ...
        synchronized (this.handlerLock) {
            ...
            synchronized (this.frameLock) {
                ...
                videoFrame.retain();
                this.renderThreadHandler.post(new Runnable() { // from class: com.ss.bytertc.base.media.d
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f97877b.renderFrameOnRenderThread();
                    }
                });
            }
            if (z10) {
    ...
    public void release() {
        ...
        synchronized (this.handlerLock) {
            ...
            this.renderThreadHandler.postAtFrontOfQueue(new Runnable() { // from class: com.ss.bytertc.base.media.a
                @Override // java.lang.Runnable
                public final void run() {
                    this.f97849b.lambda$release$1(countDownLatch);
                }
            });
            final Looper looper = this.renderThreadHandler.getLooper();
            this.renderThreadHandler.post(new Runnable() { // from class: com.ss.bytertc.base.media.b
                @Override // java.lang.Runnable
                public final void run() {
                    this.f97851b.lambda$release$2(looper);
                }
            });
            this.renderThreadHandler = null;
            int i10 = mDestroyTimeoutMs;
            if (i10 <= 0) {
    ...
    public void releaseEglSurface(final Runnable runnable) {
        ...
        synchronized (this.handlerLock) {
            ...
            if (handler == null) {
                ...
                this.renderThreadHandler.postAtFrontOfQueue(new Runnable() { // from class: com.ss.bytertc.base.media.c
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f97853b.lambda$releaseEglSurface$5(runnable);
                    }
                });
            }
        }
    ...
    public void removeFrameListener(final FrameListener frameListener) {
        ...
        synchronized (this.handlerLock) {
            ...
            postToRenderThread(new Runnable() { // from class: com.ss.bytertc.base.media.f
                @Override // java.lang.Runnable
                public final void run() {
                    this.f97883b.lambda$removeFrameListener$4(countDownLatch, frameListener);
                }
            });
            ThreadUtils.awaitUninterruptibly(countDownLatch);
        }
