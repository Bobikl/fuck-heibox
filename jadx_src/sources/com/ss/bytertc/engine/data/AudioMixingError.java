...
public enum AudioMixingError {
    ...
    /* JADX INFO: renamed from: com.ss.bytertc.engine.data.AudioMixingError$1, reason: invalid class name */
    ...
    AudioMixingError(int i10) {
        this.value = i10;
    }

    @CalledByNative
    public static AudioMixingError fromId(int i10) {
        for (AudioMixingError audioMixingError : values()) {
            if (audioMixingError.value() == i10) {
