...
public enum AudioMixingState {
    ...
    /* JADX INFO: renamed from: com.ss.bytertc.engine.data.AudioMixingState$1, reason: invalid class name */
    ...
    AudioMixingState(int i10) {
        this.value = i10;
    }

    @CalledByNative
    public static AudioMixingState fromId(int i10) {
        for (AudioMixingState audioMixingState : values()) {
            if (audioMixingState.value() == i10) {
