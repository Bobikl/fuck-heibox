...
public enum AudioPlaybackDevice {
    ...
    @CalledByNative
    public static AudioPlaybackDevice fromId(int i10) {
        for (AudioPlaybackDevice audioPlaybackDevice : values()) {
            if (audioPlaybackDevice.value() == i10) {
    ...
    public String toString() {
        int i10 = AnonymousClass1.$SwitchMap$com$ss$bytertc$engine$data$AudioPlaybackDevice[ordinal()];
        if (i10 == 1) {
        ...
        if (i10 != 4) {
            return i10 != 5 ? "" : "kAudioPlaybackDeviceHeadsetUSB";
        }
