...
public class MixedStreamProxy implements IMixedStreamObserver {
    ...
    public void onMixingEvent(ByteRTCStreamMixingEvent byteRTCStreamMixingEvent, String str, ByteRTCTranscoderErrorCode byteRTCTranscoderErrorCode, MixedStreamType mixedStreamType) {
        ...
        map.put("mixType", Integer.valueOf(mixedStreamType.value()));
        this.emitter.emit("onMixingEvent", map);
    }
    ...
    public void registerEvent(BinaryMessenger binaryMessenger) {
        this.emitter.registerEvent(binaryMessenger, "com.bytedance.ve_rtc_mix_stream");
    }
}
