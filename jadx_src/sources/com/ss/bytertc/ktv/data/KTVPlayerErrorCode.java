...
public enum KTVPlayerErrorCode {
    ...
    /* JADX INFO: renamed from: com.ss.bytertc.ktv.data.KTVPlayerErrorCode$1, reason: invalid class name */
    ...
    KTVPlayerErrorCode(int i10) {
        this.value = i10;
    }

    @CalledByNative
    public static KTVPlayerErrorCode fromId(int i10) {
        for (KTVPlayerErrorCode kTVPlayerErrorCode : values()) {
            if (kTVPlayerErrorCode.value() == i10) {
