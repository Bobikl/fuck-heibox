...
public enum KTVErrorCode {
    OK(0),
    APPID_INVALID(TnetStatusCode.EASY_REASON_HANDSHAKE_ERROR),
    PARAS_INVALID(-3001),
    ...
    /* JADX INFO: renamed from: com.ss.bytertc.ktv.data.KTVErrorCode$1, reason: invalid class name */
    ...
    KTVErrorCode(int i10) {
        this.value = i10;
    }

    @CalledByNative
    public static KTVErrorCode fromId(int i10) {
        for (KTVErrorCode kTVErrorCode : values()) {
            if (kTVErrorCode.value() == i10) {
                return kTVErrorCode;
            }
        }
        return null;
