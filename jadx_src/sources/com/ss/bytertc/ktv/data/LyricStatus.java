...
public enum LyricStatus {
    ...
    /* JADX INFO: renamed from: com.ss.bytertc.ktv.data.LyricStatus$1, reason: invalid class name */
    ...
    @CalledByNative
    public static LyricStatus fromId(int i10) {
        for (LyricStatus lyricStatus : values()) {
            if (lyricStatus.value() == i10) {
                return lyricStatus;
            }
        }
        return null;
    ...
    public String toString() {
        int i10 = AnonymousClass1.$SwitchMap$com$ss$bytertc$ktv$data$LyricStatus[ordinal()];
        if (i10 == 1) {
        ...
        if (i10 != 3) {
            return i10 != 4 ? "" : "LYRIC_STATUS_NONE";
        }
