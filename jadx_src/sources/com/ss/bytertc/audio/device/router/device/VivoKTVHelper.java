...
public class VivoKTVHelper {
    ...
    static {
        int[][] iArr = {new int[]{200, 1000, 500, c.f.f32181c1, 1000, 1500}, new int[]{5000, c.f.f32181c1, 1200, c.f.f32181c1, c.g.f33101t, 1200}, new int[]{c.f.f32181c1, 8000, 1000, 4000, c.g.f33101t, 1500}, new int[]{2500, 3000, 1500, 4000, 5000, 1500}, new int[]{c.d.pr, c.f.f32477ok, 1500, 5000, c.f.f32477ok, 1500}, new int[]{4000, 3000, 1000, 2500, c.f.f32477ok, 1200}, new int[]{500, 5000, 800, c.f.f32181c1, 3000, 1200}, new int[]{20, 500, 60, c.f.f32181c1, 5000, 1500}, new int[]{0, 0, 0, 4000, 0, 1200}};
        ...
        EchoCustomParams = new int[][]{new int[]{c.d.Bl, 150, 1500, 2000}};
    }
    ...
    private void setEQParams(int i10) {
        ...
        this.mAudioManager.setParameters("vivo_ktv_miceq_band2=" + (iArr[i10][1] + 8));
        this.mAudioManager.setParameters("vivo_ktv_miceq_band3=" + (iArr[i10][2] + 8));
        this.mAudioManager.setParameters("vivo_ktv_miceq_band4=" + (iArr[i10][3] + 8));
        this.mAudioManager.setParameters("vivo_ktv_miceq_band5=" + (iArr[i10][4] + 8));
    }

    private void setEchoParams(int i10) {
        if (i10 == 4) {
    ...
    private void setGramophoneParams(int i10) {
        if (i10 == 7) {
    ...
    private void setReverbParams(int i10) {
        AudioManager audioManager = this.mAudioManager;
        StringBuilder sb2 = new StringBuilder();
        ...
        audioManager.setParameters(sb2.toString());
        this.mAudioManager.setParameters("vivo_ktv_rb_damp=" + iArr[i10][1]);
        this.mAudioManager.setParameters("vivo_ktv_rb_wet=" + iArr[i10][2]);
        this.mAudioManager.setParameters("vivo_ktv_rb_dry=" + iArr[i10][3]);
        this.mAudioManager.setParameters("vivo_ktv_rb_width=" + iArr[i10][4]);
        this.mAudioManager.setParameters("vivo_ktv_rb_gain=" + iArr[i10][5]);
    ...
    public boolean isDeviceSupportKaraoke() {
        ...
        if (Build.MANUFACTURER.trim().contains("vivo")) {
            ...
            if (stringTokenizer.countTokens() == 2 && stringTokenizer.nextToken().equals(KEY_MIC_TYPE) && ((i10 = Integer.parseInt(stringTokenizer.nextToken())) == 1 || i10 == 0)) {
                return true;
            }
        }
        return false;
    ...
    public void setCustomMode(int i10) {
        Log.v(TAG, "setCustomMode: " + i10);
        synchronized (this.mParamLock) {
            setExtSpeakerParam(0);
            setGramophoneParams(i10);
            setReverbParams(i10);
            setEQParams(i10);
            setEchoParams(i10);
        }
