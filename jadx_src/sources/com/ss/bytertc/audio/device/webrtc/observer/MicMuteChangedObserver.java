...
public class MicMuteChangedObserver {
    ...
    public final class MicMuteBroadCastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            try {
                ...
                Log.e(MicMuteChangedObserver.TAG, "MicMuteBroadCastReceiver.onReceive, exception: " + e10.getMessage());
            }
        }
    }

    public interface OnMicMuteChangedListener {
        void onMicMuteChanged(boolean z10);
    }
    ...
    private void unregisterReceiver() {
        ...
        try {
            ...
            Log.e(TAG, "unregisterReceiver, exception: " + e10.getMessage());
        }
    }
