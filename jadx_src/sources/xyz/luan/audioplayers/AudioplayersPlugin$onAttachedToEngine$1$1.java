...
public final /* synthetic */ class AudioplayersPlugin$onAttachedToEngine$1$1 extends FunctionReferenceImpl implements p<MethodCall, MethodChannel.Result, b2> {
    AudioplayersPlugin$onAttachedToEngine$1$1(Object obj) {
    ...
    public final void i(@dl.d MethodCall p10, @dl.d MethodChannel.Result p11) {
        f0.p(p10, "p0");
        f0.p(p11, "p1");
        ((AudioplayersPlugin) this.receiver).q(p10, p11);
    }
