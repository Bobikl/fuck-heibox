...
public final class MaybeFlatMapObservable<T, R> extends z<R> {
    ...
    final o<? super T, ? extends e0<? extends R>> f121843c;
    ...
    public static final class FlatMapObserver<T, R> extends AtomicReference<io.reactivex.disposables.b> implements g0<R>, t<T>, io.reactivex.disposables.b {
        ...
        /* JADX INFO: renamed from: b, reason: collision with root package name */
        final g0<? super R> f121844b;

        /* JADX INFO: renamed from: c, reason: collision with root package name */
        final o<? super T, ? extends e0<? extends R>> f121845c;
        ...
        public void onComplete() {
            this.f121844b.onComplete();
        }

        @Override // io.reactivex.g0
        public void onError(Throwable th2) {
            this.f121844b.onError(th2);
        }

        @Override // io.reactivex.g0
        public void onNext(R r10) {
            this.f121844b.onNext(r10);
        }
        ...
        public void onSuccess(T t10) {
            try {
                ((e0) io.reactivex.internal.functions.a.g(this.f121845c.apply(t10), "The mapper returned a null Publisher")).g(this);
            } catch (Throwable th2) {
    ...
    protected void H5(g0<? super R> g0Var) {
        FlatMapObserver flatMapObserver = new FlatMapObserver(g0Var, this.f121843c);
        g0Var.onSubscribe(flatMapObserver);
        this.f121842b.f(flatMapObserver);
    }
}
