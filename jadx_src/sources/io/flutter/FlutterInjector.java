...
public final class FlutterInjector {
    ...
    public static final class Builder {
        ...
        public Builder setDeferredComponentManager(@p0 DeferredComponentManager deferredComponentManager) {
            this.deferredComponentManager = deferredComponentManager;
            return this;
        }

        public Builder setExecutorService(@n0 ExecutorService executorService) {
            this.executorService = executorService;
            return this;
        }

        public Builder setFlutterJNIFactory(@n0 FlutterJNI.Factory factory) {
            this.flutterJniFactory = factory;
            return this;
        }

        public Builder setFlutterLoader(@n0 FlutterLoader flutterLoader) {
            this.flutterLoader = flutterLoader;
            return this;
        }
    }

    private FlutterInjector(@n0 FlutterLoader flutterLoader, @p0 DeferredComponentManager deferredComponentManager, @n0 FlutterJNI.Factory factory, @n0 ExecutorService executorService) {
        this.flutterLoader = flutterLoader;
        this.deferredComponentManager = deferredComponentManager;
        this.flutterJniFactory = factory;
        this.executorService = executorService;
    ...
    public static void setInstance(@n0 FlutterInjector flutterInjector) {
        if (accessed) {
