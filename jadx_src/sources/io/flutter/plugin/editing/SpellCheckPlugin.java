...
public class SpellCheckPlugin implements SpellCheckChannel.SpellCheckMethodHandler, SpellCheckerSession.SpellCheckerSessionListener {
    ...
    public SpellCheckPlugin(@n0 TextServicesManager textServicesManager, @n0 SpellCheckChannel spellCheckChannel) {
    ...
    public void initiateSpellCheck(@n0 String str, @n0 String str2, @n0 MethodChannel.Result result) {
    ...
    public void performSpellCheck(@n0 String str, @n0 String str2) {
