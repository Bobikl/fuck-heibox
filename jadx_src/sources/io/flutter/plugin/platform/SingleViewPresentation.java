...
public class SingleViewPresentation extends Presentation {
    ...
    public static class ImmContext extends ContextWrapper {
        ...
        private ImmContext(Context context, @p0 InputMethodManager inputMethodManager) {
            super(context);
    ...
    public static class PresentationContext extends ContextWrapper {
        ...
        PresentationContext(Context context, @n0 WindowManagerHandler windowManagerHandler, Context context2) {
            super(context);
