...
public class StandardMessageCodec implements MessageCodec<Object> {
    ...
    protected static final void readAlignment(@n0 ByteBuffer byteBuffer, int i10) {
    ...
    @n0
    protected static final byte[] readBytes(@n0 ByteBuffer byteBuffer) {
        byte[] bArr = new byte[readSize(byteBuffer)];
        byteBuffer.get(bArr);
        return bArr;
    }

    protected static final int readSize(@n0 ByteBuffer byteBuffer) {
        ...
        return i10 == 254 ? byteBuffer.getChar() : byteBuffer.getInt();
    }

    protected static final void writeAlignment(@n0 ByteArrayOutputStream byteArrayOutputStream, int i10) {
    ...
    protected static final void writeBytes(@n0 ByteArrayOutputStream byteArrayOutputStream, @n0 byte[] bArr) {
        writeSize(byteArrayOutputStream, bArr.length);
        byteArrayOutputStream.write(bArr, 0, bArr.length);
    }

    protected static final void writeChar(@n0 ByteArrayOutputStream byteArrayOutputStream, int i10) {
        if (LITTLE_ENDIAN) {
    ...
    protected static final void writeDouble(@n0 ByteArrayOutputStream byteArrayOutputStream, double d10) {
        writeLong(byteArrayOutputStream, Double.doubleToLongBits(d10));
    }

    protected static final void writeFloat(@n0 ByteArrayOutputStream byteArrayOutputStream, float f10) {
        writeInt(byteArrayOutputStream, Float.floatToIntBits(f10));
    }

    protected static final void writeInt(@n0 ByteArrayOutputStream byteArrayOutputStream, int i10) {
        if (LITTLE_ENDIAN) {
            byteArrayOutputStream.write(i10);
            byteArrayOutputStream.write(i10 >>> 8);
    ...
    protected static final void writeLong(@n0 ByteArrayOutputStream byteArrayOutputStream, long j10) {
        if (LITTLE_ENDIAN) {
    ...
    protected static final void writeSize(@n0 ByteArrayOutputStream byteArrayOutputStream, int i10) {
        if (i10 < 254) {
            byteArrayOutputStream.write(i10);
        } else if (i10 <= 65535) {
    ...
    @n0
    protected final Object readValue(@n0 ByteBuffer byteBuffer) {
        if (byteBuffer.hasRemaining()) {
    ...
    protected void writeValue(@n0 ByteArrayOutputStream byteArrayOutputStream, @p0 Object obj) {
        int i10 = 0;
