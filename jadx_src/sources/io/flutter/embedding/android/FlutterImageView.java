...
public class FlutterImageView extends View implements RenderSurface {
    ...
    public FlutterImageView(@n0 Context context) {
        this(context, 1, 1, SurfaceKind.background);
    }

    public FlutterImageView(@n0 Context context, int i10, int i11, SurfaceKind surfaceKind) {
        this(context, createImageReader(i10, i11), surfaceKind);
    }

    @j1
    FlutterImageView(@n0 Context context, @n0 ImageReader imageReader, SurfaceKind surfaceKind) {
        super(context, null);
    ...
    public FlutterImageView(@n0 Context context, @n0 AttributeSet attributeSet) {
        this(context, 1, 1, SurfaceKind.background);
    }
