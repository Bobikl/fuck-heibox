...
public final class ApplicationInfoLoader {
    ...
    public static final String PUBLIC_AOT_SHARED_LIBRARY_NAME = FlutterLoader.class.getName() + lg.a.f131414g + "aot-shared-library-name";
    public static final String PUBLIC_VM_SNAPSHOT_DATA_KEY = FlutterLoader.class.getName() + lg.a.f131414g + "vm-snapshot-data";
    public static final String PUBLIC_ISOLATE_SNAPSHOT_DATA_KEY = FlutterLoader.class.getName() + lg.a.f131414g + "isolate-snapshot-data";
    public static final String PUBLIC_FLUTTER_ASSETS_DIR_KEY = FlutterLoader.class.getName() + lg.a.f131414g + "flutter-assets-dir";

    @n0
    private static ApplicationInfo getApplicationInfo(@n0 Context context) {
        try {
    ...
    @n0
    public static FlutterApplicationInfo load(@n0 Context context) {
