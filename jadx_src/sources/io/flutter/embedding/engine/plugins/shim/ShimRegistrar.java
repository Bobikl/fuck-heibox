...
public class ShimRegistrar implements PluginRegistry.Registrar, FlutterPlugin, ActivityAware {
    ...
    public ShimRegistrar(@n0 String str, @n0 Map<String, Object> map) {
        this.pluginId = str;
    ...
    @Override // io.flutter.plugin.common.PluginRegistry.Registrar
    @n0
    public PluginRegistry.Registrar addViewDestroyListener(@n0 PluginRegistry.ViewDestroyListener viewDestroyListener) {
