...
public class RestorationChannel {
    ...
    public RestorationChannel(@n0 DartExecutor dartExecutor, @n0 boolean z10) {
        this(new MethodChannel(dartExecutor, "flutter/restoration", StandardMethodCodec.INSTANCE), z10);
    }

    RestorationChannel(MethodChannel methodChannel, @n0 boolean z10) {
    ...
    public void setRestorationData(@n0 final byte[] bArr) {
