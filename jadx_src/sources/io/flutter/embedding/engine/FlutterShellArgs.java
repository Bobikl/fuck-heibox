...
public class FlutterShellArgs {
    ...
    public FlutterShellArgs(@n0 List<String> list) {
        this.args = new HashSet(list);
    }

    public FlutterShellArgs(@n0 Set<String> set) {
        this.args = new HashSet(set);
    }

    public FlutterShellArgs(@n0 String[] strArr) {
        this.args = new HashSet(Arrays.asList(strArr));
    }

    @n0
    public static FlutterShellArgs fromIntent(@n0 Intent intent) {
