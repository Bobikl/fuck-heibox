...
public final class a {
    ...
    @p0
    private static Drawable d(@p0 Drawable drawable, @p0 ColorStateList colorStateList, @p0 PorterDuff.Mode mode, boolean z10) {
        if (drawable == null) {
            return null;
        }
    ...
    @n0
    public static AttributeSet g(@n0 Context context, @l1 int i10, @n0 CharSequence charSequence) {
        int next;
        try {
    ...
    public static void h(@n0 Outline outline, @n0 Path path) {
    ...
    @TargetApi(21)
    public static void i(@p0 RippleDrawable rippleDrawable, int i10) {
        rippleDrawable.setRadius(i10);
    }

    public static void j(@n0 Drawable drawable, @l int i10) {
        if (i10 != 0) {
            d.n(drawable, i10);
        } else {
            d.o(drawable, null);
    ...
    @p0
    public static PorterDuffColorFilter k(@n0 Drawable drawable, @p0 ColorStateList colorStateList, @p0 PorterDuff.Mode mode) {
