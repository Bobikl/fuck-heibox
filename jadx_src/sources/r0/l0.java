...
@Metadata(bv = {}, d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0004\u001a\u00020\u0001*\u00020\u00008F¢\u0006\u0006\u001a\u0004\b\u0002\u0010\u0003¨\u0006\u0005"}, d2 = {"Ln0/a$d;", "Landroidx/compose/ui/graphics/vector/c;", ak.av, "(Ln0/a$d;)Landroidx/compose/ui/graphics/vector/c;", "Phone", "material-icons-core_release"}, k = 2, mv = {1, 7, 1})
public final class l0 {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    @dl.e
    private static androidx.compose.ui.graphics.vector.c f138729a;

    @dl.d
    public static final androidx.compose.ui.graphics.vector.c a(@dl.d n0.a.d dVar) {
        kotlin.jvm.internal.f0.p(dVar, "<this>");
        androidx.compose.ui.graphics.vector.c cVar = f138729a;
        if (cVar != null) {
            kotlin.jvm.internal.f0.m(cVar);
            return cVar;
        }
        androidx.compose.ui.graphics.vector.c.a aVar = new androidx.compose.ui.graphics.vector.c.a("Sharp.Phone", s1.h.g(24.0f), s1.h.g(24.0f), 24.0f, 24.0f, 0L, 0, 96, (kotlin.jvm.internal.u) null);
        ...
        eVar.j(8.54f, 3.0f);
        eVar.h(3.03f);
        eVar.e(2.45f, 13.18f, 10.82f, 21.55f, 21.0f, 20.97f);
        eVar.u(-5.51f);
        eVar.d();
