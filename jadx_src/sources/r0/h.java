...
@Metadata(bv = {}, d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\"\u0015\u0010\u0004\u001a\u00020\u0001*\u00020\u00008F¢\u0006\u0006\u001a\u0004\b\u0002\u0010\u0003¨\u0006\u0005"}, d2 = {"Ln0/a$d;", "Landroidx/compose/ui/graphics/vector/c;", ak.av, "(Ln0/a$d;)Landroidx/compose/ui/graphics/vector/c;", "Build", "material-icons-core_release"}, k = 2, mv = {1, 7, 1})
public final class h {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    @dl.e
    private static androidx.compose.ui.graphics.vector.c f138720a;

    @dl.d
    public static final androidx.compose.ui.graphics.vector.c a(@dl.d n0.a.d dVar) {
        kotlin.jvm.internal.f0.p(dVar, "<this>");
        androidx.compose.ui.graphics.vector.c cVar = f138720a;
        if (cVar != null) {
            kotlin.jvm.internal.f0.m(cVar);
            return cVar;
        }
        androidx.compose.ui.graphics.vector.c.a aVar = new androidx.compose.ui.graphics.vector.c.a("Sharp.Build", s1.h.g(24.0f), s1.h.g(24.0f), 24.0f, 24.0f, 0L, 0, 96, (kotlin.jvm.internal.u) null);
        ...
        eVar.l(12.09f, 2.91f);
        eVar.e(10.08f, 0.9f, 7.07f, 0.49f, 4.65f, 1.67f);
        eVar.k(4.34f, 4.34f);
        eVar.k(-3.0f, 3.0f);
        eVar.k(-4.34f, -4.34f);
        eVar.e(0.48f, 7.1f, 0.89f, 10.09f, 2.9f, 12.1f);
        eVar.f(1.86f, 1.86f, 4.58f, 2.35f, 6.89f, 1.48f);
        eVar.k(9.82f, 9.82f);
        eVar.k(3.71f, -3.71f);
        eVar.k(-9.78f, -9.79f);
        eVar.f(0.92f, -2.34f, 0.44f, -5.1f, -1.45f, -6.99f);
        eVar.d();
