...
public final /* synthetic */ class LazyJavaClassMemberScope$computeNonDeclaredFunctions$3 extends FunctionReference implements l<f, Collection<? extends s0>> {
    ...
    public final Collection<s0> invoke(@dl.d f p10) {
        f0.p(p10, "p0");
        return ((LazyJavaClassMemberScope) this.receiver).J0(p10);
    }
}
