...
public final class KotlinTarget {
    ...
    static {
        ...
        int i10 = 2;
        u uVar = null;
        PROPERTY = new KotlinTarget("PROPERTY", 3, a0.f133862j, z10, i10, uVar);
        boolean z11 = false;
        int i11 = 2;
        u uVar2 = null;
        FIELD = new KotlinTarget("FIELD", 4, "field", z11, i11, uVar2);
        LOCAL_VARIABLE = new KotlinTarget("LOCAL_VARIABLE", 5, "local variable", z10, i10, uVar);
        VALUE_PARAMETER = new KotlinTarget("VALUE_PARAMETER", 6, "value parameter", z11, i11, uVar2);
        CONSTRUCTOR = new KotlinTarget("CONSTRUCTOR", 7, "constructor", z10, i10, uVar);
        FUNCTION = new KotlinTarget("FUNCTION", 8, "function", z11, i11, uVar2);
        PROPERTY_GETTER = new KotlinTarget("PROPERTY_GETTER", 9, "getter", z10, i10, uVar);
        PROPERTY_SETTER = new KotlinTarget("PROPERTY_SETTER", 10, "setter", z11, i11, uVar2);
        ...
        DEFAULT_TARGET_SET = CollectionsKt___CollectionsKt.V5(arrayList);
        ALL_TARGET_SET = ArraysKt___ArraysKt.Mz(values());
        KotlinTarget kotlinTarget3 = CLASS;
        ANNOTATION_CLASS_LIST = CollectionsKt__CollectionsKt.L(ANNOTATION_CLASS, kotlinTarget3);
        LOCAL_CLASS_LIST = CollectionsKt__CollectionsKt.L(LOCAL_CLASS, kotlinTarget3);
        CLASS_LIST = CollectionsKt__CollectionsKt.L(CLASS_ONLY, kotlinTarget3);
        KotlinTarget kotlinTarget4 = OBJECT;
        COMPANION_OBJECT_LIST = CollectionsKt__CollectionsKt.L(COMPANION_OBJECT, kotlinTarget4, kotlinTarget3);
        OBJECT_LIST = CollectionsKt__CollectionsKt.L(STANDALONE_OBJECT, kotlinTarget4, kotlinTarget3);
        INTERFACE_LIST = CollectionsKt__CollectionsKt.L(INTERFACE, kotlinTarget3);
        ENUM_LIST = CollectionsKt__CollectionsKt.L(ENUM_CLASS, kotlinTarget3);
        KotlinTarget kotlinTarget5 = PROPERTY;
        KotlinTarget kotlinTarget6 = FIELD;
        ENUM_ENTRY_LIST = CollectionsKt__CollectionsKt.L(ENUM_ENTRY, kotlinTarget5, kotlinTarget6);
        KotlinTarget kotlinTarget7 = PROPERTY_SETTER;
        PROPERTY_SETTER_LIST = s.k(kotlinTarget7);
        KotlinTarget kotlinTarget8 = PROPERTY_GETTER;
        PROPERTY_GETTER_LIST = s.k(kotlinTarget8);
        FUNCTION_LIST = s.k(FUNCTION);
        KotlinTarget kotlinTarget9 = FILE;
        FILE_LIST = s.k(kotlinTarget9);
        AnnotationUseSiteTarget annotationUseSiteTarget = AnnotationUseSiteTarget.CONSTRUCTOR_PARAMETER;
        KotlinTarget kotlinTarget10 = VALUE_PARAMETER;
        USE_SITE_MAPPING = s0.W(c1.a(annotationUseSiteTarget, kotlinTarget10), c1.a(AnnotationUseSiteTarget.FIELD, kotlinTarget6), c1.a(AnnotationUseSiteTarget.PROPERTY, kotlinTarget5), c1.a(AnnotationUseSiteTarget.FILE, kotlinTarget9), c1.a(AnnotationUseSiteTarget.PROPERTY_GETTER, kotlinTarget8), c1.a(AnnotationUseSiteTarget.PROPERTY_SETTER, kotlinTarget7), c1.a(AnnotationUseSiteTarget.RECEIVER, kotlinTarget10), c1.a(AnnotationUseSiteTarget.SETTER_PARAMETER, kotlinTarget10), c1.a(AnnotationUseSiteTarget.PROPERTY_DELEGATE_FIELD, kotlinTarget6));
    }
    ...
    /* synthetic */ KotlinTarget(String str, int i10, String str2, boolean z10, int i11, u uVar) {
