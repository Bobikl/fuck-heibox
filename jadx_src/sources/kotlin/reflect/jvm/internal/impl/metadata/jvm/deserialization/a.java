...
public class a {
    ...
    private static final boolean f127155a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    static final /* synthetic */ boolean f127156b = false;
    ...
    private static void b(@dl.d byte[] bArr, int i10) {
        if (bArr == null) {
            a(4);
        }
    ...
    @dl.d
    private static byte[] c(@dl.d String[] strArr) {
        if (strArr == null) {
            a(11);
        }
        int length = 0;
    ...
    @dl.d
    private static byte[] d(@dl.d byte[] bArr) {
        if (bArr == null) {
            a(13);
        }
    ...
    @dl.d
    public static byte[] e(@dl.d String[] strArr) {
        if (strArr == null) {
            a(7);
        }
    ...
    @dl.d
    private static String[] f(@dl.d String[] strArr) {
        if (strArr == null) {
            a(9);
        }
