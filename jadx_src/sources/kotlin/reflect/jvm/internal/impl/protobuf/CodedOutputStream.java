...
public final class CodedOutputStream {
    ...
    private final byte[] f127281a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private final int f127282b;

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    private final OutputStream f127285e;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private int f127284d = 0;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private int f127283c = 0;
    ...
    private CodedOutputStream(OutputStream outputStream, byte[] bArr) {
        this.f127285e = outputStream;
        this.f127281a = bArr;
        this.f127282b = bArr.length;
    }
    ...
    private void K() throws IOException {
        OutputStream outputStream = this.f127285e;
        if (outputStream == null) {
            throw new OutOfSpaceException();
        }
        outputStream.write(this.f127281a, 0, this.f127283c);
        this.f127283c = 0;
    }
    ...
    public void g0(byte b10) throws IOException {
        if (this.f127283c == this.f127282b) {
            K();
        }
        byte[] bArr = this.f127281a;
        int i10 = this.f127283c;
        this.f127283c = i10 + 1;
        bArr[i10] = b10;
        this.f127284d++;
    }
    ...
    public void j0(d dVar, int i10, int i11) throws IOException {
        int i12 = this.f127282b;
        int i13 = this.f127283c;
        if (i12 - i13 >= i11) {
            dVar.j(this.f127281a, i10, i13, i11);
            this.f127283c += i11;
            this.f127284d += i11;
            return;
        }
        int i14 = i12 - i13;
        dVar.j(this.f127281a, i10, i13, i14);
        int i15 = i10 + i14;
        int i16 = i11 - i14;
        this.f127283c = this.f127282b;
        this.f127284d += i14;
        K();
        if (i16 <= this.f127282b) {
            dVar.j(this.f127281a, i15, 0, i16);
            this.f127283c = i16;
        } else {
            dVar.D(this.f127285e, i15, i16);
        }
        this.f127284d += i16;
    }
    ...
    public void l0(byte[] bArr, int i10, int i11) throws IOException {
        ...
        int i13 = this.f127283c;
        if (i12 - i13 >= i11) {
            System.arraycopy(bArr, i10, this.f127281a, i13, i11);
            this.f127283c += i11;
            this.f127284d += i11;
            return;
        }
        int i14 = i12 - i13;
        System.arraycopy(bArr, i10, this.f127281a, i13, i14);
        int i15 = i10 + i14;
        int i16 = i11 - i14;
        this.f127283c = this.f127282b;
        this.f127284d += i14;
        K();
        if (i16 <= this.f127282b) {
            System.arraycopy(bArr, i15, this.f127281a, 0, i16);
            this.f127283c = i16;
        } else {
            this.f127285e.write(bArr, i15, i16);
        }
        this.f127284d += i16;
    }
