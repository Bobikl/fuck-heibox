...
public class DefaultItemAnimator extends SimpleItemAnimator {
    ...
    public boolean canReuseUpdatedViewHolder(@n0 RecyclerView.ViewHolder viewHolder, @n0 List<Object> list) {
    ...
    public void runPendingAnimations() {
        ...
        if (z10 || z11 || z13 || z12) {
            ...
            if (z11) {
                ...
                if (z10) {
                    j1.q1(arrayList.get(0).holder.itemView, runnable, getRemoveDuration());
                } else {
                    runnable.run();
                }
            }
            if (z12) {
                ...
                if (z10) {
                    j1.q1(arrayList2.get(0).oldHolder.itemView, runnable2, getRemoveDuration());
                } else {
                    runnable2.run();
                }
            }
            if (z13) {
                ...
                if (z10 || z11 || z12) {
                    j1.q1(arrayList3.get(0).itemView, runnable3, (z10 ? getRemoveDuration() : 0L) + Math.max(z11 ? getMoveDuration() : 0L, z12 ? getChangeDuration() : 0L));
                } else {
                    runnable3.run();
                }
            }
