...
public abstract class SnapHelper extends RecyclerView.OnFlingListener {
    ...
    private boolean snapFromFling(@n0 RecyclerView.LayoutManager layoutManager, int i10, int i11) {
    ...
    @p0
    public abstract int[] calculateDistanceToFinalSnap(@n0 RecyclerView.LayoutManager layoutManager, @n0 View view);
    ...
    @p0
    @Deprecated
    protected LinearSmoothScroller createSnapScroller(@n0 RecyclerView.LayoutManager layoutManager) {
