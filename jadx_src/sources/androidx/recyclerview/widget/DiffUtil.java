...
public class DiffUtil {
    private static final Comparator<Diagonal> DIAGONAL_COMPARATOR = new Comparator<Diagonal>() { // from class: androidx.recyclerview.widget.DiffUtil.1
        ...
        public int compare(Diagonal diagonal, Diagonal diagonal2) {
            return diagonal.f26848x - diagonal2.f26848x;
        }
    };
    ...
    public static class Diagonal {
        ...
        public final int f26848x;

        /* JADX INFO: renamed from: y, reason: collision with root package name */
        public final int f26849y;
        ...
        int endX() {
            return this.f26848x + this.size;
        }

        int endY() {
            return this.f26849y + this.size;
        }
    }
    ...
    public static class DiffResult {
        ...
        private void addEdgeDiagonals() {
            ...
            if (diagonal == null || diagonal.f26848x != 0 || diagonal.f26849y != 0) {
        ...
        private void findMatchingItems() {
            for (Diagonal diagonal : this.mDiagonals) {
                for (int i10 = 0; i10 < diagonal.size; i10++) {
                    int i11 = diagonal.f26848x + i10;
                    int i12 = diagonal.f26849y + i10;
        ...
        public int convertNewPositionToOld(@f0(from = 0) int i10) {
        ...
        public int convertOldPositionToNew(@f0(from = 0) int i10) {
        ...
        public void dispatchUpdatesTo(@n0 ListUpdateCallback listUpdateCallback) {
            int i10;
            ...
            for (int size = this.mDiagonals.size() - 1; size >= 0; size--) {
                ...
                int i19 = diagonal.f26848x;
                int i20 = diagonal.f26849y;
                ...
                i12 = diagonal.f26848x;
                i13 = diagonal.f26849y;
            }
            batchingListUpdateCallback.dispatchLastEvent();
        }

        public void dispatchUpdatesTo(@n0 RecyclerView.Adapter adapter) {
    ...
    @n0
    public static DiffResult calculateDiff(@n0 Callback callback) {
        return calculateDiff(callback, true);
    }

    @n0
    public static DiffResult calculateDiff(@n0 Callback callback, boolean z10) {
