...
public class RecyclerView extends ViewGroup implements f1, r0, s0 {
    ...
    private u0 mScrollingChildHelper;
    final State mState;
    ...
    public static abstract class Adapter<VH extends ViewHolder> {
        ...
        public final void bindViewHolder(@n0 VH vh2, int i10) {
            ...
            if (z10) {
                ...
                vh2.setFlags(1, c.b.Z6);
                e0.b(RecyclerView.TRACE_BIND_VIEW_TAG);
            }
        ...
        public final VH createViewHolder(@n0 ViewGroup viewGroup, int i10) {
            try {
                e0.b(RecyclerView.TRACE_CREATE_VIEW_TAG);
        ...
        public int findRelativeAdapterPositionIn(@n0 Adapter<? extends ViewHolder> adapter, @n0 ViewHolder viewHolder, int i10) {
            if (adapter == this) {
                return i10;
            }
            return -1;
        ...
        public void registerAdapterDataObserver(@n0 AdapterDataObserver adapterDataObserver) {
        ...
        public void setStateRestorationPolicy(@n0 StateRestorationPolicy stateRestorationPolicy) {
            this.mStateRestorationPolicy = stateRestorationPolicy;
            this.mObservable.notifyStateRestorationPolicyChanged();
        }

        public void unregisterAdapterDataObserver(@n0 AdapterDataObserver adapterDataObserver) {
    ...
    public static class AdapterDataObservable extends Observable<AdapterDataObserver> {
        ...
        public void notifyItemRangeChanged(int i10, int i11, @p0 Object obj) {
            for (int size = ((Observable) this).mObservers.size() - 1; size >= 0; size--) {
    ...
    public static class EdgeEffectFactory {
        ...
        @n0
        protected EdgeEffect createEdgeEffect(@n0 RecyclerView recyclerView, int i10) {
    ...
    public static abstract class ItemAnimator {
        ...
        public interface ItemAnimatorListener {
            void onAnimationFinished(@n0 ViewHolder viewHolder);
        }
        ...
        public static class ItemHolderInfo {
            ...
            @n0
            public ItemHolderInfo setFrom(@n0 ViewHolder viewHolder) {
                return setFrom(viewHolder, 0);
            }

            @n0
            public ItemHolderInfo setFrom(@n0 ViewHolder viewHolder, int i10) {
        ...
        public abstract boolean animateAppearance(@n0 ViewHolder viewHolder, @p0 ItemHolderInfo itemHolderInfo, @n0 ItemHolderInfo itemHolderInfo2);

        public abstract boolean animateChange(@n0 ViewHolder viewHolder, @n0 ViewHolder viewHolder2, @n0 ItemHolderInfo itemHolderInfo, @n0 ItemHolderInfo itemHolderInfo2);

        public abstract boolean animateDisappearance(@n0 ViewHolder viewHolder, @n0 ItemHolderInfo itemHolderInfo, @p0 ItemHolderInfo itemHolderInfo2);

        public abstract boolean animatePersistence(@n0 ViewHolder viewHolder, @n0 ItemHolderInfo itemHolderInfo, @n0 ItemHolderInfo itemHolderInfo2);

        public boolean canReuseUpdatedViewHolder(@n0 ViewHolder viewHolder) {
            return true;
        }

        public boolean canReuseUpdatedViewHolder(@n0 ViewHolder viewHolder, @n0 List<Object> list) {
            return canReuseUpdatedViewHolder(viewHolder);
        }

        public final void dispatchAnimationFinished(@n0 ViewHolder viewHolder) {
        ...
        public final void dispatchAnimationStarted(@n0 ViewHolder viewHolder) {
        ...
        public abstract void endAnimation(@n0 ViewHolder viewHolder);
        ...
        public final boolean isRunning(@p0 ItemAnimatorFinishedListener itemAnimatorFinishedListener) {
        ...
        public void onAnimationFinished(@n0 ViewHolder viewHolder) {
        }

        public void onAnimationStarted(@n0 ViewHolder viewHolder) {
        }

        @n0
        public ItemHolderInfo recordPostLayoutInformation(@n0 State state, @n0 ViewHolder viewHolder) {
            return obtainHolderInfo().setFrom(viewHolder);
        }

        @n0
        public ItemHolderInfo recordPreLayoutInformation(@n0 State state, @n0 ViewHolder viewHolder, int i10, @n0 List<Object> list) {
            return obtainHolderInfo().setFrom(viewHolder);
        }
    ...
    public static abstract class ItemDecoration {
        ...
        public void getItemOffsets(@n0 Rect rect, @n0 View view, @n0 RecyclerView recyclerView, @n0 State state) {
        ...
        public void onDraw(@n0 Canvas canvas, @n0 RecyclerView recyclerView, @n0 State state) {
        ...
        public void onDrawOver(@n0 Canvas canvas, @n0 RecyclerView recyclerView, @n0 State state) {
    ...
    public static abstract class LayoutManager {
        ...
        private void detachViewInternal(int i10, @n0 View view) {
  ...
  0x0011: PHI (r3v3 int) = (r3v0 int), (r3v2 int), (r3v0 int) binds: [B:7:0x000f, B:11:0x0016, B:4:0x000a] A[DONT_GENERATE, DONT_INLINE]] */
        ...
        public static Properties getProperties(@n0 Context context, @p0 AttributeSet attributeSet, int i10, int i11) {
            Properties properties = new Properties();
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, androidx.recyclerview.R.styleable.f26847f, i10, i11);
        ...
        public int computeHorizontalScrollExtent(@n0 State state) {
            return 0;
        }

        public int computeHorizontalScrollOffset(@n0 State state) {
            return 0;
        }

        public int computeHorizontalScrollRange(@n0 State state) {
            return 0;
        }

        public int computeVerticalScrollExtent(@n0 State state) {
            return 0;
        }

        public int computeVerticalScrollOffset(@n0 State state) {
            return 0;
        }

        public int computeVerticalScrollRange(@n0 State state) {
            return 0;
        }

        public void detachAndScrapAttachedViews(@n0 Recycler recycler) {
            for (int childCount = getChildCount() - 1; childCount >= 0; childCount--) {
                scrapOrRecycleView(recycler, childCount, getChildAt(childCount));
            }
        }

        public void detachAndScrapView(@n0 View view, @n0 Recycler recycler) {
            scrapOrRecycleView(recycler, this.mChildHelper.indexOfChild(view), view);
        }

        public void detachAndScrapViewAt(int i10, @n0 Recycler recycler) {
        ...
        public int getColumnCountForAccessibility(@n0 Recycler recycler, @n0 State state) {
            return -1;
        }
        ...
        public int getLayoutDirection() {
            return androidx.core.view.j1.Z(this.mRecyclerView);
        }
        ...
        public int getMinimumHeight() {
            return androidx.core.view.j1.e0(this.mRecyclerView);
        }

        @t0
        public int getMinimumWidth() {
            return androidx.core.view.j1.f0(this.mRecyclerView);
        }
        ...
        public int getPaddingEnd() {
            RecyclerView recyclerView = this.mRecyclerView;
            if (recyclerView != null) {
                return androidx.core.view.j1.j0(recyclerView);
            }
            return 0;
        }
        ...
        public int getPaddingStart() {
            RecyclerView recyclerView = this.mRecyclerView;
            if (recyclerView != null) {
                return androidx.core.view.j1.k0(recyclerView);
            }
            return 0;
        }
        ...
        public int getRowCountForAccessibility(@n0 Recycler recycler, @n0 State state) {
            return -1;
        }

        public int getSelectionModeForAccessibility(@n0 Recycler recycler, @n0 State state) {
            return 0;
        }
        ...
        public boolean isLayoutHierarchical(@n0 Recycler recycler, @n0 State state) {
            return false;
        }
        ...
        public boolean isViewPartiallyVisible(@n0 View view, boolean z10, boolean z11) {
            boolean z12 = this.mHorizontalBoundCheck.isViewWithinBoundFlags(view, SocializeConstants.AUTH_EVENT) && this.mVerticalBoundCheck.isViewWithinBoundFlags(view, SocializeConstants.AUTH_EVENT);
            return z10 ? z12 : !z12;
        }
        ...
        @p0
        public View onFocusSearchFailed(@n0 View view, int i10, @n0 Recycler recycler, @n0 State state) {
            return null;
        }
        ...
        public void onInitializeAccessibilityEvent(@n0 Recycler recycler, @n0 State state, @n0 AccessibilityEvent accessibilityEvent) {
            RecyclerView recyclerView = this.mRecyclerView;
        ...
        void onInitializeAccessibilityNodeInfo(a0 a0Var) {
            RecyclerView recyclerView = this.mRecyclerView;
            onInitializeAccessibilityNodeInfo(recyclerView.mRecycler, recyclerView.mState, a0Var);
        }

        public void onInitializeAccessibilityNodeInfo(@n0 Recycler recycler, @n0 State state, @n0 a0 a0Var) {
            ...
            a0Var.d1(a0.d.f(getRowCountForAccessibility(recycler, state), getColumnCountForAccessibility(recycler, state), isLayoutHierarchical(recycler, state), getSelectionModeForAccessibility(recycler, state)));
        }

        void onInitializeAccessibilityNodeInfoForItem(View view, a0 a0Var) {
            ViewHolder childViewHolderInt = RecyclerView.getChildViewHolderInt(view);
            if (childViewHolderInt == null || childViewHolderInt.isRemoved() || this.mChildHelper.isHidden(childViewHolderInt.itemView)) {
                return;
            }
            RecyclerView recyclerView = this.mRecyclerView;
            onInitializeAccessibilityNodeInfoForItem(recyclerView.mRecycler, recyclerView.mState, view, a0Var);
        }

        public void onInitializeAccessibilityNodeInfoForItem(@n0 Recycler recycler, @n0 State state, @n0 View view, @n0 a0 a0Var) {
        }
        ...
        public void onMeasure(@n0 Recycler recycler, @n0 State state, int i10, int i11) {
        ...
        public boolean onRequestChildFocus(@n0 RecyclerView recyclerView, @n0 State state, @n0 View view, @p0 View view2) {
        ...
        boolean performAccessibilityAction(int i10, @p0 Bundle bundle) {
            RecyclerView recyclerView = this.mRecyclerView;
  ...
  0x0071: PHI (r8v8 int) = (r8v4 int), (r8v12 int) binds: [B:22:0x005e, B:15:0x0030] A[DONT_GENERATE, DONT_INLINE]] */
        public boolean performAccessibilityAction(@n0 Recycler recycler, @n0 State state, int i10, @p0 Bundle bundle) {
            int height;
            int width;
            int i11;
            int i12;
        ...
        boolean performAccessibilityActionForItem(@n0 View view, int i10, @p0 Bundle bundle) {
            RecyclerView recyclerView = this.mRecyclerView;
            return performAccessibilityActionForItem(recyclerView.mRecycler, recyclerView.mState, view, i10, bundle);
        }

        public boolean performAccessibilityActionForItem(@n0 Recycler recycler, @n0 State state, @n0 View view, int i10, @p0 Bundle bundle) {
            return false;
        }
        ...
        public void postOnAnimation(Runnable runnable) {
            RecyclerView recyclerView = this.mRecyclerView;
            if (recyclerView != null) {
                androidx.core.view.j1.p1(recyclerView, runnable);
            }
        }
        ...
        public void removeAndRecycleAllViews(@n0 Recycler recycler) {
            for (int childCount = getChildCount() - 1; childCount >= 0; childCount--) {
        ...
        public void removeAndRecycleView(@n0 View view, @n0 Recycler recycler) {
            removeView(view);
            recycler.recycleView(view);
        }

        public void removeAndRecycleViewAt(int i10, @n0 Recycler recycler) {
            View childAt = getChildAt(i10);
            removeViewAt(i10);
    ...
    public interface OnChildAttachStateChangeListener {
        void onChildViewAttachedToWindow(@n0 View view);

        void onChildViewDetachedFromWindow(@n0 View view);
    }
    ...
    public final class Recycler {
        ...
        private void attachAccessibilityDelegateOnBind(ViewHolder viewHolder) {
            if (RecyclerView.this.isAccessibilityEnabled()) {
                View view = viewHolder.itemView;
                if (androidx.core.view.j1.V(view) == 0) {
                ...
                androidx.core.view.j1.B1(view, itemDelegate);
            }
        }
        ...
        private boolean tryBindViewHolderByDeadline(@n0 ViewHolder viewHolder, int i10, int i11, long j10) {
        ...
        void addViewHolderToRecycledViewPool(@n0 ViewHolder viewHolder, boolean z10) {
            RecyclerView.clearNestedRecyclerViewIfNotNested(viewHolder);
            View view = viewHolder.itemView;
            RecyclerViewAccessibilityDelegate recyclerViewAccessibilityDelegate = RecyclerView.this.mAccessibilityDelegate;
            if (recyclerViewAccessibilityDelegate != null) {
                a itemDelegate = recyclerViewAccessibilityDelegate.getItemDelegate();
                androidx.core.view.j1.B1(view, itemDelegate instanceof RecyclerViewAccessibilityDelegate.ItemDelegate ? ((RecyclerViewAccessibilityDelegate.ItemDelegate) itemDelegate).getAndRemoveOriginalDelegateForItem(view) : null);
            }
            if (z10) {
        ...
        public void bindViewToPosition(@n0 View view, int i10) {
        ...
        void dispatchViewRecycled(@n0 ViewHolder viewHolder) {
        ...
        ViewHolder getScrapOrHiddenOrCachedHolderForPosition(int i10, boolean z10) {
            ...
            if (iIndexOfChild != -1) {
                ...
                childViewHolderInt.addFlags(c.k.f33727n6);
        ...
        public void recycleView(@n0 View view) {
            ViewHolder childViewHolderInt = RecyclerView.getChildViewHolderInt(view);
            if (childViewHolderInt.isTmpDetached()) {
        ...
        void recycleViewHolderInternal(ViewHolder viewHolder) {
            ...
            if ((adapter != null && zDoesTransientStatePreventRecycling && adapter.onFailedToRecycleView(viewHolder)) || viewHolder.isRecyclable()) {
                if (this.mViewCacheMax <= 0 || viewHolder.hasAnyOfTheFlags(c.b.f30651g7)) {
                    z10 = false;
                } else {
                    int size = this.mCachedViews.size();
        ...
        /* JADX WARN: Code duplicated, block: B:106:0x0228 A[ADDED_TO_REGION] */
 ...
 binds: [B:28:0x005d, B:59:0x0102] A[DONT_GENERATE, DONT_INLINE]
  0x0181: PHI (r4v3 boolean) = (r4v2 boolean), (r4v7 boolean) binds: [B:28:0x005d, B:59:0x0102] A[DONT_GENERATE, DONT_INLINE]] */
        ...
        @p0
        ViewHolder tryGetViewHolderForPositionByDeadline(int i10, boolean z10, long j10) {
    ...
    public interface RecyclerListener {
        void onViewRecycled(@n0 ViewHolder viewHolder);
    }
        ...
        void triggerUpdateProcessor() {
            if (RecyclerView.POST_UPDATES_ON_ANIMATION) {
                ...
                if (recyclerView.mHasFixedSize && recyclerView.mIsAttached) {
                    androidx.core.view.j1.p1(recyclerView, recyclerView.mUpdateChildViewsRunnable);
                    return;
                }
            }
            RecyclerView recyclerView2 = RecyclerView.this;
    ...
    public static abstract class SmoothScroller {
        ...
        public static class Action {
            ...
            public Action(@t0 int i10, @t0 int i11) {
                this(i10, i11, Integer.MIN_VALUE, null);
            }

            public Action(@t0 int i10, @t0 int i11, int i12) {
                this(i10, i11, i12, null);
            }

            public Action(@t0 int i10, @t0 int i11, int i12, @p0 Interpolator interpolator) {
            ...
            public void setDx(@t0 int i10) {
                this.mChanged = true;
                this.mDx = i10;
            }

            public void setDy(@t0 int i10) {
                this.mChanged = true;
                this.mDy = i10;
            }

            public void setInterpolator(@p0 Interpolator interpolator) {
                this.mChanged = true;
                this.mInterpolator = interpolator;
            }

            public void update(@t0 int i10, @t0 int i11, int i12, @p0 Interpolator interpolator) {
                this.mDx = i10;
                this.mDy = i11;
                this.mDuration = i12;
                this.mInterpolator = interpolator;
        ...
        protected void normalize(@n0 PointF pointF) {
            float f10 = pointF.x;
            float f11 = pointF.y;
        ...
        protected abstract void onSeekTargetStep(@t0 int i10, @t0 int i11, @n0 State state, @n0 Action action);

        protected abstract void onStart();

        protected abstract void onStop();

        protected abstract void onTargetFound(@n0 View view, @n0 State state, @n0 Action action);
    ...
    public static abstract class ViewCacheExtension {
        @p0
        public abstract View getViewForPositionAndType(@n0 Recycler recycler, int i10, int i11);
    }
    ...
    public class ViewFlinger implements Runnable {
        ...
        private void internalPostOnAnimation() {
            ...
            androidx.core.view.j1.p1(RecyclerView.this, this);
        }
        ...
        public void smoothScrollBy(int i10, int i11, int i12, @p0 Interpolator interpolator) {
    ...
    public static abstract class ViewHolder {
        ...
        boolean doesTransientStatePreventRecycling() {
            return (this.mFlags & 16) == 0 && androidx.core.view.j1.M0(this.itemView);
        }
        ...
        void onEnteredHiddenState(RecyclerView recyclerView) {
            ...
            if (i10 != -1) {
                ...
                this.mWasImportantForAccessibilityBeforeHidden = androidx.core.view.j1.V(this.itemView);
            }
    ...
    public RecyclerView(@n0 Context context, @p0 AttributeSet attributeSet, int i10) {
        ...
        this.mViewInfoProcessCallback = new ViewInfoStore.ProcessCallback() { // from class: androidx.recyclerview.widget.RecyclerView.4
            ...
            @Override // androidx.recyclerview.widget.ViewInfoStore.ProcessCallback
            public void processDisappeared(ViewHolder viewHolder, @n0 ItemAnimator.ItemHolderInfo itemHolderInfo, @p0 ItemAnimator.ItemHolderInfo itemHolderInfo2) {
                RecyclerView.this.mRecycler.unscrapView(viewHolder);
                RecyclerView.this.animateDisappearance(viewHolder, itemHolderInfo, itemHolderInfo2);
            }

            @Override // androidx.recyclerview.widget.ViewInfoStore.ProcessCallback
            public void processPersistent(ViewHolder viewHolder, @n0 ItemAnimator.ItemHolderInfo itemHolderInfo, @n0 ItemAnimator.ItemHolderInfo itemHolderInfo2) {
        ...
        this.mScaledHorizontalScrollFactor = v2.b(viewConfiguration, context);
        this.mScaledVerticalScrollFactor = v2.e(viewConfiguration, context);
        ...
        initChildrenHelper();
        initAutofill();
        if (androidx.core.view.j1.V(this) == 0) {
            androidx.core.view.j1.R1(this, 1);
        }
        this.mAccessibilityManager = (AccessibilityManager) getContext().getSystemService("accessibility");
        setAccessibilityDelegateCompat(new RecyclerViewAccessibilityDelegate(this));
        int[] iArr = androidx.recyclerview.R.styleable.f26847f;
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, iArr, i10, 0);
        androidx.core.view.j1.z1(this, context, iArr, attributeSet, typedArrayObtainStyledAttributes, i10, 0);
        ...
        androidx.core.view.j1.z1(this, context, iArr2, attributeSet, typedArrayObtainStyledAttributes2, i10, 0);
    ...
    private void animateChange(@n0 ViewHolder viewHolder, @n0 ViewHolder viewHolder2, @n0 ItemAnimator.ItemHolderInfo itemHolderInfo, @n0 ItemAnimator.ItemHolderInfo itemHolderInfo2, boolean z10, boolean z11) {
        viewHolder.setIsRecyclable(false);
        if (z10) {
    ...
    static void clearNestedRecyclerViewIfNotNested(@n0 ViewHolder viewHolder) {
    ...
    private void dispatchContentChangedIfNecessary() {
        ...
        b.i(accessibilityEventObtain, i10);
    ...
    @p0
    static RecyclerView findNestedRecyclerView(@n0 View view) {
        if (!(view instanceof ViewGroup)) {
            return null;
        }
    ...
    private String getFullClassName(Context context, String str) {
        ...
        return RecyclerView.class.getPackage().getName() + lg.a.f131414g + str;
    }
    ...
    private void initAutofill() {
        if (androidx.core.view.j1.W(this) == 0) {
            androidx.core.view.j1.S1(this, 8);
        }
    }
    ...
    private void nestedScrollByInternal(int i10, int i11, @p0 MotionEvent motionEvent, int i12) {
        LayoutManager layoutManager = this.mLayout;
    ...
    private void pullGlows(float f10, float f11, float f12, float f13) {
        ...
        if (f11 >= 0.0f) {
            if (f11 > 0.0f) {
                ensureRightGlow();
                androidx.core.widget.i.g(this.mRightGlow, f11 / getWidth(), f12 / getHeight());
            } else {
                z10 = false;
            }
            if (f13 < 0.0f) {
                ensureTopGlow();
                androidx.core.widget.i.g(this.mTopGlow, (-f13) / getHeight(), f10 / getWidth());
            } else if (f13 > 0.0f) {
                ensureBottomGlow();
                androidx.core.widget.i.g(this.mBottomGlow, f13 / getHeight(), 1.0f - (f10 / getWidth()));
            } else {
                z11 = z10;
            }
        ...
        ensureLeftGlow();
        androidx.core.widget.i.g(this.mLeftGlow, (-f11) / getWidth(), 1.0f - (f12 / getHeight()));
        z10 = true;
        if (f13 < 0.0f) {
            ensureTopGlow();
            androidx.core.widget.i.g(this.mTopGlow, (-f13) / getHeight(), f10 / getWidth());
    ...
    private void requestChildOnScreen(@n0 View view, @p0 View view2) {
    ...
    private void setAdapterInternal(@p0 Adapter adapter, boolean z10, boolean z11) {
    ...
    public void addItemDecoration(@n0 ItemDecoration itemDecoration) {
        addItemDecoration(itemDecoration, -1);
    }

    public void addItemDecoration(@n0 ItemDecoration itemDecoration, int i10) {
        LayoutManager layoutManager = this.mLayout;
        if (layoutManager != null) {
    ...
    public void addOnChildAttachStateChangeListener(@n0 OnChildAttachStateChangeListener onChildAttachStateChangeListener) {
    ...
    public void addOnItemTouchListener(@n0 OnItemTouchListener onItemTouchListener) {
        this.mOnItemTouchListeners.add(onItemTouchListener);
    }

    public void addOnScrollListener(@n0 OnScrollListener onScrollListener) {
    ...
    public void addRecyclerListener(@n0 RecyclerListener recyclerListener) {
        o.b(recyclerListener != null, "'listener' arg cannot be null.");
        this.mRecyclerListeners.add(recyclerListener);
    }

    void animateAppearance(@n0 ViewHolder viewHolder, @p0 ItemAnimator.ItemHolderInfo itemHolderInfo, @n0 ItemAnimator.ItemHolderInfo itemHolderInfo2) {
        viewHolder.setIsRecyclable(false);
    ...
    void animateDisappearance(@n0 ViewHolder viewHolder, @n0 ItemAnimator.ItemHolderInfo itemHolderInfo, @p0 ItemAnimator.ItemHolderInfo itemHolderInfo2) {
        addAnimatingView(viewHolder);
        viewHolder.setIsRecyclable(false);
    ...
    void consumePendingUpdateOperations() {
        if (!this.mFirstLayoutComplete || this.mDataSetHasChangedAfterLayout) {
            e0.b(TRACE_ON_DATA_SET_CHANGE_LAYOUT_TAG);
            dispatchLayout();
            e0.d();
            return;
        }
        if (this.mAdapterHelper.hasPendingUpdates()) {
            ...
            e0.b(TRACE_HANDLE_ADAPTER_UPDATES_TAG);
            startInterceptRequestLayout();
            onEnterLayoutOrScroll();
            this.mAdapterHelper.preProcess();
    ...
    void defaultOnMeasure(int i10, int i11) {
        setMeasuredDimension(LayoutManager.chooseSize(i10, getPaddingLeft() + getPaddingRight(), androidx.core.view.j1.f0(this)), LayoutManager.chooseSize(i11, getPaddingTop() + getPaddingBottom(), androidx.core.view.j1.e0(this)));
    }
    ...
    void dispatchPendingImportantForAccessibilityChanges() {
        ...
        for (int size = this.mPendingAccessibilityImportanceChange.size() - 1; size >= 0; size--) {
            ...
            if (viewHolder.itemView.getParent() == this && !viewHolder.shouldIgnore() && (i10 = viewHolder.mPendingAccessibilityState) != -1) {
                androidx.core.view.j1.R1(viewHolder.itemView, i10);
    ...
    @p0
    public ViewHolder findContainingViewHolder(@n0 View view) {
    ...
    int getAdapterPositionInRecyclerView(ViewHolder viewHolder) {
        if (viewHolder.hasAnyOfTheFlags(c.b.f30605e7) || !viewHolder.isBound()) {
            return -1;
        }
    ...
    public ViewHolder getChildViewHolder(@n0 View view) {
        ViewParent parent = view.getParent();
    ...
    protected void onAttachedToWindow() {
        ...
        if (ALLOW_THREAD_GAP_WORK) {
            ...
            if (gapWorker == null) {
                ...
                Display displayQ = androidx.core.view.j1.Q(this);
                float f10 = 60.0f;
  ...
  0x00df: PHI (r0v36 int) = (r0v26 int), (r0v40 int) binds: [B:41:0x00c8, B:45:0x00db] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            ...
            if (this.mScrollState == 1) {
                ...
                if (scrollByInternal(zCanScrollHorizontally ? i11 : 0, zCanScrollVertically ? i14 : 0, motionEvent, 0)) {
                    getParent().requestDisallowInterceptTouchEvent(true);
                }
                GapWorker gapWorker = this.mGapWorker;
    ...
    void postAnimationRunner() {
        ...
        androidx.core.view.j1.p1(this, this.mItemAnimatorRunner);
    ...
    public void removeItemDecoration(@n0 ItemDecoration itemDecoration) {
        LayoutManager layoutManager = this.mLayout;
        if (layoutManager != null) {
    ...
    public void removeOnChildAttachStateChangeListener(@n0 OnChildAttachStateChangeListener onChildAttachStateChangeListener) {
        List<OnChildAttachStateChangeListener> list = this.mOnChildAttachStateListeners;
        if (list == null) {
            return;
        }
    ...
    public void removeOnItemTouchListener(@n0 OnItemTouchListener onItemTouchListener) {
    ...
    public void removeOnScrollListener(@n0 OnScrollListener onScrollListener) {
        List<OnScrollListener> list = this.mScrollListeners;
        if (list != null) {
    ...
    public void removeRecyclerListener(@n0 RecyclerListener recyclerListener) {
    ...
    boolean scrollByInternal(int i10, int i11, MotionEvent motionEvent, int i12) {
        ...
        if (getOverScrollMode() != 2) {
            if (motionEvent != null && !q0.l(motionEvent, 8194)) {
    ...
    void scrollStep(int i10, int i11, @p0 int[] iArr) {
        startInterceptRequestLayout();
        onEnterLayoutOrScroll();
        e0.b(TRACE_SCROLL_TAG);
        fillRemainingScrollValues(this.mState);
    ...
    public void setAccessibilityDelegateCompat(@p0 RecyclerViewAccessibilityDelegate recyclerViewAccessibilityDelegate) {
        this.mAccessibilityDelegate = recyclerViewAccessibilityDelegate;
        androidx.core.view.j1.B1(this, recyclerViewAccessibilityDelegate);
    }
    ...
    public void setChildDrawingOrderCallback(@p0 ChildDrawingOrderCallback childDrawingOrderCallback) {
    ...
    public void setEdgeEffectFactory(@n0 EdgeEffectFactory edgeEffectFactory) {
        o.l(edgeEffectFactory);
    ...
    public void setItemAnimator(@p0 ItemAnimator itemAnimator) {
    ...
    public void setLayoutManager(@p0 LayoutManager layoutManager) {
    ...
    public void setOnFlingListener(@p0 OnFlingListener onFlingListener) {
        this.mOnFlingListener = onFlingListener;
    }

    @Deprecated
    public void setOnScrollListener(@p0 OnScrollListener onScrollListener) {
    ...
    public void setRecycledViewPool(@p0 RecycledViewPool recycledViewPool) {
        this.mRecycler.setRecycledViewPool(recycledViewPool);
    }

    @Deprecated
    public void setRecyclerListener(@p0 RecyclerListener recyclerListener) {
    ...
    public void setViewCacheExtension(@p0 ViewCacheExtension viewCacheExtension) {
    ...
    boolean shouldDeferAccessibilityEvent(AccessibilityEvent accessibilityEvent) {
        ...
        int iD = accessibilityEvent != null ? b.d(accessibilityEvent) : 0;
    ...
    void smoothScrollBy(@t0 int i10, @t0 int i11, @p0 Interpolator interpolator, int i12, boolean z10) {
        LayoutManager layoutManager = this.mLayout;
        if (layoutManager == null) {
