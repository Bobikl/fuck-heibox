...
public class ConcatAdapterController implements NestedAdapterWrapper.Callback {
    ...
    boolean addAdapter(int i10, RecyclerView.Adapter<RecyclerView.ViewHolder> adapter) {
        ...
        if (hasStableIds()) {
            o.b(adapter.hasStableIds(), "All sub adapters must have stable ids when stable id mode is ISOLATED_STABLE_IDS or SHARED_STABLE_IDS");
    ...
    public void onChanged(@n0 NestedAdapterWrapper nestedAdapterWrapper) {
    ...
    @Override // androidx.recyclerview.widget.NestedAdapterWrapper.Callback
    public void onItemRangeChanged(@n0 NestedAdapterWrapper nestedAdapterWrapper, int i10, int i11) {
        this.mConcatAdapter.notifyItemRangeChanged(i10 + countItemsBefore(nestedAdapterWrapper), i11);
    }

    @Override // androidx.recyclerview.widget.NestedAdapterWrapper.Callback
    public void onItemRangeChanged(@n0 NestedAdapterWrapper nestedAdapterWrapper, int i10, int i11, @p0 Object obj) {
        this.mConcatAdapter.notifyItemRangeChanged(i10 + countItemsBefore(nestedAdapterWrapper), i11, obj);
    }

    @Override // androidx.recyclerview.widget.NestedAdapterWrapper.Callback
    public void onItemRangeInserted(@n0 NestedAdapterWrapper nestedAdapterWrapper, int i10, int i11) {
        this.mConcatAdapter.notifyItemRangeInserted(i10 + countItemsBefore(nestedAdapterWrapper), i11);
    }

    @Override // androidx.recyclerview.widget.NestedAdapterWrapper.Callback
    public void onItemRangeMoved(@n0 NestedAdapterWrapper nestedAdapterWrapper, int i10, int i11) {
    ...
    @Override // androidx.recyclerview.widget.NestedAdapterWrapper.Callback
    public void onItemRangeRemoved(@n0 NestedAdapterWrapper nestedAdapterWrapper, int i10, int i11) {
