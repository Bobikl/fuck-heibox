...
public final class AndroidPopup_androidKt$SimpleStack$1 implements i0 {
    ...
    public static final AndroidPopup_androidKt$SimpleStack$1 f17161a = new AndroidPopup_androidKt$SimpleStack$1();
    ...
    public final j0 a(@dl.d l0 Layout, @dl.d List<? extends g0> measurables, long j10) {
        ...
        if (size == 0) {
            return k0.p(Layout, 0, 0, null, new l<e1.a, b2>() { // from class: androidx.compose.ui.window.AndroidPopup_androidKt$SimpleStack$1$measure$1
        ...
        if (size == 1) {
            ...
            return k0.p(Layout, e1VarZ1.getWidth(), e1VarZ1.getHeight(), null, new l<e1.a, b2>() { // from class: androidx.compose.ui.window.AndroidPopup_androidKt$SimpleStack$1$measure$2
                {
                    super(1);
                }
        ...
        return k0.p(Layout, i10, i11, null, new l<e1.a, b2>() { // from class: androidx.compose.ui.window.AndroidPopup_androidKt$SimpleStack$1$measure$3
