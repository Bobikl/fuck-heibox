...
public final class MeasuringIntrinsics {
    ...
    /* JADX INFO: compiled from: LayoutModifier.kt */
    @Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0002\b\u0004\b\u0082\u0001\u0018\u00002\b\u0012\u0004\u0012\u00020\u00000\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002j\u0002\b\u0003j\u0002\b\u0004¨\u0006\u0005"}, d2 = {"Landroidx/compose/ui/layout/MeasuringIntrinsics$IntrinsicWidthHeight;", "", "(Ljava/lang/String;I)V", com.google.common.net.c.f58864t1, "Height", "ui_release"}, k = 1, mv = {1, 7, 1}, xi = 48)
    ...
    public static final class a implements g0 {
        ...
        public a(@dl.d m measurable, @dl.d IntrinsicMinMax minMax, @dl.d IntrinsicWidthHeight widthHeight) {
    ...
    public final int a(@dl.d w modifier, @dl.d n instrinsicMeasureScope, @dl.d m intrinsicMeasurable, int w10) {
        ...
        return modifier.k(new o(instrinsicMeasureScope, instrinsicMeasureScope.getLayoutDirection()), new a(intrinsicMeasurable, IntrinsicMinMax.Max, IntrinsicWidthHeight.Height), s1.c.b(0, w10, 0, 0, 13, null)).getHeight();
    }

    public final int b(@dl.d w modifier, @dl.d n instrinsicMeasureScope, @dl.d m intrinsicMeasurable, int h10) {
        kotlin.jvm.internal.f0.p(modifier, "modifier");
        kotlin.jvm.internal.f0.p(instrinsicMeasureScope, "instrinsicMeasureScope");
        kotlin.jvm.internal.f0.p(intrinsicMeasurable, "intrinsicMeasurable");
        return modifier.k(new o(instrinsicMeasureScope, instrinsicMeasureScope.getLayoutDirection()), new a(intrinsicMeasurable, IntrinsicMinMax.Max, IntrinsicWidthHeight.Width), s1.c.b(0, 0, 0, h10, 7, null)).getWidth();
    }

    public final int c(@dl.d w modifier, @dl.d n instrinsicMeasureScope, @dl.d m intrinsicMeasurable, int w10) {
        kotlin.jvm.internal.f0.p(modifier, "modifier");
        kotlin.jvm.internal.f0.p(instrinsicMeasureScope, "instrinsicMeasureScope");
        kotlin.jvm.internal.f0.p(intrinsicMeasurable, "intrinsicMeasurable");
        return modifier.k(new o(instrinsicMeasureScope, instrinsicMeasureScope.getLayoutDirection()), new a(intrinsicMeasurable, IntrinsicMinMax.Min, IntrinsicWidthHeight.Height), s1.c.b(0, w10, 0, 0, 13, null)).getHeight();
    }

    public final int d(@dl.d w modifier, @dl.d n instrinsicMeasureScope, @dl.d m intrinsicMeasurable, int h10) {
        kotlin.jvm.internal.f0.p(modifier, "modifier");
        kotlin.jvm.internal.f0.p(instrinsicMeasureScope, "instrinsicMeasureScope");
        kotlin.jvm.internal.f0.p(intrinsicMeasurable, "intrinsicMeasurable");
        return modifier.k(new o(instrinsicMeasureScope, instrinsicMeasureScope.getLayoutDirection()), new a(intrinsicMeasurable, IntrinsicMinMax.Min, IntrinsicWidthHeight.Width), s1.c.b(0, 0, 0, h10, 7, null)).getWidth();
    }
}
