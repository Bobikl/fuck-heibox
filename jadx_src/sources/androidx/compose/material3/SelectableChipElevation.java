...
public final class SelectableChipElevation {
    ...
    public /* synthetic */ SelectableChipElevation(float f10, float f11, float f12, float f13, float f14, float f15, kotlin.jvm.internal.u uVar) {
    ...
    private final m2<s1.h> e(boolean z10, androidx.compose.foundation.interaction.e eVar, androidx.compose.runtime.p pVar, int i10) {
        ...
        pVar.T(664514136);
        if (ComposerKt.g0()) {
            ComposerKt.w0(664514136, i10, -1, "androidx.compose.material3.SelectableChipElevation.animateElevation (Chip.kt:1658)");
        }
        pVar.T(-492369756);
        Object objU = pVar.U();
        ...
        if (zS || objU2 == companion.a()) {
            objU2 = new SelectableChipElevation$animateElevation$1$1(eVar, snapshotStateList, null);
            pVar.N(objU2);
        }
        pVar.c0();
        ...
        if (z10) {
            pVar.T(-699481375);
            EffectsKt.h(s1.h.d(f11), new SelectableChipElevation$animateElevation$3(animatable, this, f11, dVar, null), pVar, 64);
            pVar.c0();
        } else {
            pVar.T(-699481518);
            EffectsKt.h(s1.h.d(f11), new SelectableChipElevation$animateElevation$2(animatable, f11, null), pVar, 64);
            pVar.c0();
        }
    ...
    public boolean equals(@dl.e Object other) {
        ...
        return s1.h.l(this.defaultElevation, selectableChipElevation.defaultElevation) && s1.h.l(this.pressedElevation, selectableChipElevation.pressedElevation) && s1.h.l(this.focusedElevation, selectableChipElevation.focusedElevation) && s1.h.l(this.hoveredElevation, selectableChipElevation.hoveredElevation) && s1.h.l(this.disabledElevation, selectableChipElevation.disabledElevation);
    }
    ...
    public final m2<s1.h> f(boolean z10, @dl.d androidx.compose.foundation.interaction.e interactionSource, @dl.e androidx.compose.runtime.p pVar, int i10) {
        ...
        pVar.T(-1888175651);
        if (ComposerKt.g0()) {
            ComposerKt.w0(-1888175651, i10, -1, "androidx.compose.material3.SelectableChipElevation.shadowElevation (Chip.kt:1650)");
        }
    ...
    public final m2<s1.h> g(boolean z10, @dl.d androidx.compose.foundation.interaction.e interactionSource, @dl.e androidx.compose.runtime.p pVar, int i10) {
        ...
        pVar.T(-93383461);
        if (ComposerKt.g0()) {
            ComposerKt.w0(-93383461, i10, -1, "androidx.compose.material3.SelectableChipElevation.tonalElevation (Chip.kt:1631)");
        }
        m2<s1.h> m2VarE = e(z10, interactionSource, pVar, (i10 & bb.c.b.f30796me) | (i10 & 14) | (i10 & 112));
        if (ComposerKt.g0()) {
            ComposerKt.v0();
