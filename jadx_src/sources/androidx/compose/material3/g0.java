...
public final class g0 {
    ...
    public /* synthetic */ g0(long j10, long j11, long j12, long j13, kotlin.jvm.internal.u uVar) {
    ...
    public final m2<androidx.compose.ui.graphics.l0> a(boolean z10, @dl.e androidx.compose.runtime.p pVar, int i10) {
        pVar.T(1876083926);
        if (ComposerKt.g0()) {
            ComposerKt.w0(1876083926, i10, -1, "androidx.compose.material3.IconButtonColors.containerColor (IconButton.kt:824)");
        }
    ...
    public final m2<androidx.compose.ui.graphics.l0> b(boolean z10, @dl.e androidx.compose.runtime.p pVar, int i10) {
        pVar.T(613133646);
        if (ComposerKt.g0()) {
            ComposerKt.w0(613133646, i10, -1, "androidx.compose.material3.IconButtonColors.contentColor (IconButton.kt:834)");
        }
    ...
    public boolean equals(@dl.e Object other) {
        ...
        g0 g0Var = (g0) other;
        return androidx.compose.ui.graphics.l0.y(this.containerColor, g0Var.containerColor) && androidx.compose.ui.graphics.l0.y(this.contentColor, g0Var.contentColor) && androidx.compose.ui.graphics.l0.y(this.disabledContainerColor, g0Var.disabledContainerColor) && androidx.compose.ui.graphics.l0.y(this.disabledContentColor, g0Var.disabledContentColor);
    }
