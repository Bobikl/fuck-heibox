...
public final class e {
    ...
    public /* synthetic */ e(long j10, long j11, long j12, long j13, kotlin.jvm.internal.u uVar) {
    ...
    public final m2<androidx.compose.ui.graphics.l0> a(boolean z10, @dl.e androidx.compose.runtime.p pVar, int i10) {
        pVar.T(-754887434);
        if (ComposerKt.g0()) {
            ComposerKt.w0(-754887434, i10, -1, "androidx.compose.material3.ButtonColors.containerColor (Button.kt:917)");
        }
    ...
    public final m2<androidx.compose.ui.graphics.l0> b(boolean z10, @dl.e androidx.compose.runtime.p pVar, int i10) {
        pVar.T(-360303250);
        if (ComposerKt.g0()) {
            ComposerKt.w0(-360303250, i10, -1, "androidx.compose.material3.ButtonColors.contentColor (Button.kt:927)");
        }
    ...
    public boolean equals(@dl.e Object other) {
        ...
        e eVar = (e) other;
        return androidx.compose.ui.graphics.l0.y(this.containerColor, eVar.containerColor) && androidx.compose.ui.graphics.l0.y(this.contentColor, eVar.contentColor) && androidx.compose.ui.graphics.l0.y(this.disabledContainerColor, eVar.disabledContainerColor) && androidx.compose.ui.graphics.l0.y(this.disabledContentColor, eVar.disabledContentColor);
    }
