...
public final /* data */ class HorizontalScrollLayoutModifier implements androidx.compose.ui.layout.w {
    ...
    public HorizontalScrollLayoutModifier(@dl.d TextFieldScrollerPosition scrollerPosition, int i10, @dl.d TransformedText transformedText, @dl.d yh.a<w> textLayoutResultProvider) {
    ...
    public static /* synthetic */ HorizontalScrollLayoutModifier g(HorizontalScrollLayoutModifier horizontalScrollLayoutModifier, TextFieldScrollerPosition textFieldScrollerPosition, int i10, TransformedText transformedText, yh.a aVar, int i11, Object obj) {
        if ((i11 & 1) != 0) {
        ...
        return horizontalScrollLayoutModifier.f(textFieldScrollerPosition, i10, transformedText, aVar);
    }
    ...
    public boolean equals(@dl.e Object other) {
        ...
        return f0.g(this.scrollerPosition, horizontalScrollLayoutModifier.scrollerPosition) && this.cursorOffset == horizontalScrollLayoutModifier.cursorOffset && f0.g(this.transformedText, horizontalScrollLayoutModifier.transformedText) && f0.g(this.textLayoutResultProvider, horizontalScrollLayoutModifier.textLayoutResultProvider);
    }

    @dl.d
    public final HorizontalScrollLayoutModifier f(@dl.d TextFieldScrollerPosition scrollerPosition, int i10, @dl.d TransformedText transformedText, @dl.d yh.a<w> textLayoutResultProvider) {
        f0.p(scrollerPosition, "scrollerPosition");
        f0.p(transformedText, "transformedText");
        f0.p(textLayoutResultProvider, "textLayoutResultProvider");
    ...
    public j0 k(@dl.d final l0 measure, @dl.d g0 measurable, long j10) {
        ...
        final e1 e1VarZ1 = measurable.z1(measurable.w1(s1.b.o(j10)) < s1.b.p(j10) ? j10 : s1.b.e(j10, 0, Integer.MAX_VALUE, 0, 0, 13, null));
        final int iMin = Math.min(e1VarZ1.getWidth(), s1.b.p(j10));
        return k0.p(measure, iMin, e1VarZ1.getHeight(), null, new yh.l<e1.a, b2>() { // from class: androidx.compose.foundation.text.HorizontalScrollLayoutModifier$measure$1
            ...
            public final void a(@dl.d e1.a layout) {
                ...
                this.n().l(Orientation.Horizontal, TextFieldScrollKt.b(l0Var, iM, transformedTextQ, wVarInvoke != null ? wVarInvoke.getValue() : null, measure.getLayoutDirection() == LayoutDirection.Rtl, e1VarZ1.getWidth()), iMin, e1VarZ1.getWidth());
                e1.a.v(layout, e1VarZ1, di.d.L0(-this.n().d()), 0, 0.0f, 4, null);
            }
