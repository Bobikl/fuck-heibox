...
public final class TextFieldSelectionManager_androidKt$textFieldMagnifier$1 extends Lambda implements yh.q<androidx.compose.ui.n, androidx.compose.runtime.p, Integer, androidx.compose.ui.n> {

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    final /* synthetic */ TextFieldSelectionManager f8315b;
    ...
    TextFieldSelectionManager_androidKt$textFieldMagnifier$1(TextFieldSelectionManager textFieldSelectionManager) {
        super(3);
        this.f8315b = textFieldSelectionManager;
    }
    ...
    public final androidx.compose.ui.n c(@dl.d androidx.compose.ui.n composed, @dl.e androidx.compose.runtime.p pVar, int i10) {
        ...
        final TextFieldSelectionManager textFieldSelectionManager = this.f8315b;
        yh.a<b1.f> aVar = new yh.a<b1.f>() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager_androidKt$textFieldMagnifier$1.1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
            }
            ...
            public final long a() {
                return TextFieldSelectionManagerKt.b(textFieldSelectionManager, TextFieldSelectionManager_androidKt$textFieldMagnifier$1.d(a1Var));
            }
        ...
        if (zS || objU2 == companion.a()) {
            objU2 = new yh.l<yh.a<? extends b1.f>, androidx.compose.ui.n>() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager_androidKt$textFieldMagnifier$1$2$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                }
                ...
                public final androidx.compose.ui.n invoke(@dl.d final yh.a<b1.f> center) {
                    ...
                    yh.l<s1.e, b1.f> lVar = new yh.l<s1.e, b1.f>() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager_androidKt$textFieldMagnifier$1$2$1.1
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        {
                            super(1);
                        }
                    ...
                    return MagnifierKt.f(companion2, lVar, null, 0.0f, c0VarC, new yh.l<s1.l, b2>() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager_androidKt$textFieldMagnifier$1$2$1.2
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        {
                            super(1);
                        }
                        ...
                        public final void a(long j10) {
                            ...
                            s1.e eVar3 = eVar2;
                            TextFieldSelectionManager_androidKt$textFieldMagnifier$1.e(a1Var3, s1.s.a(eVar3.e1(s1.l.p(j10)), eVar3.e1(s1.l.m(j10))));
                        }
