...
public final class d1 implements h1 {
    ...
    public d1(@dl.d h1 first, @dl.d h1 second) {
    ...
    public boolean equals(@dl.e Object other) {
        ...
        d1 d1Var = (d1) other;
        return kotlin.jvm.internal.f0.g(d1Var.first, this.first) && kotlin.jvm.internal.f0.g(d1Var.second, this.second);
    }
