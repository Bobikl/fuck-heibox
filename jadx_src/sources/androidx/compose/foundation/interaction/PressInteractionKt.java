...
public final class PressInteractionKt {
    ...
    public static final m2<Boolean> a(@dl.d e eVar, @dl.e p pVar, int i10) {
        ...
        pVar.T(-1692965168);
        if (ComposerKt.g0()) {
            ComposerKt.w0(-1692965168, i10, -1, "androidx.compose.foundation.interaction.collectIsPressedAsState (PressInteraction.kt:83)");
        }
        pVar.T(-492369756);
        Object objU = pVar.U();
        ...
        if (zS || objU2 == companion.a()) {
            objU2 = new PressInteractionKt$collectIsPressedAsState$1$1(eVar, a1Var, null);
            pVar.N(objU2);
        }
        pVar.c0();
