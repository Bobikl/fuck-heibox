...
public final class LazyGridDslKt$items$10 extends Lambda implements yh.r<l, Integer, androidx.compose.runtime.p, Integer, b2> {

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    final /* synthetic */ yh.r<l, T, androidx.compose.runtime.p, Integer, b2> f6683b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    final /* synthetic */ T[] f6684c;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public LazyGridDslKt$items$10(yh.r<? super l, ? super T, ? super androidx.compose.runtime.p, ? super Integer, b2> rVar, T[] tArr) {
        super(4);
        this.f6683b = rVar;
        this.f6684c = tArr;
    }
    ...
    public final void a(@dl.d l items, int i10, @dl.e androidx.compose.runtime.p pVar, int i11) {
        ...
        this.f6683b.U0(items, this.f6684c[i10], pVar, Integer.valueOf(i12 & 14));
        if (ComposerKt.g0()) {
            ComposerKt.v0();
        }
    }
