...
public final class LazyGridDslKt$items$5 extends Lambda implements yh.r<l, Integer, androidx.compose.runtime.p, Integer, b2> {

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    final /* synthetic */ yh.r<l, T, androidx.compose.runtime.p, Integer, b2> f6691b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    final /* synthetic */ List<T> f6692c;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public LazyGridDslKt$items$5(yh.r<? super l, ? super T, ? super androidx.compose.runtime.p, ? super Integer, b2> rVar, List<? extends T> list) {
        super(4);
        this.f6691b = rVar;
        this.f6692c = list;
    }
    ...
    public final void a(@dl.d l items, int i10, @dl.e androidx.compose.runtime.p pVar, int i11) {
        ...
        if (ComposerKt.g0()) {
            ComposerKt.w0(699646206, i12, -1, "androidx.compose.foundation.lazy.grid.items.<anonymous> (LazyGridDsl.kt:390)");
        }
        this.f6691b.U0(items, (T) this.f6692c.get(i10), pVar, Integer.valueOf(i12 & 14));
        if (ComposerKt.g0()) {
            ComposerKt.v0();
        }
    }
