...
public final class LazyGridDslKt$itemsIndexed$8 extends Lambda implements yh.p<m, Integer, d> {

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    final /* synthetic */ yh.q<m, Integer, T, d> f6714b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    final /* synthetic */ T[] f6715c;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public LazyGridDslKt$itemsIndexed$8(yh.q<? super m, ? super Integer, ? super T, d> qVar, T[] tArr) {
        super(2);
        this.f6714b = qVar;
        this.f6715c = tArr;
    }
    ...
    public final long a(@dl.d m mVar, int i10) {
        f0.p(mVar, "$this$null");
        return this.f6714b.invoke(mVar, Integer.valueOf(i10), this.f6715c[i10]).getPackedValue();
    }
