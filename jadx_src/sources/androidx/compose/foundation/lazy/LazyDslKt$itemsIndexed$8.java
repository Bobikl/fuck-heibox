...
public final class LazyDslKt$itemsIndexed$8 extends Lambda implements yh.r<g, Integer, androidx.compose.runtime.p, Integer, b2> {

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    final /* synthetic */ yh.s<g, Integer, T, androidx.compose.runtime.p, Integer, b2> f6489b;
    ...
    public LazyDslKt$itemsIndexed$8(yh.s<? super g, ? super Integer, ? super T, ? super androidx.compose.runtime.p, ? super Integer, b2> sVar, T[] tArr) {
        super(4);
        this.f6489b = sVar;
        this.f6490c = tArr;
    }
    ...
    public final void a(@dl.d g items, int i10, @dl.e androidx.compose.runtime.p pVar, int i11) {
        ...
        if (ComposerKt.g0()) {
            ComposerKt.w0(1600639390, i12, -1, "androidx.compose.foundation.lazy.itemsIndexed.<anonymous> (LazyDsl.kt:249)");
        }
        this.f6489b.N0(items, Integer.valueOf(i10), this.f6490c[i10], pVar, Integer.valueOf((i12 & 14) | (i12 & 112)));
        if (ComposerKt.g0()) {
            ComposerKt.v0();
        }
    }
