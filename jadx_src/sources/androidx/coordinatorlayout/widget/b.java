...
public class b {
    ...
    private static final ThreadLocal<Matrix> f19824a = new ThreadLocal<>();

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static final ThreadLocal<RectF> f19825b = new ThreadLocal<>();
    ...
    static void c(ViewGroup viewGroup, View view, Rect rect) {
        ThreadLocal<Matrix> threadLocal = f19824a;
        ...
        ThreadLocal<RectF> threadLocal2 = f19825b;
