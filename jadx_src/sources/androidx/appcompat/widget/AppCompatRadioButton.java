...
public class AppCompatRadioButton extends RadioButton implements androidx.core.widget.b0, androidx.core.view.g1, d0, androidx.core.widget.c0 {
    ...
    public AppCompatRadioButton(Context context, @androidx.annotation.p0 AttributeSet attributeSet) {
        this(context, attributeSet, R.attr.radioButtonStyle);
    }

    public AppCompatRadioButton(Context context, @androidx.annotation.p0 AttributeSet attributeSet, int i10) {
