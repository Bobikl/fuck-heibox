...
public class AppCompatAutoCompleteTextView extends AutoCompleteTextView implements androidx.core.view.g1, d0, androidx.core.widget.c0 {
    ...
    public AppCompatAutoCompleteTextView(@androidx.annotation.n0 Context context) {
        this(context, null);
    }

    public AppCompatAutoCompleteTextView(@androidx.annotation.n0 Context context, @androidx.annotation.p0 AttributeSet attributeSet) {
        this(context, attributeSet, androidx.appcompat.R.attr.autoCompleteTextViewStyle);
    }

    public AppCompatAutoCompleteTextView(@androidx.annotation.n0 Context context, @androidx.annotation.p0 AttributeSet attributeSet, int i10) {
        super(u0.b(context), attributeSet, i10);
        s0.a(this, getContext());
        x0 x0VarG = x0.G(getContext(), attributeSet, f2395e, i10, 0);
        if (x0VarG.C(0)) {
    ...
    public InputConnection onCreateInputConnection(EditorInfo editorInfo) {
        return this.f2398d.e(i.a(super.onCreateInputConnection(editorInfo), editorInfo, this), editorInfo);
    }
