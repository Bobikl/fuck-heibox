...
public class g1 extends n0 {
    ...
    private static boolean f2813c = false;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    public static final int f2814d = 20;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private final WeakReference<Context> f2815b;

    public g1(@androidx.annotation.n0 Context context, @androidx.annotation.n0 Resources resources) {
        super(resources);
        this.f2815b = new WeakReference<>(context);
    }
    ...
    public Drawable getDrawable(int i10) throws Resources.NotFoundException {
        Context context = this.f2815b.get();
        return context != null ? m0.h().t(context, this, i10) : a(i10);
    }
