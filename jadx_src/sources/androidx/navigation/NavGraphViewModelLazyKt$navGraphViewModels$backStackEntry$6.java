...
public final class NavGraphViewModelLazyKt$navGraphViewModels$backStackEntry$6 extends Lambda implements yh.a<NavBackStackEntry> {
    ...
    public final NavBackStackEntry invoke() {
        return androidx.navigation.fragment.e.a(this.f24924b).P(this.f24925c);
    }
}
