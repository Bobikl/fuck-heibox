...
public final class v1<K> extends z1<K> {
    ...
    public /* synthetic */ v1(int i10, int i11, kotlin.jvm.internal.u uVar) {
        this((i11 & 1) != 0 ? 6 : i10);
    }

    private final void O() {
        if (this.f3769d <= 8 || Long.compare(kotlin.r1.h(kotlin.r1.h(this.f3770e) * 32) ^ Long.MIN_VALUE, kotlin.r1.h(kotlin.r1.h(this.f3769d) * 25) ^ Long.MIN_VALUE) > 0) {
            k0(h2.w(this.f3769d));
        } else {
            h0();
        }
    ...
    private final int R(K k10) {
        ...
        while (true) {
            ...
            if ((((~j10) << 6) & j10 & (-9187201950435737472L)) != 0) {
                int iQ = Q(i11);
                if (this.f3722f == 0) {
                    if (!(((this.f3766a[iQ >> 3] >> ((iQ & 7) << 3)) & 255) == 254)) {
                        O();
                        iQ = Q(i11);
                    }
                }
                this.f3770e++;
                int i19 = this.f3722f;
                long[] jArr2 = this.f3766a;
                int i20 = iQ >> 3;
                long j14 = jArr2[i20];
                int i21 = (iQ & 7) << 3;
                this.f3722f = i19 - (((j14 >> i21) & 255) == 128 ? 1 : 0);
    ...
    private final void T() {
        this.f3722f = h2.o(o()) - this.f3770e;
    }
    ...
    private final void V(int i10) {
        ...
        this.f3769d = iMax;
        U(iMax);
        this.f3767b = new Object[iMax];
        this.f3768c = new float[iMax];
    }
    ...
    public final void P() {
        ...
        kotlin.collections.m.n2(this.f3767b, null, 0, this.f3769d);
        T();
    }
    ...
    public final void b0(@dl.d z1<K> from) {
        kotlin.jvm.internal.f0.p(from, "from");
        e0(from);
    }

    public final float c0(K k10, float f10, float f11) {
        int iR = R(k10);
        if (iR < 0) {
            iR = ~iR;
        } else {
    ...
    public final void d0(K k10, float f10) {
        l0(k10, f10);
    }

    /* JADX WARN: Multi-variable type inference failed */
    public final void e0(@dl.d z1<K> from) {
        kotlin.jvm.internal.f0.p(from, "from");
        Object[] objArr = from.f3767b;
        float[] fArr = from.f3768c;
        long[] jArr = from.f3766a;
        int length = jArr.length - 2;
        if (length < 0) {
            return;
        }
    ...
    public final boolean g0(K k10, float f10) {
        int i10 = i(k10);
        if (i10 >= 0) {
            if (this.f3768c[i10] == f10) {
                j0(i10);
                return true;
            }
        }
    ...
    public final void i0(@dl.d yh.p<? super K, ? super Float, Boolean> predicate) {
        ...
        while (true) {
            ...
            if ((((~j10) << 7) & j10 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i12 = 0; i12 < i11; i12++) {
                    if ((255 & j10) < 128) {
                        int i13 = (i10 << 3) + i12;
                        if (predicate.invoke(this.f3767b[i13], Float.valueOf(this.f3768c[i13])).booleanValue()) {
                            j0(i13);
                        }
                    }
                    j10 >>= 8;
    ...
    public final int m0() {
        int i10 = this.f3769d;
        int iX = h2.x(h2.z(this.f3770e));
        if (iX >= i10) {
            return 0;
        }
        k0(iX);
        return i10 - this.f3769d;
    }
}
