...
public final class o1 extends k0 {
    ...
    public /* synthetic */ o1(int i10, int i11, kotlin.jvm.internal.u uVar) {
        this((i11 & 1) != 0 ? 6 : i10);
    }

    private final void O() {
        if (this.f3640d <= 8 || Long.compare(kotlin.r1.h(kotlin.r1.h(this.f3641e) * 32) ^ Long.MIN_VALUE, kotlin.r1.h(kotlin.r1.h(this.f3640d) * 25) ^ Long.MIN_VALUE) > 0) {
            j0(h2.w(this.f3640d));
        } else {
            g0();
        }
    ...
    private final int R(long j10) {
        ...
        while (true) {
            ...
            if ((((~j11) << 6) & j11 & (-9187201950435737472L)) != 0) {
                int iQ = Q(i11);
                if (this.f3676f == 0) {
                    if (!(((this.f3637a[iQ >> 3] >> ((iQ & 7) << 3)) & 255) == 254)) {
                        O();
                        iQ = Q(i11);
                    }
                }
                ...
                long j15 = jArr2[i20];
                int i21 = (iQ & 7) << 3;
                this.f3676f = i19 - (((j15 >> i21) & 255) == 128 ? 1 : 0);
    ...
    private final void T() {
        this.f3676f = h2.o(o()) - this.f3641e;
    }
    ...
    private final void V(int i10) {
        ...
        this.f3640d = iMax;
        U(iMax);
        this.f3638b = new long[iMax];
        this.f3639c = new float[iMax];
    }
    ...
    public final void a0(@dl.d k0 from) {
        kotlin.jvm.internal.f0.p(from, "from");
        d0(from);
    }

    public final float b0(long j10, float f10, float f11) {
        int iR = R(j10);
        if (iR < 0) {
            iR = ~iR;
        } else {
    ...
    public final void c0(long j10, float f10) {
        k0(j10, f10);
    }

    public final void d0(@dl.d k0 from) {
        kotlin.jvm.internal.f0.p(from, "from");
        long[] jArr = from.f3638b;
        float[] fArr = from.f3639c;
        long[] jArr2 = from.f3637a;
        int length = jArr2.length - 2;
        if (length < 0) {
            return;
        }
    ...
    public final boolean f0(long j10, float f10) {
        int i10 = i(j10);
        if (i10 >= 0) {
            if (this.f3639c[i10] == f10) {
                i0(i10);
                return true;
            }
        }
    ...
    public final void h0(@dl.d yh.p<? super Long, ? super Float, Boolean> predicate) {
        ...
        while (true) {
            ...
            if ((((~j10) << 7) & j10 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i12 = 0; i12 < i11; i12++) {
                    if ((255 & j10) < 128) {
                        int i13 = (i10 << 3) + i12;
                        if (predicate.invoke(Long.valueOf(this.f3638b[i13]), Float.valueOf(this.f3639c[i13])).booleanValue()) {
                            i0(i13);
                        }
                    }
                    j10 >>= 8;
    ...
    public final int l0() {
        int i10 = this.f3640d;
        int iX = h2.x(h2.z(this.f3641e));
        if (iX >= i10) {
            return 0;
        }
        j0(iX);
        return i10 - this.f3640d;
    }
}
