...
public final class c1 extends i {
    ...
    private final void O() {
        if (this.f3622d <= 8 || Long.compare(kotlin.r1.h(kotlin.r1.h(this.f3623e) * 32) ^ Long.MIN_VALUE, kotlin.r1.h(kotlin.r1.h(this.f3622d) * 25) ^ Long.MIN_VALUE) > 0) {
            j0(h2.w(this.f3622d));
        } else {
            g0();
        }
    ...
    private final int R(float f10) {
        ...
        while (true) {
            ...
            if ((((~j10) << 6) & j10 & (-9187201950435737472L)) != 0) {
                int iQ = Q(i11);
                if (this.f3570f == 0) {
                    if (!(((this.f3619a[iQ >> 3] >> ((iQ & 7) << 3)) & 255) == 254)) {
                        O();
                        iQ = Q(i11);
                    }
                }
                this.f3623e++;
                int i19 = this.f3570f;
                long[] jArr2 = this.f3619a;
                int i20 = iQ >> 3;
                long j14 = jArr2[i20];
                int i21 = (iQ & 7) << 3;
                this.f3570f = i19 - (((j14 >> i21) & 255) == 128 ? 1 : 0);
    ...
    private final void T() {
        this.f3570f = h2.o(o()) - this.f3623e;
    }
    ...
    private final void V(int i10) {
        ...
        this.f3622d = iMax;
        U(iMax);
        this.f3620b = new float[iMax];
        this.f3621c = new float[iMax];
    }
    ...
    private final void j0(int i10) {
        ...
        int i12 = this.f3622d;
        V(i10);
        float[] fArr3 = this.f3620b;
        float[] fArr4 = this.f3621c;
        int i13 = 0;
        while (i13 < i12) {
    ...
    public final void a0(@dl.d i from) {
    ...
    public final void d0(@dl.d i from) {
        kotlin.jvm.internal.f0.p(from, "from");
        float[] fArr = from.f3620b;
        float[] fArr2 = from.f3621c;
        long[] jArr = from.f3619a;
        int length = jArr.length - 2;
        if (length < 0) {
            return;
        }
    ...
    public final void h0(@dl.d yh.p<? super Float, ? super Float, Boolean> predicate) {
        ...
        while (true) {
            ...
            if ((((~j10) << 7) & j10 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i12 = 0; i12 < i11; i12++) {
                    if ((255 & j10) < 128) {
                        int i13 = (i10 << 3) + i12;
                        if (predicate.invoke(Float.valueOf(this.f3620b[i13]), Float.valueOf(this.f3621c[i13])).booleanValue()) {
                            i0(i13);
                        }
                    }
                    j10 >>= 8;
    ...
    public final int l0() {
        int i10 = this.f3622d;
        int iX = h2.x(h2.z(this.f3623e));
        if (iX >= i10) {
            return 0;
        }
        j0(iX);
        return i10 - this.f3622d;
    }
}
