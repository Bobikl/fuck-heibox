...
public final class r1 extends q0 {
    ...
    public /* synthetic */ r1(int i10, int i11, kotlin.jvm.internal.u uVar) {
        this((i11 & 1) != 0 ? 6 : i10);
    }

    private final void O() {
        if (this.f3688d <= 8 || Long.compare(kotlin.r1.h(kotlin.r1.h(this.f3689e) * 32) ^ Long.MIN_VALUE, kotlin.r1.h(kotlin.r1.h(this.f3688d) * 25) ^ Long.MIN_VALUE) > 0) {
            j0(h2.w(this.f3688d));
        } else {
            g0();
        }
    ...
    private final int R(long j10) {
        ...
        while (true) {
            ...
            if ((((~j11) << 6) & j11 & (-9187201950435737472L)) != 0) {
                int iQ = Q(i11);
                if (this.f3692f == 0) {
                    if (!(((this.f3685a[iQ >> 3] >> ((iQ & 7) << 3)) & 255) == 254)) {
                        O();
                        iQ = Q(i11);
                    }
                }
                ...
                long j15 = jArr2[i20];
                int i21 = (iQ & 7) << 3;
                this.f3692f = i19 - (((j15 >> i21) & 255) == 128 ? 1 : 0);
    ...
    private final void T() {
        this.f3692f = h2.o(o()) - this.f3689e;
    }
    ...
    private final void V(int i10) {
        ...
        this.f3688d = iMax;
        U(iMax);
        this.f3686b = new long[iMax];
        this.f3687c = new long[iMax];
    }
    ...
    private final void j0(int i10) {
        int i11;
        long[] jArr = this.f3685a;
        long[] jArr2 = this.f3686b;
        long[] jArr3 = this.f3687c;
        int i12 = this.f3688d;
        V(i10);
        long[] jArr4 = this.f3686b;
        long[] jArr5 = this.f3687c;
        int i13 = 0;
        while (i13 < i12) {
            if (((jArr[i13 >> 3] >> ((i13 & 7) << 3)) & 255) < 128) {
                ...
                i11 = i13;
                long j11 = i14 & 127;
                long[] jArr6 = this.f3685a;
                int i15 = iQ >> 3;
                int i16 = (iQ & 7) << 3;
                jArr6[i15] = (jArr6[i15] & (~(255 << i16))) | (j11 << i16);
                int i17 = this.f3688d;
                int i18 = ((iQ - 7) & i17) + (i17 & 7);
                int i19 = i18 >> 3;
                int i20 = (i18 & 7) << 3;
                jArr6[i19] = (j11 << i20) | (jArr6[i19] & (~(255 << i20)));
                jArr4[iQ] = j10;
                jArr5[iQ] = jArr3[i11];
            } else {
                i11 = i13;
    ...
    public final void a0(@dl.d q0 from) {
    ...
    public final void d0(@dl.d q0 from) {
        kotlin.jvm.internal.f0.p(from, "from");
        long[] jArr = from.f3686b;
        long[] jArr2 = from.f3687c;
        long[] jArr3 = from.f3685a;
    ...
    public final void h0(@dl.d yh.p<? super Long, ? super Long, Boolean> predicate) {
        ...
        while (true) {
            ...
            if ((((~j10) << 7) & j10 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i12 = 0; i12 < i11; i12++) {
                    if ((255 & j10) < 128) {
                        int i13 = (i10 << 3) + i12;
                        if (predicate.invoke(Long.valueOf(this.f3686b[i13]), Long.valueOf(this.f3687c[i13])).booleanValue()) {
                            i0(i13);
                        }
                    }
                    j10 >>= 8;
    ...
    public final int l0() {
        int i10 = this.f3688d;
        int iX = h2.x(h2.z(this.f3689e));
        if (iX >= i10) {
            return 0;
        }
        j0(iX);
        return i10 - this.f3688d;
    }
}
