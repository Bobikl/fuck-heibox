...
public abstract class g0<V> {
    ...
    private g0() {
        this.f3598a = h2.f3611e;
        this.f3599b = j0.b();
        this.f3600c = i0.a.f119208c;
    }

    public /* synthetic */ g0(kotlin.jvm.internal.u uVar) {
        this();
    }

    public static /* synthetic */ String L(g0 g0Var, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i10, CharSequence charSequence4, int i11, Object obj) {
        if (obj != null) {
        ...
        return g0Var.E(charSequence, charSequence5, charSequence6, i12, charSequence4);
    }

    public static /* synthetic */ String M(g0 g0Var, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i10, CharSequence charSequence4, yh.p transform, int i11, Object obj) {
        long[] jArr;
        int i12;
        if (obj != null) {
            throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: joinToString");
        ...
        sb2.append(prefix);
        int[] iArr = g0Var.f3599b;
        Object[] objArr = g0Var.f3600c;
        long[] jArr2 = g0Var.f3598a;
    ...
    public final String E(@dl.d CharSequence separator, @dl.d CharSequence prefix, @dl.d CharSequence postfix, int i10, @dl.d CharSequence truncated) {
        ...
        StringBuilder sb2 = new StringBuilder();
        sb2.append(prefix);
        int[] iArr2 = this.f3599b;
        Object[] objArr = this.f3600c;
    ...
    @dl.d
    @xh.i
    public final String F(@dl.d CharSequence charSequence, @dl.d CharSequence prefix, @dl.d CharSequence postfix, int i10, @dl.d CharSequence truncated, @dl.d yh.p<? super Integer, ? super V, ? extends CharSequence> transform) {
        int[] iArr;
  ...
  0x0097: PHI (r11v2 int) = (r11v1 int), (r11v3 int) binds: [B:6:0x0044, B:23:0x0095] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    @dl.d
    @xh.i
    public final String G(@dl.d CharSequence separator, @dl.d CharSequence prefix, @dl.d CharSequence postfix, int i10, @dl.d yh.p<? super Integer, ? super V, ? extends CharSequence> transform) {
        int i11;
        kotlin.jvm.internal.f0.p(separator, "separator");
        kotlin.jvm.internal.f0.p(prefix, "prefix");
        kotlin.jvm.internal.f0.p(postfix, "postfix");
  ...
  0x0096: PHI (r11v2 int) = (r11v1 int), (r11v3 int) binds: [B:6:0x0044, B:23:0x0094] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    @dl.d
    @xh.i
    public final String H(@dl.d CharSequence separator, @dl.d CharSequence prefix, @dl.d CharSequence postfix, @dl.d yh.p<? super Integer, ? super V, ? extends CharSequence> transform) {
        int i10;
        kotlin.jvm.internal.f0.p(separator, "separator");
        kotlin.jvm.internal.f0.p(prefix, "prefix");
        kotlin.jvm.internal.f0.p(postfix, "postfix");
  ...
  0x008a: PHI (r10v2 int) = (r10v1 int), (r10v3 int) binds: [B:6:0x003a, B:23:0x0088] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    @dl.d
    @xh.i
    public final String I(@dl.d CharSequence separator, @dl.d CharSequence prefix, @dl.d yh.p<? super Integer, ? super V, ? extends CharSequence> transform) {
        int i10;
        kotlin.jvm.internal.f0.p(separator, "separator");
        kotlin.jvm.internal.f0.p(prefix, "prefix");
        kotlin.jvm.internal.f0.p(transform, "transform");
  ...
  0x008a: PHI (r11v2 int) = (r11v1 int), (r11v3 int) binds: [B:6:0x0038, B:23:0x0088] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    @dl.d
    @xh.i
    public final String J(@dl.d CharSequence separator, @dl.d yh.p<? super Integer, ? super V, ? extends CharSequence> transform) {
        int i10;
        kotlin.jvm.internal.f0.p(separator, "separator");
        kotlin.jvm.internal.f0.p(transform, "transform");
        StringBuilder sb2 = new StringBuilder();
  ...
  0x0080: PHI (r10v2 int) = (r10v1 int), (r10v3 int) binds: [B:6:0x002e, B:23:0x007e] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    @dl.d
    @xh.i
    public final String K(@dl.d yh.p<? super Integer, ? super V, ? extends CharSequence> transform) {
        int i10;
        kotlin.jvm.internal.f0.p(transform, "transform");
        StringBuilder sb2 = new StringBuilder();
        sb2.append((CharSequence) "");
    ...
    public final boolean a(@dl.d yh.p<? super Integer, ? super V, Boolean> predicate) {
    ...
    /* JADX WARN: Code duplicated, block: B:24:0x0064 A[SYNTHETIC] */
    public final boolean c(@dl.d yh.p<? super Integer, ? super V, Boolean> predicate) {
        kotlin.jvm.internal.f0.p(predicate, "predicate");
        int[] iArr = this.f3599b;
        Object[] objArr = this.f3600c;
        long[] jArr = this.f3598a;
        ...
        loop0: while (true) {
            ...
            while (true) {
                if (j12 != 0) {
                    ...
                    if (this.f3599b[iNumberOfTrailingZeros] == i10) {
                        break loop0;
                    }
                    j12 &= j12 - 1;
                }
                ...
                if ((((~j10) << 7) & j10 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i12 = 0; i12 < i11; i12++) {
                        if ((255 & j10) < 128) {
                            ...
                            if (obj2 == null) {
                                if (g0Var.n(i14) != null || !g0Var.e(i14)) {
                                    break loop0;
                                }
                            } else if (!kotlin.jvm.internal.f0.g(obj2, g0Var.n(i14))) {
                                return false;
                            }
                        }
                        j10 >>= 8;
    ...
    public final int h(@dl.d yh.p<? super Integer, ? super V, Boolean> predicate) {
        kotlin.jvm.internal.f0.p(predicate, "predicate");
        int[] iArr = this.f3599b;
        Object[] objArr = this.f3600c;
        long[] jArr = this.f3598a;
    ...
    public final void j(@dl.d yh.p<? super Integer, ? super V, kotlin.b2> block) {
    ...
    public final V n(int i10) {
        ...
        if (iNumberOfTrailingZeros >= 0) {
            return (V) this.f3600c[iNumberOfTrailingZeros];
        }
        return null;
    }
    ...
    public final V r(int i10, V v10) {
        int iNumberOfTrailingZeros;
        int i11 = h2.f3616j * i10;
        int i12 = i11 ^ (i11 << 16);
        int i13 = i12 & 127;
        ...
        return iNumberOfTrailingZeros >= 0 ? (V) this.f3600c[iNumberOfTrailingZeros] : v10;
    }

    public final V s(int i10, @dl.d yh.a<? extends V> defaultValue) {
