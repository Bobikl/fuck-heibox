...
public final class y1<K> extends e2<K> {
    ...
    public /* synthetic */ y1(int i10, int i11, kotlin.jvm.internal.u uVar) {
        this((i11 & 1) != 0 ? 6 : i10);
    }

    private final void O() {
        if (this.f3585d <= 8 || Long.compare(kotlin.r1.h(kotlin.r1.h(this.f3586e) * 32) ^ Long.MIN_VALUE, kotlin.r1.h(kotlin.r1.h(this.f3585d) * 25) ^ Long.MIN_VALUE) > 0) {
            k0(h2.w(this.f3585d));
        } else {
            h0();
        }
    ...
    private final int R(K k10) {
        ...
        while (true) {
            ...
            if ((((~j10) << 6) & j10 & (-9187201950435737472L)) != 0) {
                int iQ = Q(i11);
                if (this.f3751f == 0) {
                    if (!(((this.f3582a[iQ >> 3] >> ((iQ & 7) << 3)) & 255) == 254)) {
                        O();
                        iQ = Q(i11);
                    }
                }
                ...
                long j14 = jArr2[i20];
                int i21 = (iQ & 7) << 3;
                this.f3751f = i19 - (((j14 >> i21) & 255) == 128 ? 1 : 0);
    ...
    private final void T() {
        this.f3751f = h2.o(o()) - this.f3586e;
    }
    ...
    private final void V(int i10) {
        ...
        this.f3585d = iMax;
        U(iMax);
        this.f3583b = new Object[iMax];
        this.f3584c = new long[iMax];
    }
    ...
    public final void P() {
        ...
        kotlin.collections.m.n2(this.f3583b, null, 0, this.f3585d);
        T();
    }
    ...
    public final void b0(@dl.d e2<K> from) {
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public final void e0(@dl.d e2<K> from) {
        kotlin.jvm.internal.f0.p(from, "from");
        Object[] objArr = from.f3583b;
        long[] jArr = from.f3584c;
        long[] jArr2 = from.f3582a;
    ...
    public final void i0(@dl.d yh.p<? super K, ? super Long, Boolean> predicate) {
        ...
        while (true) {
            ...
            if ((((~j10) << 7) & j10 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i12 = 0; i12 < i11; i12++) {
                    if ((255 & j10) < 128) {
                        int i13 = (i10 << 3) + i12;
                        if (predicate.invoke(this.f3583b[i13], Long.valueOf(this.f3584c[i13])).booleanValue()) {
                            j0(i13);
                        }
                    }
                    j10 >>= 8;
    ...
    public final int m0() {
        int i10 = this.f3585d;
        int iX = h2.x(h2.z(this.f3586e));
        if (iX >= i10) {
            return 0;
        }
        k0(iX);
        return i10 - this.f3585d;
    }
}
