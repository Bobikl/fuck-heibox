...
public abstract class x {
    ...
    public static /* synthetic */ String L(x xVar, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i10, CharSequence charSequence4, int i11, Object obj) {
        if (obj != null) {
        ...
        return xVar.E(charSequence, charSequence5, charSequence6, i12, charSequence4);
    }

    public static /* synthetic */ String M(x xVar, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i10, CharSequence charSequence4, yh.p transform, int i11, Object obj) {
        long[] jArr;
        int i12;
        if (obj != null) {
            throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: joinToString");
        ...
        sb2.append(prefix);
        int[] iArr = xVar.f3730b;
        float[] fArr = xVar.f3731c;
        long[] jArr2 = xVar.f3729a;
            ...
            if ((((~j10) << 7) & j10 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                while (i19 < i18) {
                    if ((j10 & 255) < 128) {
                        ...
                        sb2.append((CharSequence) transform.invoke(Integer.valueOf(i21), Float.valueOf(f10)));
                        i15++;
                        i12 = 8;
                    } else {
                        i12 = i17;
    ...
    public final String E(@dl.d CharSequence separator, @dl.d CharSequence prefix, @dl.d CharSequence postfix, int i10, @dl.d CharSequence truncated) {
        ...
        float[] fArr = this.f3731c;
        long[] jArr = this.f3729a;
  ...
  0x00a1: PHI (r12v2 int) = (r12v1 int), (r12v3 int) binds: [B:6:0x004c, B:22:0x009f] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    @dl.d
    @xh.i
    public final String F(@dl.d CharSequence charSequence, @dl.d CharSequence prefix, @dl.d CharSequence postfix, int i10, @dl.d CharSequence truncated, @dl.d yh.p<? super Integer, ? super Float, ? extends CharSequence> transform) {
            ...
            if ((((~j10) << 7) & j10 & (-9187201950435737472L)) == -9187201950435737472L) {
                ...
                while (i15 < i14) {
                    if ((j10 & 255) < 128) {
                        ...
                        sb2.append(transform.invoke(Integer.valueOf(i17), Float.valueOf(f10)));
                        i12++;
                    }
                    j10 >>= 8;
                    i15++;
    ...
    @dl.d
    @xh.i
    public final String G(@dl.d CharSequence charSequence, @dl.d CharSequence prefix, @dl.d CharSequence postfix, int i10, @dl.d yh.p<? super Integer, ? super Float, ? extends CharSequence> transform) {
        CharSequence separator = charSequence;
        kotlin.jvm.internal.f0.p(separator, "separator");
        kotlin.jvm.internal.f0.p(prefix, "prefix");
        kotlin.jvm.internal.f0.p(postfix, "postfix");
  ...
  0x009a: PHI (r11v2 int) = (r11v1 int), (r11v3 int) binds: [B:6:0x0044, B:23:0x0098] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    @dl.d
    @xh.i
    public final String H(@dl.d CharSequence separator, @dl.d CharSequence prefix, @dl.d CharSequence postfix, @dl.d yh.p<? super Integer, ? super Float, ? extends CharSequence> transform) {
        int i10;
        kotlin.jvm.internal.f0.p(separator, "separator");
        kotlin.jvm.internal.f0.p(prefix, "prefix");
        kotlin.jvm.internal.f0.p(postfix, "postfix");
  ...
  0x008e: PHI (r10v2 int) = (r10v1 int), (r10v3 int) binds: [B:6:0x003a, B:23:0x008c] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    @dl.d
    @xh.i
    public final String I(@dl.d CharSequence separator, @dl.d CharSequence prefix, @dl.d yh.p<? super Integer, ? super Float, ? extends CharSequence> transform) {
        int i10;
        kotlin.jvm.internal.f0.p(separator, "separator");
        kotlin.jvm.internal.f0.p(prefix, "prefix");
        kotlin.jvm.internal.f0.p(transform, "transform");
  ...
  0x008e: PHI (r11v2 int) = (r11v1 int), (r11v3 int) binds: [B:6:0x0038, B:23:0x008c] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    @dl.d
    @xh.i
    public final String J(@dl.d CharSequence separator, @dl.d yh.p<? super Integer, ? super Float, ? extends CharSequence> transform) {
        int i10;
        kotlin.jvm.internal.f0.p(separator, "separator");
        kotlin.jvm.internal.f0.p(transform, "transform");
        StringBuilder sb2 = new StringBuilder();
  ...
  0x0084: PHI (r10v2 int) = (r10v1 int), (r10v3 int) binds: [B:6:0x002e, B:23:0x0082] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    @dl.d
    @xh.i
    public final String K(@dl.d yh.p<? super Integer, ? super Float, ? extends CharSequence> transform) {
        int i10;
        kotlin.jvm.internal.f0.p(transform, "transform");
        StringBuilder sb2 = new StringBuilder();
        sb2.append((CharSequence) "");
    ...
    public final boolean a(@dl.d yh.p<? super Integer, ? super Float, Boolean> predicate) {
    ...
    /* JADX WARN: Code duplicated, block: B:24:0x0068 A[SYNTHETIC] */
    public final boolean c(@dl.d yh.p<? super Integer, ? super Float, Boolean> predicate) {
        kotlin.jvm.internal.f0.p(predicate, "predicate");
        int[] iArr = this.f3730b;
        float[] fArr = this.f3731c;
        long[] jArr = this.f3729a;
    ...
    public final int h(@dl.d yh.p<? super Integer, ? super Float, Boolean> predicate) {
        kotlin.jvm.internal.f0.p(predicate, "predicate");
        int[] iArr = this.f3730b;
        float[] fArr = this.f3731c;
        long[] jArr = this.f3729a;
            ...
            while (true) {
                ...
                if ((((~j10) << 7) & j10 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i13 = 0; i13 < i12; i13++) {
                        if ((255 & j10) < 128) {
                            int i14 = (i11 << 3) + i13;
                            iFloatToIntBits += Float.floatToIntBits(fArr[i14]) ^ iArr[i14];
                        }
                        j10 >>= 8;
                    }
                    if (i12 != 8) {
        ...
        while (true) {
            ...
            while (true) {
                if (j12 != 0) {
                    ...
                    if (this.f3730b[iNumberOfTrailingZeros] == i10) {
    ...
    public final void j(@dl.d yh.p<? super Integer, ? super Float, kotlin.b2> block) {
    ...
    public final float r(int i10, float f10) {
        int i11 = i(i10);
        return i11 >= 0 ? this.f3731c[i11] : f10;
    }

    public final float s(int i10, @dl.d yh.a<Float> defaultValue) {
        kotlin.jvm.internal.f0.p(defaultValue, "defaultValue");
        int i11 = i(i10);
        return i11 < 0 ? defaultValue.invoke().floatValue() : this.f3731c[i11];
    }
