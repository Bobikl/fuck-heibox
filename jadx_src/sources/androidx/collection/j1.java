...
public final class j1 extends z {
    ...
    private final void O() {
        if (this.f3755d <= 8 || Long.compare(kotlin.r1.h(kotlin.r1.h(this.f3756e) * 32) ^ Long.MIN_VALUE, kotlin.r1.h(kotlin.r1.h(this.f3755d) * 25) ^ Long.MIN_VALUE) > 0) {
            j0(h2.w(this.f3755d));
        } else {
            g0();
        }
    ...
    private final int R(int i10) {
        ...
        while (true) {
            ...
            if ((((~j10) << 6) & j10 & (-9187201950435737472L)) != 0) {
                int iQ = Q(i13);
                if (this.f3633f == 0) {
                    if (!(((this.f3752a[iQ >> 3] >> ((iQ & 7) << 3)) & 255) == 254)) {
                        O();
                        iQ = Q(i13);
                    }
                }
                this.f3756e++;
                int i21 = this.f3633f;
                long[] jArr2 = this.f3752a;
                int i22 = iQ >> 3;
                long j14 = jArr2[i22];
                int i23 = (iQ & 7) << 3;
                this.f3633f = i21 - (((j14 >> i23) & 255) == 128 ? 1 : 0);
    ...
    private final void T() {
        this.f3633f = h2.o(o()) - this.f3756e;
    }
    ...
    private final void V(int i10) {
        ...
        this.f3755d = iMax;
        U(iMax);
        this.f3753b = new int[iMax];
        this.f3754c = new int[iMax];
    }
    ...
    private final void j0(int i10) {
        ...
        int i12 = this.f3755d;
        V(i10);
        int[] iArr3 = this.f3753b;
        int[] iArr4 = this.f3754c;
        int i13 = 0;
        while (i13 < i12) {
    ...
    public final void a0(@dl.d z from) {
    ...
    public final void d0(@dl.d z from) {
        kotlin.jvm.internal.f0.p(from, "from");
        int[] iArr = from.f3753b;
        int[] iArr2 = from.f3754c;
        long[] jArr = from.f3752a;
        int length = jArr.length - 2;
        if (length < 0) {
            return;
        }
    ...
    public final void h0(@dl.d yh.p<? super Integer, ? super Integer, Boolean> predicate) {
        ...
        while (true) {
            ...
            if ((((~j10) << 7) & j10 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i12 = 0; i12 < i11; i12++) {
                    if ((255 & j10) < 128) {
                        int i13 = (i10 << 3) + i12;
                        if (predicate.invoke(Integer.valueOf(this.f3753b[i13]), Integer.valueOf(this.f3754c[i13])).booleanValue()) {
                            i0(i13);
                        }
                    }
                    j10 >>= 8;
    ...
    public final int l0() {
        int i10 = this.f3755d;
        int iX = h2.x(h2.z(this.f3756e));
        if (iX >= i10) {
            return 0;
        }
        j0(iX);
        return i10 - this.f3755d;
    }
}
