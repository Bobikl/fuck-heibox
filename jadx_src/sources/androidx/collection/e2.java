...
public abstract class e2<K> {
    ...
    private e2() {
        this.f3582a = h2.f3611e;
        this.f3583b = i0.a.f119208c;
        this.f3584c = w0.b();
    }

    public /* synthetic */ e2(kotlin.jvm.internal.u uVar) {
        this();
    }

    public static /* synthetic */ String L(e2 e2Var, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i10, CharSequence charSequence4, int i11, Object obj) {
        if (obj != null) {
        ...
        return e2Var.E(charSequence, charSequence5, charSequence6, i12, charSequence4);
    }

    public static /* synthetic */ String M(e2 e2Var, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i10, CharSequence charSequence4, yh.p transform, int i11, Object obj) {
        long[] jArr;
        int i12;
        if (obj != null) {
            throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: joinToString");
        ...
        sb2.append(prefix);
        Object[] objArr = e2Var.f3583b;
        long[] jArr2 = e2Var.f3584c;
        long[] jArr3 = e2Var.f3582a;
    ...
    public final String E(@dl.d CharSequence separator, @dl.d CharSequence prefix, @dl.d CharSequence postfix, int i10, @dl.d CharSequence truncated) {
        ...
        StringBuilder sb2 = new StringBuilder();
        sb2.append(prefix);
        Object[] objArr2 = this.f3583b;
        long[] jArr = this.f3584c;
        long[] jArr2 = this.f3582a;
    ...
    @dl.d
    @xh.i
    public final String F(@dl.d CharSequence charSequence, @dl.d CharSequence prefix, @dl.d CharSequence postfix, int i10, @dl.d CharSequence truncated, @dl.d yh.p<? super K, ? super Long, ? extends CharSequence> transform) {
        Object[] objArr;
  ...
  0x0097: PHI (r11v2 int) = (r11v1 int), (r11v3 int) binds: [B:6:0x0044, B:23:0x0095] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    @dl.d
    @xh.i
    public final String G(@dl.d CharSequence separator, @dl.d CharSequence prefix, @dl.d CharSequence postfix, int i10, @dl.d yh.p<? super K, ? super Long, ? extends CharSequence> transform) {
        int i11;
        kotlin.jvm.internal.f0.p(separator, "separator");
        kotlin.jvm.internal.f0.p(prefix, "prefix");
        kotlin.jvm.internal.f0.p(postfix, "postfix");
  ...
  0x0096: PHI (r11v2 int) = (r11v1 int), (r11v3 int) binds: [B:6:0x0044, B:23:0x0094] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    @dl.d
    @xh.i
    public final String H(@dl.d CharSequence separator, @dl.d CharSequence prefix, @dl.d CharSequence postfix, @dl.d yh.p<? super K, ? super Long, ? extends CharSequence> transform) {
        int i10;
        kotlin.jvm.internal.f0.p(separator, "separator");
        kotlin.jvm.internal.f0.p(prefix, "prefix");
        kotlin.jvm.internal.f0.p(postfix, "postfix");
  ...
  0x008a: PHI (r10v2 int) = (r10v1 int), (r10v3 int) binds: [B:6:0x003a, B:23:0x0088] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    @dl.d
    @xh.i
    public final String I(@dl.d CharSequence separator, @dl.d CharSequence prefix, @dl.d yh.p<? super K, ? super Long, ? extends CharSequence> transform) {
        int i10;
        kotlin.jvm.internal.f0.p(separator, "separator");
        kotlin.jvm.internal.f0.p(prefix, "prefix");
        kotlin.jvm.internal.f0.p(transform, "transform");
  ...
  0x008a: PHI (r11v2 int) = (r11v1 int), (r11v3 int) binds: [B:6:0x0038, B:23:0x0088] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    @dl.d
    @xh.i
    public final String J(@dl.d CharSequence separator, @dl.d yh.p<? super K, ? super Long, ? extends CharSequence> transform) {
        int i10;
        kotlin.jvm.internal.f0.p(separator, "separator");
        kotlin.jvm.internal.f0.p(transform, "transform");
        StringBuilder sb2 = new StringBuilder();
  ...
  0x0080: PHI (r10v2 int) = (r10v1 int), (r10v3 int) binds: [B:6:0x002e, B:23:0x007e] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    @dl.d
    @xh.i
    public final String K(@dl.d yh.p<? super K, ? super Long, ? extends CharSequence> transform) {
        int i10;
        kotlin.jvm.internal.f0.p(transform, "transform");
        StringBuilder sb2 = new StringBuilder();
        sb2.append((CharSequence) "");
    ...
    public final boolean a(@dl.d yh.p<? super K, ? super Long, Boolean> predicate) {
    ...
    /* JADX WARN: Code duplicated, block: B:24:0x0064 A[SYNTHETIC] */
    public final boolean c(@dl.d yh.p<? super K, ? super Long, Boolean> predicate) {
        kotlin.jvm.internal.f0.p(predicate, "predicate");
        Object[] objArr = this.f3583b;
        long[] jArr = this.f3584c;
        long[] jArr2 = this.f3582a;
    ...
    /* JADX WARN: Code duplicated, block: B:28:0x0067 A[DONT_INVERT] */
    /* JADX WARN: Code duplicated, block: B:29:0x0069 A[LOOP:0: B:14:0x0027->B:29:0x0069, LOOP_END] */
            ...
            while (true) {
                ...
                if ((((~j10) << 7) & j10 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i12 = 0; i12 < i11; i12++) {
                        if ((255 & j10) < 128) {
                            int i13 = (i10 << 3) + i12;
                            if (jArr[i13] != e2Var.n(objArr[i13])) {
                                return false;
                            }
                        }
                        j10 >>= 8;
    ...
    public final int h(@dl.d yh.p<? super K, ? super Long, Boolean> predicate) {
        kotlin.jvm.internal.f0.p(predicate, "predicate");
        Object[] objArr = this.f3583b;
        long[] jArr = this.f3584c;
        long[] jArr2 = this.f3582a;
                ...
                if ((((~j10) << 7) & j10 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i13 = 0; i13 < i12; i13++) {
                        if ((255 & j10) < 128) {
                            ...
                            iHashCode += (obj != null ? obj.hashCode() : 0) ^ k.a(jArr[i14]);
                        }
                        j10 >>= 8;
                    }
                    if (i12 != 8) {
        ...
        while (true) {
            ...
            while (true) {
                if (j12 != 0) {
                    ...
                    if (kotlin.jvm.internal.f0.g(this.f3583b[iNumberOfTrailingZeros], k10)) {
    ...
    public final void j(@dl.d yh.p<? super K, ? super Long, kotlin.b2> block) {
    ...
    public final long n(K k10) {
        int i10 = i(k10);
        if (i10 >= 0) {
            return this.f3584c[i10];
        }
    ...
    public final long r(K k10, long j10) {
        int i10 = i(k10);
        return i10 >= 0 ? this.f3584c[i10] : j10;
    }

    public final long s(K k10, @dl.d yh.a<Long> defaultValue) {
        kotlin.jvm.internal.f0.p(defaultValue, "defaultValue");
        int i10 = i(k10);
        return i10 >= 0 ? this.f3584c[i10] : defaultValue.invoke().longValue();
    }
