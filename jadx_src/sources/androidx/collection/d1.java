...
public final class d1 extends m {
    ...
    private final void O() {
        if (this.f3656d <= 8 || Long.compare(kotlin.r1.h(kotlin.r1.h(this.f3657e) * 32) ^ Long.MIN_VALUE, kotlin.r1.h(kotlin.r1.h(this.f3656d) * 25) ^ Long.MIN_VALUE) > 0) {
            j0(h2.w(this.f3656d));
        } else {
            g0();
        }
    ...
    private final int R(float f10) {
        ...
        while (true) {
            ...
            if ((((~j10) << 6) & j10 & (-9187201950435737472L)) != 0) {
                int iQ = Q(i11);
                if (this.f3573f == 0) {
                    if (!(((this.f3653a[iQ >> 3] >> ((iQ & 7) << 3)) & 255) == 254)) {
                        O();
                        iQ = Q(i11);
                    }
                }
                this.f3657e++;
                int i19 = this.f3573f;
                long[] jArr2 = this.f3653a;
                int i20 = iQ >> 3;
                long j14 = jArr2[i20];
                int i21 = (iQ & 7) << 3;
                this.f3573f = i19 - (((j14 >> i21) & 255) == 128 ? 1 : 0);
    ...
    private final void T() {
        this.f3573f = h2.o(o()) - this.f3657e;
    }
    ...
    private final void V(int i10) {
        ...
        this.f3656d = iMax;
        U(iMax);
        this.f3654b = new float[iMax];
        this.f3655c = new int[iMax];
    }
    ...
    public final void a0(@dl.d m from) {
    ...
    public final void d0(@dl.d m from) {
        kotlin.jvm.internal.f0.p(from, "from");
        float[] fArr = from.f3654b;
        int[] iArr = from.f3655c;
        long[] jArr = from.f3653a;
        int length = jArr.length - 2;
        if (length < 0) {
            return;
        }
    ...
    public final boolean f0(float f10, int i10) {
        int i11 = i(f10);
        if (i11 < 0 || this.f3655c[i11] != i10) {
            return false;
        }
        i0(i11);
        return true;
    ...
    public final void h0(@dl.d yh.p<? super Float, ? super Integer, Boolean> predicate) {
        ...
        while (true) {
            ...
            if ((((~j10) << 7) & j10 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i12 = 0; i12 < i11; i12++) {
                    if ((255 & j10) < 128) {
                        int i13 = (i10 << 3) + i12;
                        if (predicate.invoke(Float.valueOf(this.f3654b[i13]), Integer.valueOf(this.f3655c[i13])).booleanValue()) {
                            i0(i13);
                        }
                    }
                    j10 >>= 8;
    ...
    public final int l0() {
        int i10 = this.f3656d;
        int iX = h2.x(h2.z(this.f3657e));
        if (iX >= i10) {
            return 0;
        }
        j0(iX);
        return i10 - this.f3656d;
    }
}
