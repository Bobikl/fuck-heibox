...
public final class h1 extends u {
    ...
    public /* synthetic */ h1(int i10, int i11, kotlin.jvm.internal.u uVar) {
        this((i11 & 1) != 0 ? 6 : i10);
    }

    private final void J() {
        if (this.f3710c <= 8 || Long.compare(kotlin.r1.h(kotlin.r1.h(this.f3711d) * 32) ^ Long.MIN_VALUE, kotlin.r1.h(kotlin.r1.h(this.f3710c) * 25) ^ Long.MIN_VALUE) > 0) {
            b0(h2.w(this.f3710c));
        } else {
            Z();
        }
    ...
    private final int L(float f10) {
        ...
        while (true) {
            ...
            if ((((~j10) << 6) & j10 & (-9187201950435737472L)) != 0) {
                int iM = M(i11);
                if (this.f3606e == 0) {
                    if (!(((this.f3708a[iM >> 3] >> ((iM & 7) << 3)) & 255) == 254)) {
                        J();
                        iM = M(i11);
                    }
                }
                ...
                long j14 = jArr2[i20];
                int i21 = (iM & 7) << 3;
                this.f3606e = i19 - (((j14 >> i21) & 255) == 128 ? 1 : 0);
    ...
    private final void N() {
        this.f3606e = h2.o(l()) - this.f3711d;
    }
    ...
    public final boolean G(float f10) {
        int i10 = this.f3711d;
        this.f3709b[L(f10)] = f10;
        return this.f3711d != i10;
    }

    public final boolean H(@dl.d u elements) {
        kotlin.jvm.internal.f0.p(elements, "elements");
        int i10 = this.f3711d;
        U(elements);
        return i10 != this.f3711d;
    }

    public final boolean I(@dl.d float[] elements) {
        kotlin.jvm.internal.f0.p(elements, "elements");
        int i10 = this.f3711d;
        V(elements);
        return i10 != this.f3711d;
    ...
    public final void R(@dl.d u elements) {
        kotlin.jvm.internal.f0.p(elements, "elements");
        float[] fArr = elements.f3709b;
        long[] jArr = elements.f3708a;
    ...
    public final void S(@dl.d float[] elements) {
        kotlin.jvm.internal.f0.p(elements, "elements");
    ...
    public final void U(@dl.d u elements) {
        kotlin.jvm.internal.f0.p(elements, "elements");
        float[] fArr = elements.f3709b;
        long[] jArr = elements.f3708a;
        int length = jArr.length - 2;
    ...
    public final void V(@dl.d float[] elements) {
        kotlin.jvm.internal.f0.p(elements, "elements");
        for (float f10 : elements) {
            T(f10);
        }
    ...
    public final boolean X(@dl.d u elements) {
        kotlin.jvm.internal.f0.p(elements, "elements");
        int i10 = this.f3711d;
        R(elements);
        return i10 != this.f3711d;
    ...
    public final boolean Y(@dl.d float[] elements) {
        kotlin.jvm.internal.f0.p(elements, "elements");
        int i10 = this.f3711d;
        S(elements);
        return i10 != this.f3711d;
    ...
    public final int c0() {
        int i10 = this.f3710c;
        int iX = h2.x(h2.z(this.f3711d));
        if (iX >= i10) {
            return 0;
        }
        b0(iX);
        return i10 - this.f3710c;
    }
}
