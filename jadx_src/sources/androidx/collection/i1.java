...
public final class i1 extends x {
    ...
    public /* synthetic */ i1(int i10, int i11, kotlin.jvm.internal.u uVar) {
        this((i11 & 1) != 0 ? 6 : i10);
    }

    private final void O() {
        if (this.f3732d <= 8 || Long.compare(kotlin.r1.h(kotlin.r1.h(this.f3733e) * 32) ^ Long.MIN_VALUE, kotlin.r1.h(kotlin.r1.h(this.f3732d) * 25) ^ Long.MIN_VALUE) > 0) {
            j0(h2.w(this.f3732d));
        } else {
            g0();
        }
    ...
    private final int R(int i10) {
        ...
        while (true) {
            ...
            if ((((~j10) << 6) & j10 & (-9187201950435737472L)) != 0) {
                int iQ = Q(i13);
                if (this.f3628f == 0) {
                    if (!(((this.f3729a[iQ >> 3] >> ((iQ & 7) << 3)) & 255) == 254)) {
                        O();
                        iQ = Q(i13);
                    }
                }
                this.f3733e++;
                int i21 = this.f3628f;
                long[] jArr2 = this.f3729a;
                int i22 = iQ >> 3;
                long j14 = jArr2[i22];
                int i23 = (iQ & 7) << 3;
                this.f3628f = i21 - (((j14 >> i23) & 255) == 128 ? 1 : 0);
    ...
    private final void T() {
        this.f3628f = h2.o(o()) - this.f3733e;
    }
    ...
    private final void V(int i10) {
        ...
        this.f3732d = iMax;
        U(iMax);
        this.f3730b = new int[iMax];
        this.f3731c = new float[iMax];
    }
    ...
    public final void a0(@dl.d x from) {
        kotlin.jvm.internal.f0.p(from, "from");
        d0(from);
    }

    public final float b0(int i10, float f10, float f11) {
        int iR = R(i10);
        if (iR < 0) {
            iR = ~iR;
        } else {
    ...
    public final void d0(@dl.d x from) {
        kotlin.jvm.internal.f0.p(from, "from");
        int[] iArr = from.f3730b;
        float[] fArr = from.f3731c;
        long[] jArr = from.f3729a;
        int length = jArr.length - 2;
        if (length < 0) {
            return;
        }
    ...
    public final void h0(@dl.d yh.p<? super Integer, ? super Float, Boolean> predicate) {
        ...
        while (true) {
            ...
            if ((((~j10) << 7) & j10 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i12 = 0; i12 < i11; i12++) {
                    if ((255 & j10) < 128) {
                        int i13 = (i10 << 3) + i12;
                        if (predicate.invoke(Integer.valueOf(this.f3730b[i13]), Float.valueOf(this.f3731c[i13])).booleanValue()) {
                            i0(i13);
                        }
                    }
                    j10 >>= 8;
    ...
    public final int l0() {
        int i10 = this.f3732d;
        int iX = h2.x(h2.z(this.f3733e));
        if (iX >= i10) {
            return 0;
        }
        j0(iX);
        return i10 - this.f3732d;
    }
}
