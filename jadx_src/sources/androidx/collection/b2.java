...
public abstract class b2<K> {
    ...
    private b2() {
        this.f3559a = h2.f3611e;
        this.f3560b = i0.a.f119208c;
        this.f3561c = j0.b();
    }

    public /* synthetic */ b2(kotlin.jvm.internal.u uVar) {
        this();
    }

    public static /* synthetic */ String L(b2 b2Var, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i10, CharSequence charSequence4, int i11, Object obj) {
        if (obj != null) {
        ...
        return b2Var.E(charSequence, charSequence5, charSequence6, i12, charSequence4);
    }

    public static /* synthetic */ String M(b2 b2Var, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i10, CharSequence charSequence4, yh.p transform, int i11, Object obj) {
        long[] jArr;
        int i12;
        if (obj != null) {
            throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: joinToString");
        ...
        sb2.append(prefix);
        Object[] objArr = b2Var.f3560b;
        int[] iArr = b2Var.f3561c;
        long[] jArr2 = b2Var.f3559a;
    ...
    @dl.d
    @xh.i
    public final String F(@dl.d CharSequence charSequence, @dl.d CharSequence prefix, @dl.d CharSequence postfix, int i10, @dl.d CharSequence truncated, @dl.d yh.p<? super K, ? super Integer, ? extends CharSequence> transform) {
        Object[] objArr;
  ...
  0x0097: PHI (r11v2 int) = (r11v1 int), (r11v3 int) binds: [B:6:0x0044, B:23:0x0095] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    @dl.d
    @xh.i
    public final String G(@dl.d CharSequence separator, @dl.d CharSequence prefix, @dl.d CharSequence postfix, int i10, @dl.d yh.p<? super K, ? super Integer, ? extends CharSequence> transform) {
        int i11;
        kotlin.jvm.internal.f0.p(separator, "separator");
        kotlin.jvm.internal.f0.p(prefix, "prefix");
        kotlin.jvm.internal.f0.p(postfix, "postfix");
  ...
  0x0096: PHI (r11v2 int) = (r11v1 int), (r11v3 int) binds: [B:6:0x0044, B:23:0x0094] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    @dl.d
    @xh.i
    public final String H(@dl.d CharSequence separator, @dl.d CharSequence prefix, @dl.d CharSequence postfix, @dl.d yh.p<? super K, ? super Integer, ? extends CharSequence> transform) {
        int i10;
        kotlin.jvm.internal.f0.p(separator, "separator");
        kotlin.jvm.internal.f0.p(prefix, "prefix");
        kotlin.jvm.internal.f0.p(postfix, "postfix");
  ...
  0x008a: PHI (r10v2 int) = (r10v1 int), (r10v3 int) binds: [B:6:0x003a, B:23:0x0088] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    @dl.d
    @xh.i
    public final String I(@dl.d CharSequence separator, @dl.d CharSequence prefix, @dl.d yh.p<? super K, ? super Integer, ? extends CharSequence> transform) {
        int i10;
        kotlin.jvm.internal.f0.p(separator, "separator");
        kotlin.jvm.internal.f0.p(prefix, "prefix");
        kotlin.jvm.internal.f0.p(transform, "transform");
  ...
  0x008a: PHI (r11v2 int) = (r11v1 int), (r11v3 int) binds: [B:6:0x0038, B:23:0x0088] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    @dl.d
    @xh.i
    public final String J(@dl.d CharSequence separator, @dl.d yh.p<? super K, ? super Integer, ? extends CharSequence> transform) {
        int i10;
        kotlin.jvm.internal.f0.p(separator, "separator");
        kotlin.jvm.internal.f0.p(transform, "transform");
        StringBuilder sb2 = new StringBuilder();
  ...
  0x0080: PHI (r10v2 int) = (r10v1 int), (r10v3 int) binds: [B:6:0x002e, B:23:0x007e] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    @dl.d
    @xh.i
    public final String K(@dl.d yh.p<? super K, ? super Integer, ? extends CharSequence> transform) {
        int i10;
        kotlin.jvm.internal.f0.p(transform, "transform");
        StringBuilder sb2 = new StringBuilder();
        sb2.append((CharSequence) "");
    ...
    public final boolean a(@dl.d yh.p<? super K, ? super Integer, Boolean> predicate) {
    ...
    /* JADX WARN: Code duplicated, block: B:24:0x0064 A[SYNTHETIC] */
    public final boolean c(@dl.d yh.p<? super K, ? super Integer, Boolean> predicate) {
        kotlin.jvm.internal.f0.p(predicate, "predicate");
        Object[] objArr = this.f3560b;
        int[] iArr = this.f3561c;
        long[] jArr = this.f3559a;
            ...
            while (true) {
                ...
                if ((((~j10) << 7) & j10 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i12 = 0; i12 < i11; i12++) {
                        if ((255 & j10) < 128) {
                            int i13 = (i10 << 3) + i12;
                            if (iArr[i13] != b2Var.n(objArr[i13])) {
                                return false;
                            }
                        }
                        j10 >>= 8;
    ...
    public final int h(@dl.d yh.p<? super K, ? super Integer, Boolean> predicate) {
        kotlin.jvm.internal.f0.p(predicate, "predicate");
        Object[] objArr = this.f3560b;
        int[] iArr = this.f3561c;
        long[] jArr = this.f3559a;
    ...
    public final void j(@dl.d yh.p<? super K, ? super Integer, kotlin.b2> block) {
    ...
    public final int r(K k10, int i10) {
        int i11 = i(k10);
        return i11 >= 0 ? this.f3561c[i11] : i10;
    }

    public final int s(K k10, @dl.d yh.a<Integer> defaultValue) {
        kotlin.jvm.internal.f0.p(defaultValue, "defaultValue");
        int i10 = i(k10);
        return i10 >= 0 ? this.f3561c[i10] : defaultValue.invoke().intValue();
    }
