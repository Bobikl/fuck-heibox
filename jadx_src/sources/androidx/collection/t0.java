...
public abstract class t0<V> {
    ...
    private t0() {
        this.f3702a = h2.f3611e;
        this.f3703b = w0.b();
        this.f3704c = i0.a.f119208c;
    }
    ...
    public static /* synthetic */ String L(t0 t0Var, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i10, CharSequence charSequence4, int i11, Object obj) {
        if (obj != null) {
        ...
        return t0Var.E(charSequence, charSequence5, charSequence6, i12, charSequence4);
    }

    public static /* synthetic */ String M(t0 t0Var, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i10, CharSequence charSequence4, yh.p transform, int i11, Object obj) {
        long[] jArr;
        int i12;
        if (obj != null) {
            throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: joinToString");
        ...
        sb2.append(prefix);
        long[] jArr2 = t0Var.f3703b;
        Object[] objArr = t0Var.f3704c;
        long[] jArr3 = t0Var.f3702a;
    ...
    public final String E(@dl.d CharSequence separator, @dl.d CharSequence prefix, @dl.d CharSequence postfix, int i10, @dl.d CharSequence truncated) {
        ...
        StringBuilder sb2 = new StringBuilder();
        sb2.append(prefix);
        long[] jArr2 = this.f3703b;
        Object[] objArr = this.f3704c;
        long[] jArr3 = this.f3702a;
        int length = jArr3.length - 2;
        if (length < 0) {
            sb2.append(postfix);
            break;
    ...
    @dl.d
    @xh.i
    public final String F(@dl.d CharSequence charSequence, @dl.d CharSequence prefix, @dl.d CharSequence postfix, int i10, @dl.d CharSequence truncated, @dl.d yh.p<? super Long, ? super V, ? extends CharSequence> transform) {
        long[] jArr;
  ...
  0x0097: PHI (r11v2 int) = (r11v1 int), (r11v3 int) binds: [B:6:0x0044, B:23:0x0095] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    @dl.d
    @xh.i
    public final String G(@dl.d CharSequence separator, @dl.d CharSequence prefix, @dl.d CharSequence postfix, int i10, @dl.d yh.p<? super Long, ? super V, ? extends CharSequence> transform) {
        int i11;
        kotlin.jvm.internal.f0.p(separator, "separator");
        kotlin.jvm.internal.f0.p(prefix, "prefix");
        kotlin.jvm.internal.f0.p(postfix, "postfix");
        ...
        StringBuilder sb2 = new StringBuilder();
        sb2.append(prefix);
        long[] jArr = this.f3703b;
        Object[] objArr = this.f3704c;
        long[] jArr2 = this.f3702a;
  ...
  0x0096: PHI (r11v2 int) = (r11v1 int), (r11v3 int) binds: [B:6:0x0044, B:23:0x0094] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    @dl.d
    @xh.i
    public final String H(@dl.d CharSequence separator, @dl.d CharSequence prefix, @dl.d CharSequence postfix, @dl.d yh.p<? super Long, ? super V, ? extends CharSequence> transform) {
        int i10;
        kotlin.jvm.internal.f0.p(separator, "separator");
        kotlin.jvm.internal.f0.p(prefix, "prefix");
        kotlin.jvm.internal.f0.p(postfix, "postfix");
  ...
  0x008a: PHI (r10v2 int) = (r10v1 int), (r10v3 int) binds: [B:6:0x003a, B:23:0x0088] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    @dl.d
    @xh.i
    public final String I(@dl.d CharSequence separator, @dl.d CharSequence prefix, @dl.d yh.p<? super Long, ? super V, ? extends CharSequence> transform) {
        int i10;
        kotlin.jvm.internal.f0.p(separator, "separator");
        kotlin.jvm.internal.f0.p(prefix, "prefix");
        kotlin.jvm.internal.f0.p(transform, "transform");
  ...
  0x008a: PHI (r11v2 int) = (r11v1 int), (r11v3 int) binds: [B:6:0x0038, B:23:0x0088] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    @dl.d
    @xh.i
    public final String J(@dl.d CharSequence separator, @dl.d yh.p<? super Long, ? super V, ? extends CharSequence> transform) {
        int i10;
        kotlin.jvm.internal.f0.p(separator, "separator");
        kotlin.jvm.internal.f0.p(transform, "transform");
        StringBuilder sb2 = new StringBuilder();
  ...
  0x0080: PHI (r10v2 int) = (r10v1 int), (r10v3 int) binds: [B:6:0x002e, B:23:0x007e] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    @dl.d
    @xh.i
    public final String K(@dl.d yh.p<? super Long, ? super V, ? extends CharSequence> transform) {
        int i10;
        kotlin.jvm.internal.f0.p(transform, "transform");
        StringBuilder sb2 = new StringBuilder();
        sb2.append((CharSequence) "");
    ...
    public final boolean a(@dl.d yh.p<? super Long, ? super V, Boolean> predicate) {
    ...
    /* JADX WARN: Code duplicated, block: B:24:0x0064 A[SYNTHETIC] */
    public final boolean c(@dl.d yh.p<? super Long, ? super V, Boolean> predicate) {
        kotlin.jvm.internal.f0.p(predicate, "predicate");
        long[] jArr = this.f3703b;
        Object[] objArr = this.f3704c;
        long[] jArr2 = this.f3702a;
        ...
        loop0: while (true) {
            ...
            while (true) {
                if (j13 != 0) {
                    ...
                    if (this.f3703b[iNumberOfTrailingZeros] == j10) {
                        break loop0;
                    }
                    j13 &= j13 - 1;
                }
    ...
    /* JADX WARN: Code duplicated, block: B:37:0x007d A[DONT_INVERT] */
    /* JADX WARN: Code duplicated, block: B:38:0x007f A[LOOP:0: B:14:0x0027->B:38:0x007f, LOOP_END] */
                ...
                if ((((~j10) << 7) & j10 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i13 = 0; i13 < i12; i13++) {
                        if ((255 & j10) < 128) {
                            ...
                            if (obj2 == null) {
                                if (t0Var.n(j11) != null || !t0Var.e(j11)) {
                                    break loop0;
                                }
                            } else if (!kotlin.jvm.internal.f0.g(obj2, t0Var.n(j11))) {
                                return false;
                            }
                            i11 = 8;
                        }
    ...
    public final int h(@dl.d yh.p<? super Long, ? super V, Boolean> predicate) {
        kotlin.jvm.internal.f0.p(predicate, "predicate");
        long[] jArr = this.f3703b;
        Object[] objArr = this.f3704c;
        long[] jArr2 = this.f3702a;
                ...
                if ((((~j10) << 7) & j10 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i13 = 0; i13 < i12; i13++) {
                        if ((255 & j10) < 128) {
                            ...
                            iHashCode += (obj != null ? obj.hashCode() : 0) ^ k.a(j11);
                        }
                        j10 >>= 8;
                    }
                    if (i12 != 8) {
    ...
    public final void j(@dl.d yh.p<? super Long, ? super V, kotlin.b2> block) {
    ...
    public final V n(long j10) {
        ...
        if (iNumberOfTrailingZeros >= 0) {
            return (V) this.f3704c[iNumberOfTrailingZeros];
        }
        return null;
    }
    ...
    public final V r(long j10, V v10) {
        int iNumberOfTrailingZeros;
        int iA = k.a(j10) * h2.f3616j;
        int i10 = iA ^ (iA << 16);
        int i11 = i10 & 127;
        ...
        return iNumberOfTrailingZeros >= 0 ? (V) this.f3704c[iNumberOfTrailingZeros] : v10;
    }

    public final V s(long j10, @dl.d yh.a<? extends V> defaultValue) {
