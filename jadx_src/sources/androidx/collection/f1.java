...
public final class f1 extends q {
    ...
    public /* synthetic */ f1(int i10, int i11, kotlin.jvm.internal.u uVar) {
        this((i11 & 1) != 0 ? 6 : i10);
    }

    private final void O() {
        if (this.f3683d <= 8 || Long.compare(kotlin.r1.h(kotlin.r1.h(this.f3684e) * 32) ^ Long.MIN_VALUE, kotlin.r1.h(kotlin.r1.h(this.f3683d) * 25) ^ Long.MIN_VALUE) > 0) {
            j0(h2.w(this.f3683d));
        } else {
            g0();
        }
    ...
    private final int R(float f10) {
        ...
        while (true) {
            ...
            if ((((~j10) << 6) & j10 & (-9187201950435737472L)) != 0) {
                int iQ = Q(i11);
                if (this.f3592f == 0) {
                    if (!(((this.f3680a[iQ >> 3] >> ((iQ & 7) << 3)) & 255) == 254)) {
                        O();
                        iQ = Q(i11);
                    }
                }
                ...
                long j14 = jArr2[i20];
                int i21 = (iQ & 7) << 3;
                this.f3592f = i19 - (((j14 >> i21) & 255) == 128 ? 1 : 0);
    ...
    private final void T() {
        this.f3592f = h2.o(o()) - this.f3684e;
    }
    ...
    private final void V(int i10) {
        ...
        this.f3683d = iMax;
        U(iMax);
        this.f3681b = new float[iMax];
        this.f3682c = new long[iMax];
    }
    ...
    private final void j0(int i10) {
        ...
        long[] jArr2 = this.f3682c;
        int i12 = this.f3683d;
        V(i10);
        float[] fArr2 = this.f3681b;
        long[] jArr3 = this.f3682c;
        int i13 = 0;
        while (i13 < i12) {
    ...
    public final void X(@dl.d o keys) {
        kotlin.jvm.internal.f0.p(keys, "keys");
        float[] fArr = keys.f3672a;
        int i10 = keys.f3673b;
    ...
    public final void Y(@dl.d u keys) {
        kotlin.jvm.internal.f0.p(keys, "keys");
        float[] fArr = keys.f3709b;
        long[] jArr = keys.f3708a;
    ...
    public final void Z(@dl.d float[] keys) {
        kotlin.jvm.internal.f0.p(keys, "keys");
        for (float f10 : keys) {
            e0(f10);
        }
    ...
    public final void a0(@dl.d q from) {
    ...
    public final void d0(@dl.d q from) {
        kotlin.jvm.internal.f0.p(from, "from");
        float[] fArr = from.f3681b;
        long[] jArr = from.f3682c;
        long[] jArr2 = from.f3680a;
    ...
    public final void h0(@dl.d yh.p<? super Float, ? super Long, Boolean> predicate) {
        ...
        while (true) {
            ...
            if ((((~j10) << 7) & j10 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i12 = 0; i12 < i11; i12++) {
                    if ((255 & j10) < 128) {
                        int i13 = (i10 << 3) + i12;
                        if (predicate.invoke(Float.valueOf(this.f3681b[i13]), Long.valueOf(this.f3682c[i13])).booleanValue()) {
                            i0(i13);
                        }
                    }
                    j10 >>= 8;
    ...
    public final int l0() {
        int i10 = this.f3683d;
        int iX = h2.x(h2.z(this.f3684e));
        if (iX >= i10) {
            return 0;
        }
        j0(iX);
        return i10 - this.f3683d;
    }
}
