...
public abstract class q {
    ...
    public static /* synthetic */ String L(q qVar, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i10, CharSequence charSequence4, int i11, Object obj) {
        if (obj != null) {
        ...
        return qVar.E(charSequence, charSequence5, charSequence6, i12, charSequence4);
    }

    public static /* synthetic */ String M(q qVar, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i10, CharSequence charSequence4, yh.p transform, int i11, Object obj) {
        long[] jArr;
        int i12;
        if (obj != null) {
            throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: joinToString");
        ...
        sb2.append(prefix);
        float[] fArr = qVar.f3681b;
        long[] jArr2 = qVar.f3682c;
        long[] jArr3 = qVar.f3680a;
    ...
    public final String E(@dl.d CharSequence separator, @dl.d CharSequence prefix, @dl.d CharSequence postfix, int i10, @dl.d CharSequence truncated) {
        ...
        StringBuilder sb2 = new StringBuilder();
        sb2.append(prefix);
        float[] fArr2 = this.f3681b;
        long[] jArr = this.f3682c;
        long[] jArr2 = this.f3680a;
  ...
  0x00a1: PHI (r12v2 int) = (r12v1 int), (r12v3 int) binds: [B:6:0x004c, B:22:0x009f] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    @dl.d
    @xh.i
    public final String F(@dl.d CharSequence charSequence, @dl.d CharSequence prefix, @dl.d CharSequence postfix, int i10, @dl.d CharSequence truncated, @dl.d yh.p<? super Float, ? super Long, ? extends CharSequence> transform) {
    ...
    @dl.d
    @xh.i
    public final String G(@dl.d CharSequence charSequence, @dl.d CharSequence prefix, @dl.d CharSequence postfix, int i10, @dl.d yh.p<? super Float, ? super Long, ? extends CharSequence> transform) {
        CharSequence separator = charSequence;
        kotlin.jvm.internal.f0.p(separator, "separator");
        kotlin.jvm.internal.f0.p(prefix, "prefix");
        kotlin.jvm.internal.f0.p(postfix, "postfix");
  ...
  0x009a: PHI (r11v2 int) = (r11v1 int), (r11v3 int) binds: [B:6:0x0044, B:23:0x0098] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    @dl.d
    @xh.i
    public final String H(@dl.d CharSequence separator, @dl.d CharSequence prefix, @dl.d CharSequence postfix, @dl.d yh.p<? super Float, ? super Long, ? extends CharSequence> transform) {
        int i10;
        kotlin.jvm.internal.f0.p(separator, "separator");
        kotlin.jvm.internal.f0.p(prefix, "prefix");
        kotlin.jvm.internal.f0.p(postfix, "postfix");
  ...
  0x008e: PHI (r10v2 int) = (r10v1 int), (r10v3 int) binds: [B:6:0x003a, B:23:0x008c] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    @dl.d
    @xh.i
    public final String I(@dl.d CharSequence separator, @dl.d CharSequence prefix, @dl.d yh.p<? super Float, ? super Long, ? extends CharSequence> transform) {
        int i10;
        kotlin.jvm.internal.f0.p(separator, "separator");
        kotlin.jvm.internal.f0.p(prefix, "prefix");
        kotlin.jvm.internal.f0.p(transform, "transform");
  ...
  0x008e: PHI (r11v2 int) = (r11v1 int), (r11v3 int) binds: [B:6:0x0038, B:23:0x008c] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    @dl.d
    @xh.i
    public final String J(@dl.d CharSequence separator, @dl.d yh.p<? super Float, ? super Long, ? extends CharSequence> transform) {
        int i10;
        kotlin.jvm.internal.f0.p(separator, "separator");
        kotlin.jvm.internal.f0.p(transform, "transform");
        StringBuilder sb2 = new StringBuilder();
  ...
  0x0084: PHI (r10v2 int) = (r10v1 int), (r10v3 int) binds: [B:6:0x002e, B:23:0x0082] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    @dl.d
    @xh.i
    public final String K(@dl.d yh.p<? super Float, ? super Long, ? extends CharSequence> transform) {
        int i10;
        kotlin.jvm.internal.f0.p(transform, "transform");
        StringBuilder sb2 = new StringBuilder();
        sb2.append((CharSequence) "");
    ...
    public final boolean a(@dl.d yh.p<? super Float, ? super Long, Boolean> predicate) {
    ...
    /* JADX WARN: Code duplicated, block: B:24:0x0068 A[SYNTHETIC] */
    public final boolean c(@dl.d yh.p<? super Float, ? super Long, Boolean> predicate) {
        kotlin.jvm.internal.f0.p(predicate, "predicate");
        float[] fArr = this.f3681b;
        long[] jArr = this.f3682c;
        long[] jArr2 = this.f3680a;
    ...
    public final int h(@dl.d yh.p<? super Float, ? super Long, Boolean> predicate) {
        kotlin.jvm.internal.f0.p(predicate, "predicate");
        float[] fArr = this.f3681b;
        long[] jArr = this.f3682c;
        long[] jArr2 = this.f3680a;
        ...
        while (true) {
            ...
            while (true) {
                if (j12 != 0) {
                    ...
                    if (this.f3681b[iNumberOfTrailingZeros] == f10) {
    ...
    public final void j(@dl.d yh.p<? super Float, ? super Long, kotlin.b2> block) {
    ...
    public final long r(float f10, long j10) {
        int i10 = i(f10);
        return i10 >= 0 ? this.f3682c[i10] : j10;
    }

    public final long s(float f10, @dl.d yh.a<Long> defaultValue) {
        kotlin.jvm.internal.f0.p(defaultValue, "defaultValue");
        int i10 = i(f10);
        return i10 < 0 ? defaultValue.invoke().longValue() : this.f3682c[i10];
    }
