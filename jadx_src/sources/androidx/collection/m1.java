...
public final class m1<V> extends g0<V> {
    ...
    private final void O() {
        if (this.f3601d <= 8 || Long.compare(kotlin.r1.h(kotlin.r1.h(this.f3602e) * 32) ^ Long.MIN_VALUE, kotlin.r1.h(kotlin.r1.h(this.f3601d) * 25) ^ Long.MIN_VALUE) > 0) {
            i0(h2.w(this.f3601d));
        } else {
            f0();
        }
    ...
    private final int Q(int i10) {
        ...
        while (true) {
            ...
            if ((((~j10) << 6) & j10 & (-9187201950435737472L)) != 0) {
                int iR = R(i13);
                if (this.f3663f == 0) {
                    if (!(((this.f3598a[iR >> 3] >> ((iR & 7) << 3)) & 255) == 254)) {
                        O();
                        iR = R(i13);
                    }
                }
                this.f3602e++;
                int i21 = this.f3663f;
                long[] jArr2 = this.f3598a;
                int i22 = iR >> 3;
                long j14 = jArr2[i22];
                int i23 = (iR & 7) << 3;
                this.f3663f = i21 - (((j14 >> i23) & 255) == 128 ? 1 : 0);
                jArr2[i22] = (j14 & (~(255 << i23))) | (j11 << i23);
                int i24 = this.f3601d;
                int i25 = ((iR - 7) & i24) + (i24 & 7);
                int i26 = i25 >> 3;
                int i27 = (i25 & 7) << 3;
    ...
    private final void T() {
        this.f3663f = h2.o(o()) - this.f3602e;
    }
    ...
    private final void V(int i10) {
        ...
        this.f3601d = iMax;
        U(iMax);
        this.f3599b = new int[iMax];
        this.f3600c = new Object[iMax];
    }
    ...
    private final void i0(int i10) {
        ...
        while (i13 < i12) {
            if (((jArr[i13 >> 3] >> ((i13 & 7) << 3)) & 255) < 128) {
                ...
                int i19 = this.f3601d;
                int i20 = ((iR - 7) & i19) + (i19 & 7);
                int i21 = i20 >> 3;
                int i22 = (i20 & 7) << 3;
                jArr2[i21] = (jArr2[i21] & (~(255 << i22))) | (j10 << i22);
                iArr2[iR] = i14;
                objArr2[iR] = objArr[i11];
            } else {
                i11 = i13;
            }
            i13 = i11 + 1;
    ...
    public final void P() {
        ...
        kotlin.collections.m.n2(this.f3600c, null, 0, this.f3601d);
        T();
    }
    ...
    public final void a0(@dl.d g0<V> from) {
        kotlin.jvm.internal.f0.p(from, "from");
        c0(from);
    }

    @dl.e
    public final V b0(int i10, V v10) {
        int iQ = Q(i10);
        Object[] objArr = this.f3600c;
        V v11 = (V) objArr[iQ];
        this.f3599b[iQ] = i10;
    ...
    public final void c0(@dl.d g0<V> from) {
        kotlin.jvm.internal.f0.p(from, "from");
        int[] iArr = from.f3599b;
        Object[] objArr = from.f3600c;
        long[] jArr = from.f3598a;
        int length = jArr.length - 2;
        if (length < 0) {
            return;
        }
    ...
    public final V d0(int i10) {
        ...
        if (iNumberOfTrailingZeros >= 0) {
            return h0(iNumberOfTrailingZeros);
        }
        return null;
    }

    public final boolean e0(int i10, V v10) {
        int iNumberOfTrailingZeros;
        int i11 = h2.f3616j * i10;
        int i12 = i11 ^ (i11 << 16);
        int i13 = i12 & 127;
        ...
        if (iNumberOfTrailingZeros < 0 || !kotlin.jvm.internal.f0.g(this.f3600c[iNumberOfTrailingZeros], v10)) {
            return false;
        }
        h0(iNumberOfTrailingZeros);
        return true;
    }

    public final void g0(@dl.d yh.p<? super Integer, ? super V, Boolean> predicate) {
        ...
        while (true) {
            ...
            if ((((~j10) << 7) & j10 & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i12 = 0; i12 < i11; i12++) {
                    if ((255 & j10) < 128) {
                        int i13 = (i10 << 3) + i12;
                        if (predicate.invoke(Integer.valueOf(this.f3599b[i13]), this.f3600c[i13]).booleanValue()) {
                            h0(i13);
                        }
                    }
                    j10 >>= 8;
    ...
    public final int k0() {
        int i10 = this.f3601d;
        int iX = h2.x(h2.z(this.f3602e));
        if (iX >= i10) {
            return 0;
        }
        i0(iX);
        return i10 - this.f3601d;
    }
}
