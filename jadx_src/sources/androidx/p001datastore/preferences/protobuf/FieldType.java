...
public final class FieldType {
    ...
    public static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f22292b[JavaType.MESSAGE.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f22292b[JavaType.STRING.ordinal()] = 3;
            ...
            try {
                f22291a[Collection.VECTOR.ordinal()] = 2;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f22291a[Collection.SCALAR.ordinal()] = 3;
    ...
    static {
        ...
        for (FieldType fieldType52 : fieldTypeArrValues) {
            VALUES[fieldType52.f22290id] = fieldType52;
        }
    }
    ...
    private FieldType(String str, int i10, int i11, Collection collection, JavaType javaType) {
        ...
        int i13 = a.f22291a[collection.ordinal()];
        if (i13 == 1 || i13 == 2) {
            this.elementType = javaType.getBoxedType();
        } else {
            this.elementType = null;
        }
        this.primitiveScalar = (collection != Collection.SCALAR || (i12 = a.f22292b[javaType.ordinal()]) == 1 || i12 == 2 || i12 == 3) ? false : true;
    }
