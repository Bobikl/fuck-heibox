...
public enum WebViewFeatureInternal {
    ...
    PROXY_OVERRIDE(k0.J, org.chromium.support_lib_boundary.util.b.G),
    SUPPRESS_ERROR_PAGE("SUPPRESS_ERROR_PAGE", "SUPPRESS_ERROR_PAGE"),
    MULTI_PROCESS(k0.L, org.chromium.support_lib_boundary.util.b.M),
    FORCE_DARK("FORCE_DARK", "FORCE_DARK"),
    FORCE_DARK_STRATEGY(k0.N, org.chromium.support_lib_boundary.util.b.O),
    ...
    public static class a {
        ...
        static final Set<String> f28355a = new HashSet(Arrays.asList(u.d().a()));
    ...
    WebViewFeatureInternal(String str, String str2, int i10) {
    ...
    @n0
    public static WebViewFeatureInternal getFeature(@n0 String str) {
    ...
    public boolean isSupportedByWebView() {
        return org.chromium.support_lib_boundary.util.a.b(a.f28355a, this.mInternalFeatureValue);
    }
}
